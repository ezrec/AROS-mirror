...
/* As cairo-ft.h includes cairo.h and then declares its own prototypes, prototypes for functions which are defined in ppcinline/cairo.h, enabling this block makes it impossible to include cairo-ft.h anywhere. */
