...
DEFNEW
{
	...
	oddeven[0]       = (STRPTR) LOCSTR(MSG_PRINTER_ODDEVEN);
	oddeven[1]       = (STRPTR) LOCSTR(MSG_PRINTER_ODD); 
	oddeven[2]       = (STRPTR) LOCSTR(MSG_PRINTER_EVEN);
	scaling_modes[0] = (STRPTR) LOCSTR(MSG_PRINTER_NONE);
	scaling_modes[1] = (STRPTR) LOCSTR(MSG_PRINTER_BEST);
	scaling_modes[2] = (STRPTR) LOCSTR(MSG_PRINTER_MULTIPLE);
	pages_per_sheet[4] = (STRPTR) LOCSTR(MSG_PRINTER_CUSTOM);
	pages_order[0]   = (STRPTR) LOCSTR(MSG_PRINTER_HORIZONTAL_VERTICAL);
	pages_order[1]   = (STRPTR) LOCSTR(MSG_PRINTER_HORIZONTAL_VERTICALREVERSED);
	pages_order[2]   = (STRPTR) LOCSTR(MSG_PRINTER_HORIZONTALREVERSED_VERTICAL) ;
	pages_order[3]   = (STRPTR) LOCSTR(MSG_PRINTER_HORIZONTALREVERSED_VERTICAL_REVERSED);
	pages_order[4]   = (STRPTR) LOCSTR(MSG_PRINTER_VERTICAL_HORIZONTAL);
	pages_order[5]   = (STRPTR) LOCSTR(MSG_PRINTER_VERTICALREVERSED_HORIZONTAL);
	pages_order[6]   = (STRPTR) LOCSTR(MSG_PRINTER_VERTICAL_HORIZONTALREVERSED) ;
	pages_order[7]   = (STRPTR) LOCSTR(MSG_PRINTER_VERTICAL_REVERSED_HORIZONTALREVERSED);
	...
	second_page  = VGroup,
		...
		Child, (IPTR) HGroup,
			Child, (IPTR) HSpace(0),
			Child, (IPTR) (btnCancel = SimpleButton(LOCSTR(MSG_PRINTER_ABORT))),
			Child, (IPTR) HSpace(0),
		End,
		Child, (IPTR) HVSpace,
	End;
	...
	right_group = MUI_NewObject(MUIC_Group,
		MUIA_Group_Child, MUI_NewObject(MUIC_Group,
			...
			MUIA_FrameTitle, (IPTR) LOCSTR(MSG_PRINTER_RANGE),
			MUIA_Group_Child, MUI_NewObject(MUIC_Group,
				MUIA_Group_Columns, 2,
				MUIA_Group_Child, MUI_NewObject(MUIC_Text,
					MUIA_Text_Contents, (IPTR) LOCSTR(MSG_PRINTER_PAGES),
...
// FIXME: AROS
					...
					MUIA_Group_Child, MUI_NewObject(MUIC_Group,
						MUIA_Group_Child, MUI_NewObject(MUIC_Text,
							MUIA_Text_Contents, (IPTR) LOCSTR(MSG_PRINTER_MANUAL),
							MUIA_Text_PreParse, (IPTR) "\33r",
				...
				MUIA_Group_Child, (grpRight = MUI_NewObject(MUIC_Group,
					...
					MUIA_Group_Child, HGroup, 
						...
						TAG_END),
						Child, (IPTR) (btnReset = TextObject,
											ButtonFrame,
												//MUIA_ShowMe, FALSE,
												MUIA_Font , MUIV_Font_Button,
												MUIA_Text_Contents, (IPTR) LOCSTR(MSG_PRINTER_RESET),
			...
			TAG_END),
				Child, (IPTR) HGroup,
					Child, (IPTR) (chkReverse = CheckMark(FALSE)),
					Child, (IPTR) (TextObject, MUIA_Text_Contents, (IPTR) LOCSTR(MSG_PRINTER_REVERSE), End),
				End,
		TAG_END),
	TAG_END);
	...
	grpPageHandling =  VGroup,
			MUIA_Frame, MUIV_Frame_Group,
			MUIA_Background, MUII_GroupBack,
			MUIA_FrameTitle, (IPTR) LOCSTR(MSG_PRINTER_ORIENTATION),
			Child, (IPTR) ColGroup(2),
				Child, (IPTR) Label(LOCSTR(MSG_PRINTER_COPIES)),
				Child, (IPTR) HGroup, 
					Child, (IPTR) (strCopies = ArrowStringObject,
						MA_ArrowString_Min, 1,
					End),
					Child, (IPTR) HVSpace,
					Child, (IPTR) (grpCollate = HGroup, 
						MUIA_ShowMe, FALSE,
						Child, (IPTR) (chkCollate = CheckMark(TRUE)),
						Child, (IPTR) MUI_NewObject(MUIC_Text,
							MUIA_Text_Contents, (IPTR) LOCSTR(MSG_PRINTER_COLLATE),
							MUIA_Text_SetMax, TRUE,
						TAG_END),
					End),
				End,
				Child, (IPTR) Label(LOCSTR(MSG_PRINTER_SCALING)),
				Child, (IPTR) (cycPageScaling = CycleObject,
						MUIA_Cycle_Entries, (IPTR) scaling_modes,
				End),
				Child,  (IPTR) (grpPagesPerSheet1 = PageGroup,
				MUIA_HorizWeight, 1,
						Child, (IPTR) Label(" "),
						Child, (IPTR) Label(LOCSTR(MSG_PRINTER_PAGESPERSHEET)),
				End),
				Child, (IPTR) (grpPagesPerSheet2 = PageGroup,
				MUIA_HorizWeight, 1,
					Child, (IPTR) Label("          "),
					Child, (IPTR) (HGroup, 
						Child, (IPTR) (cycPagesPerSheet = CycleObject,
								MUIA_Cycle_Entries, (IPTR) pages_per_sheet,
						End),
						Child, (IPTR) (free_grp = HGroup, 
								MUIA_ShowMe, FALSE,
								Child, (IPTR) (StringObject, 
									MUIA_String_Accept, (IPTR) "0123456789",
									MUIA_Frame, MUIV_Frame_String,
									MUIA_String_MaxLen, 3,
									MUIA_FixWidthTxt, (IPTR) "12",
								End),
								Child, (IPTR) (MUI_NewObject(MUIC_Text,
					...
					End),
				End),
				Child, (IPTR) (grpPagesOrder1 = PageGroup,
				MUIA_HorizWeight, 1,
					Child, (IPTR) Label(" "),
					Child, (IPTR) Label(LOCSTR(MSG_PRINTER_ORDER)),
				End),
				Child, (IPTR) (grpPagesOrder2 = PageGroup,
				MUIA_HorizWeight, 1,
					Child, (IPTR) Label("             "),
					Child, (IPTR) (cycPagesOrder = CycleObject,
						MUIA_Cycle_Entries, (IPTR) pages_order,
					End),
				End),
			End,
			Child, (IPTR) HVSpace,	
			Child, (IPTR) HGroup, 
				Child, (IPTR) (chkAutorotatescale = CheckMark(TRUE)),
				Child, (IPTR) TextObject, 
					MUIA_Text_Contents, (IPTR) LOCSTR(MSG_PRINTER_AUTOROTATE),
				End,
			End,
	...
	grpDriver = VGroup,
		MUIA_Frame, MUIV_Frame_Group,
		MUIA_Background, MUII_GroupBack,
		MUIA_FrameTitle, (IPTR) LOCSTR(MSG_PRINTER_DRIVER),
		Child, (IPTR) (btnPrefs = SimpleButton(LOCSTR(MSG_PRINTER_PREFERENCES))),
		Child, (IPTR) HGroup, 
		 	Child, (IPTR) HGroup,
		  	    MUIA_Weight, 1,
				MUIA_Frame, MUIV_Frame_Button,
				MUIA_FramePhantomHoriz, TRUE,
				Child, (IPTR) (chkPS = CheckMark(TRUE)),
				Child, (IPTR) TextObject, 
					MUIA_Text_Contents, (IPTR) "PostScript",
                 
				End,
			End,
			Child, (IPTR) (grpPSOutput = HGroup, 
                MUIA_Weight, 90,
                Child, (IPTR) (cycPSVersion = MUI_NewObject(MUIC_Cycle,
					MUIA_Cycle_Entries, ps_levels,
				TAG_END)),
				Child, (IPTR) HVSpace,
				Child, (IPTR) Label(LOCSTR(MSG_PRINTER_OUTPUT)), 
				Child, (IPTR) (strOutput = StringObject, 	
                            MUIA_Frame, MUIV_Frame_String,
                            MUIA_String_Contents, (IPTR) "PS:",
	...
	obj = (Object *) DoSuperNew(cl, obj,
					...
					//	MUIA_Window_Height, MUIV_Window_Height_Screen(50),
					    ...
					    Child, (IPTR) VGroup,
							Child, (IPTR) HGroup,
								Child, (IPTR) VGroup,
									Child, (IPTR) grpDriver,
									Child, (IPTR) right_group,
								End,
								Child, (IPTR) grpPageHandling,
							End,
						
							Child, (IPTR) HGroup,
								Child, (IPTR) (btnPrint = SimpleButton(LOCSTR(MSG_PRINTER_PRINT))),
								Child, (IPTR) HSpace(0),
