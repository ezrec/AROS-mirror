...
#ifdef __PPC__
static const char verstring[]="$VER:ApdfGfx16_" PROC ".module 1.0 (27.12.2000)";
#else
extern const char LibName[];
extern const char LibId[];
const char LibName[]="ApdfGfx16_" PROC ".module";
const char LibId[]="ApdfGfx16_" PROC ".module 1.0 (27.12.2000)";
#endif
