...
#define STREAM_FILE( stream )  ( (myFILE*)stream->descriptor.pointer )
                ...
                unsigned long   count )
  {
    ...
    return (unsigned long)myfread( buffer, 1, count, file );
  }
  ...
  FT_Stream_Open( FT_Stream  astream,
