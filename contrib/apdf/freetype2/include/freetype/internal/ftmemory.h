...
#define FT_Alloc(memory, _pointer_, _size_) \
  (memalloc_file = __FILE__, memalloc_line = __LINE__, \
            FT_Alloc(memory, _pointer_, _size_))
#define FT_Realloc(memory, _current_, _size_, _pointer_) \
  (memalloc_file = __FILE__, memalloc_line = __LINE__, \
            FT_Realloc(memory, _current_, _size_, _pointer_))
#define FT_Free(memory, _pointer_) \
  (memalloc_file = __FILE__, memalloc_line = __LINE__, \
