...
#ifdef DEBUG_MEM
#include "goo/gdebug.h"
class ObjTracker : public GDebug::Tracker {
public:
  ObjTracker();
  virtual ~ObjTracker();
protected:
...
extern ObjTracker objTracker;
#define initObj(t) ++numAlloc[type = t]; \
                  if (t != objNull && t != objNone) objTracker.track(this);
#else
...
public:
  ...
  // Erase object without freeing resources.
  void clear() { type = objNone; }
