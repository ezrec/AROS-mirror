...
//========================================================================
//
// EL (10/99): - Added LinkNamed
//             - Added support for window specification
//             - Added a few constructors
//             - Reorganised actions parsing
//
#include <aconf.h>
...
LinkGoToR::LinkGoToR(Object *fileSpecObj, Object *destObj, LinkWindow linkWindow) {
  dest = NULL;
  namedDest = NULL;
  window = linkWindow;
...
LinkLaunch::LinkLaunch(Object *actionObj, LinkWindow linkWindow) {
  Object obj1, obj2;
...
LinkNamed::LinkNamed(Object *nameObj) {
  ...
  if (nameObj->isName()) {
    ...
    error(-1, "Illegal Named-type link");
  }
}
...
LinkAction *Link::makeAction(Object *obj1, GString *baseURI) {
  ...
  if (obj2.isName("GoTo")) {
    ...
    obj1->dictLookup("NewWindow", &obj5);
    action = new LinkGoToR(&obj3, &obj4, obj5.isBool() ?
			   (obj5.getBool() ? newWindow : oldWindow)
			   : userWindow);
    obj5.free();
    obj4.free();
    obj3.free();
    ...
    obj1->dictLookup("NewWindow", &obj3);
    action = new LinkLaunch(obj1, obj3.isBool() ?
			   (obj3.getBool() ? newWindow : oldWindow)
			   : userWindow);
    obj3.free();
