...
void ObjTracker::show(void *p) {
  fprintf(stderr, "Object %lx", p);
}

Object::Object(Object& obj) {
  memcpy(this, &obj, sizeof(*this));
  if (obj.type != objNone && obj.type != objNull) {
    objTracker.unTrack((void*)&obj);
    objTracker.track(this);
    obj.type = objNone;
  }
}
...
#ifdef DEBUG_MEM
  --numAlloc[type];
  if (type != objNone && type != objNull)
    objTracker.unTrack(this);
#endif
  type = objNone;
}
