...
//========================================================================
//
// EL (10/99): - Added a isOk() member function
//             - Added beginText()/endText() virtual functions
...
public:
  ...
  // Check if device was successfully created
  ...
  //----- path paiting operator
  virtual void pathOp(GfxState *state, int op);

  //----- text drawing
  virtual void beginText(GfxState *state) {}
  virtual void endText(GfxState *state) {}
