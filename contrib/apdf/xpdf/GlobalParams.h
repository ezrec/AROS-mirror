...
public:
  ...
  myFILE *getUnicodeMapFile(GString *encodingName);
  myFILE *findCMapFile(GString *collection, GString *cMapName);
  myFILE *findToUnicodeFile(GString *name);
  ...
  char **getFontPath() { return fontPath; }
...
private:
  ...
  void parseFile(GString *fileName, myFILE *f);
