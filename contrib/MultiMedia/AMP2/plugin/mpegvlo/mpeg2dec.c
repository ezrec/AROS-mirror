...
int vo_setup (void)
{
  ...
  /* Allocate an extra 32 rows as sefety border */
  size = mpeg2dec.picture->coded_picture_width * (mpeg2dec.picture->coded_picture_height + 32) / 4;
...
VERSION("MPEGVX-LO v1.02 (020904)");

IDENT_INIT
IDENT_ADD((TYPE_VIDEO | TYPE_LORES | SUBTYPE_MPEG1 | FEATURE_GRAY), FOURCC_NONE, init_mpeg, decode_mpeg, exit_mpeg)
IDENT_ADD((TYPE_VIDEO | TYPE_LORES | SUBTYPE_MPEG2 | FEATURE_GRAY), FOURCC_NONE, init_mpeg, decode_mpeg, exit_mpeg)
IDENT_ADD((TYPE_VIDEO | TYPE_LORES | SUBTYPE_MPEGX | FEATURE_GRAY), FOURCC_NONE, init_mpeg, decode_mpeg, exit_mpeg)
IDENT_EXIT
