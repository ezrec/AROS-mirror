...
static uint8_t default_intra_quantizer_matrix[64] ATTR_ALIGN(32) = {
    8,
    16, 16,
    19, 16, 19,
    22, 22, 22, 22,
...
uint8_t scan_norm[64] ATTR_ALIGN(32) =
{
...
uint8_t scan_alt[64] ATTR_ALIGN(32) =
{
...
int header_process_sequence_header (picture_t * picture, uint8_t * buffer)
{
    ...
    picture->picture_width = height >> 12;
    picture->picture_height = height & 0xfff;
...
/* LORES */
    picture->picture_width >>= 1;
    picture->picture_height >>= 1;
    width >>= 1;
    height >>= 1;
