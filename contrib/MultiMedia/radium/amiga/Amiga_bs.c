...
int OpenBlockSelectWindow( void )
{
	...
	BS_from0Nodes[0].ln_Succ=( struct Node * )&BS_from0List.mlh_Tail;
	BS_from0Nodes[0].ln_Pred=( struct Node * )&BS_from0List.mlh_Head;
	BS_from0Nodes[0].ln_Type=0;
	BS_from0Nodes[0].ln_Pri=0;
	BS_from0Nodes[0].ln_Name="0 - NN" ;

	BS_to0Nodes[0].ln_Succ=( struct Node * )&BS_to0List.mlh_Tail;
	BS_to0Nodes[0].ln_Pred=( struct Node * )&BS_to0List.mlh_Head;
	BS_to0Nodes[0].ln_Type=0;
	BS_to0Nodes[0].ln_Pri=0;
	BS_to0Nodes[0].ln_Name="0 - NN" ;
	...
	if ( ! ( BlockSelectWnd = OpenWindowTags( NULL,
				...
				WA_IDCMP,	LISTVIEWIDCMP|BUTTONIDCMP|IDCMP_NEWSIZE|IDCMP_REFRESHWINDOW,
