...
static void p2c_7 (const uint16_t *planar, uint32_t plane_size, uint8_t *chunky,
	uint32_t width, uint32_t height)
{
	uint32_t *cp;
	const uint16_t *pp1, *pp2, *pp3, *pp4, *pp5, *pp6, *pp7;
	uint32_t cd1, cd2, cd3, cd4;
	uint32_t pd1, pd2, pd3, pd4, pd5, pd6, pd7;
	uint32_t x, y;
	cp = (uint32_t *)chunky;
	pp1 = planar;
