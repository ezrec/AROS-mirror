...
/****i* etherlink3.device/ServiceRequest ***********************************
*
*   NAME
...
/****i* etherlink3.device/CMD_INVALID **************************************
*
*   NAME
...
/****** etherlink3.device/S2_MULTICAST *************************************
*
*   NAME
*	S2_MULTICAST --
*
...
/****** etherlink3.device/S2_DEVICEQUERY ***********************************
*
*   NAME
...
/****** etherlink3.device/S2_GETSTATIONADDDRESS ****************************
*
*   NAME
...
/****** etherlink3.device/S2_CONFIGINTERFACE *******************************
*
*   NAME
*	S2_CONFIGINTERFACE --
*
...
/****** etherlink3.device/S2_BROADCAST *************************************
*
*   NAME
*	S2_BROADCAST --
*
...
/****** etherlink3.device/S2_TRACKTYPE *************************************
*
*   NAME
*	S2_TRACKTYPE --
*
...
/****** etherlink3.device/S2_UNTRACKTYPE ***********************************
*
*   NAME
*	S2_UNTRACKTYPE --
*
...
/****** etherlink3.device/S2_GETTYPESTATS **********************************
*
*   NAME
*	S2_GETTYPESTATS --
*
...
/****** etherlink3.device/S2_GETSPECIALSTATS *******************************
*
*   NAME
*	S2_GETSPECIALSTATS --
*
...
/****** etherlink3.device/S2_GETGLOBALSTATS ********************************
*
*   NAME
*	S2_GETGLOBALSTATS --
*
...
/****** etherlink3.device/S2_READORPHAN ************************************
*
*   NAME
*	S2_READORPHAN --
*
...
/****** etherlink3.device/NSCMD_DEVICEQUERY ********************************
*
*   NAME
...
/****** etherlink3.device/S2_ADDMULTICASTADDRESS ***************************
*
*   NAME
*	S2_ADDMULTICASTADDRESS --
*
...
/****** etherlink3.device/S2_ADDMULTICASTADDRESSES *************************
*
*   NAME
*	S2_ADDMULTICASTADDRESSES --
*
...
/****** etherlink3.device/S2_DELMULTICASTADDRESS ***************************
*
*   NAME
*	S2_DELMULTICASTADDRESS --
*
...
/****** etherlink3.device/S2_DELMULTICASTADDRESSES *************************
*
*   NAME
*	S2_DELMULTICASTADDRESSES --
*
...
/****i* etherlink3.device/PutRequest ***************************************
*
*   NAME
*	PutRequest -- .
*
