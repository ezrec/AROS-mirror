...
MUIPC_Prefs__OM_NEW(struct IClass *CLASS,Object *self,struct opSet *message)
{
    ...
    if (self = (Object *)DoSuperNewTags
		(
            ...
            MUIA_Window_Title, _(MSG_Prefs_WinTitle),
            ...
            WindowContents, VGroup, // Window contents
                ...
                Child, RegisterGroup(registerLabels), // Register
                    ...
                    Child, VGroup,  // Interfaces
                        ...
                        Child, ColGroup(2),
                            Child, olabel2(MSG_Prefs_IF_Traffic_Format),
                            Child, HGroup,
                                Child, temp.tformat = ocycle(MSG_Prefs_IF_Traffic_Format,tformats,MSG_Prefs_IF_Traffic_Format_Help),
                                Child, olabel1(MSG_Prefs_IF_Traffic_Grouping),
                                Child, temp.tgrouping = ocheck(MSG_Prefs_IF_Traffic_Grouping,MSG_Prefs_IF_Traffic_Grouping_Help),
                            End,

                            Child, olabel2(MSG_Prefs_IF_Rate_Format),
                            Child, HGroup,
                                Child, temp.rformat = ocycle(MSG_Prefs_IF_Rate_Format,rformats,MSG_Prefs_IF_Rate_Format_Help),
                                Child, olabel1(MSG_Prefs_IF_Rate_Grouping),
                                Child, temp.rgrouping = ocheck(MSG_Prefs_IF_Rate_Grouping,MSG_Prefs_IF_Rate_Grouping_Help),
                            End,
                        End,
                    ...
                    Child, ScrollgroupObject,
                        ...
                        MUIA_Scrollgroup_Contents, VirtgroupObject,
                            ...
                            Child, HGroup,
                                Child, ColGroup(2),
                                    Child, temp.usebusybar = ocheck(MSG_Prefs_IF_UseBusyBar,MSG_Prefs_IF_UseBusyBar_Help),
                                        Child, ollabel1(MSG_Prefs_IF_UseBusyBar),
                                End,
                                Child, HSpace(0),
                            End,
                                Child, VSpace(0),
                    ...
                    Child, VGroup, // Miami ctrls
                        ...
                        Child, ColGroup(2),
                            Child, olabel2(MSG_Prefs_Miami_Position),
                            Child, temp.layout = ocycle(MSG_Prefs_Miami_Position,positions,MSG_Prefs_Miami_Position_Help),
                            Child, olabel2(MSG_Prefs_Miami_ViewMode),
                            Child, temp.viewMode = ocycle(MSG_Prefs_Miami_ViewMode,vmodes,MSG_Prefs_Miami_ViewMode_Help),
                            Child, olabel2(MSG_Prefs_Miami_BarLayout),
                            Child, temp.barLayout = ocycle(MSG_Prefs_Miami_BarLayout,sblayouts,MSG_Prefs_Miami_BarLayout_Help),
                            Child, olabel2(MSG_Prefs_Miami_LabelPosition),
                            Child, temp.labelPos = ocycle(MSG_Prefs_Miami_LabelPosition,lposs,MSG_Prefs_Miami_LabelPosition_Help),
                        End,
                        ...
                        Child, ScrollgroupObject,
                            ...
                            MUIA_Scrollgroup_Contents, VirtgroupObject,
                                ...
                                Child, HGroup,
                                    Child, ColGroup(2),
                                        Child, temp.borderless = ocheck(MSG_Prefs_Miami_Borderless,MSG_Prefs_Miami_Borderless_Help),
                                        Child, ollabel1(MSG_Prefs_Miami_Borderless),
                                        Child, temp.sunny = ocheck(MSG_Prefs_Miami_Sunny,MSG_Prefs_Miami_Sunny_Help),
                                        Child, ollabel1(MSG_Prefs_Miami_Sunny),
                                        Child, temp.raised = ocheck(MSG_Prefs_Miami_Raised,MSG_Prefs_Miami_Raised_Help),
                                        Child, ollabel1(MSG_Prefs_Miami_Raised),
                                        Child, temp.scaled = ocheck(MSG_Prefs_Miami_Scaled,MSG_Prefs_Miami_Scaled_Help),
                                        Child, ollabel1(MSG_Prefs_Miami_Scaled),
                                        Child, temp.underscore = ocheck(MSG_Prefs_Miami_Underscore,MSG_Prefs_Miami_Underscore_Help),
                                        Child, ollabel1(MSG_Prefs_Miami_Underscore),
                                        Child, temp.frame = ocheck(MSG_Prefs_Miami_Frame,MSG_Prefs_Miami_Frame_Help),
                                        Child, ollabel1(MSG_Prefs_Miami_Frame),
                                        Child, temp.dragBar = ocheck(MSG_Prefs_Miami_DragBar,MSG_Prefs_Miami_DragBar_Help),
                                        Child, ollabel1(MSG_Prefs_Miami_DragBar),
                                    End,
                                    Child, HSpace(0),
                                End,
                                Child, VSpace(0),
                    ...
                    Child, VGroup, // Options
                        ...
                        Child, ColGroup(2),
                            Child, olabel2(MSG_Prefs_OnIconify),
                            Child, temp.oniconify = ocycle(MSG_Prefs_OnIconify,oniconifies,MSG_Prefs_OnIconify_Help),
                        End,
                        ...
                        Child, ScrollgroupObject,
                            ...
                            MUIA_Scrollgroup_Contents, VirtgroupObject,
                                ...
                                Child, HGroup,
                                    Child, ColGroup(2),
                                        Child, temp.bwin = ocheck(MSG_Prefs_BWin,MSG_Prefs_BWin_Help),
                                        Child, ollabel1(MSG_Prefs_BWin),
                                        Child, temp.bwinBorders = ocheck(MSG_Prefs_BWinBorders,MSG_Prefs_BWinBorders_Help),
                                        Child, ollabel1(MSG_Prefs_BWinBorders),
                                        #ifdef __MORPHOS__
                                        Child, temp.useTransparency = ocheck(MSG_Prefs_UseTransparency,MSG_Prefs_UseTransparency_Help),
                                        Child, ollabel1(MSG_Prefs_UseTransparency),
                                        #endif
                                    End,
                                    Child, HSpace(0),
                                End,
                ...
                Child, HGroup, // Buttons
                    Child, save = obutton(MSG_Prefs_Save,MSG_Prefs_Save_Help),
                    Child, owspace(4),
                    Child, use = obutton(MSG_Prefs_Use,MSG_Prefs_Use_Help),
                    Child, owspace(4),
                    Child, apply = obutton(MSG_Prefs_Apply,MSG_Prefs_Apply_Help),
                    Child, owspace(4),
                    Child, test = obutton(MSG_Prefs_Test,MSG_Prefs_Test_Help),
                    Child, owspace(4),
                    Child, cancel = obutton(MSG_Prefs_Cancel,MSG_Prefs_Cancel_Help),
                End, // Buttons
