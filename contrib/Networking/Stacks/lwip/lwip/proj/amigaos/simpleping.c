...
static const char version[] = "$VER: simpleping 0.1 (2.9.2003)";
...
static void ping(struct sockaddr_in *addr)
{
...
int main(void)
{
  ...
  host = gethostbyname(cli_args.host);

  sockaddr.sin_len = sizeof(struct sockaddr_in);
	sockaddr.sin_family = AF_INET;
	sockaddr.sin_port = 1; /* ignored */
