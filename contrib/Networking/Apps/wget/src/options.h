...
struct options
{
  ...
  int dot_files;		/* FTP should add "-a" to "LIST" cmd */
  ...
  int max_filename_length;	/* How many chars long on filenames */
#if _AMIGASF
  int no_file_comments;		/* do not add the url as comment for
  				   the local file.  */
#endif
