...
*/
#ifndef _SQLITE_OS_AROS_H_
#define _SQLITE_OS_AROS_H_
...
struct OsFile {
	...
	BOOL isOpen;              /* True if needs to be closed */
	BOOL fullSync;            /* Use F_FULLSYNC if available */
