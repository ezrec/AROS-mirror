/* Example source
        ...
        Name:           example_lib.c
        Versionstring:  $VER: example_lib.c 1.0 (05.10.2004)
        Author:         Jens Langner
        Distribution:   PD
...
#define VERSION		51
#define REVISION	1
#define DATE		  "05.10.2004"
#define VERS		  "example.library 51.1"
#define VSTRING		"example.library 51.1 (10.5.2004)\r\n"
#define VERSTAG		"\0$VER: example.library 51.1 (10.5.2004)"

static const char UserLibName[] = "example.library";
static const char UserLibID[]   = "\0$VER: example.library 1.0 (05.10.04)";
...
char * LIBFUNC SayHelloOS4()
{
  return "Hello AmigaOS4!!!";
}

char * LIBFUNC SayHelloOS3()
{
  return "Hello AmigaOS3!!!";
}

char * LIBFUNC SayHelloMOS()
{
  return "Hello MorphOS!!!";
}

char * LIBFUNC Uppercase(REG(a0, char *txt))
{
  char *p = txt;
...
char * LIBFUNC STDARGS SPrintf(REG(a0, char *buf), REG(a1, char *fmt), ...)
{
	VA_LIST args;
