...
#define CONFIG_TCC_PREFIX "" //Removed
#endif
...
#if defined(WIN32) || defined(TCC_UCLIBC) || defined(__FreeBSD__) || defined(__AROS__)
/* currently incorrect */
...
void help(void)
{
    printf("tcc version 0.9.19 - Tiny C Compiler - Copyright (C) 2001-2003 Fabrice Bellard\n"
