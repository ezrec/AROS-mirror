...
{
  $Log$
  Revision 1.1  2002/02/19 08:24:18  sasu
  Initial revision

  Revision 1.1.2.2  2000/12/03 19:18:58  marco
   * Hide dummy dos-window

  Revision 1.1.2.1  2000/12/03 12:34:03  marco
   * First in a series of WinCrt fixes.
