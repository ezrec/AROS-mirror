...
{
  $Log$
  Revision 1.1  2002/02/19 08:25:11  sasu
  Initial revision

  Revision 1.1.2.3  2000/12/16 15:57:16  jonas
    * removed 64bit evaluations when range checking is on

  Revision 1.1.2.2  2000/11/11 15:53:27  jonas
    * fixed web bug1166

  Revision 1.1.2.1  2000/07/16 07:47:01  jonas
