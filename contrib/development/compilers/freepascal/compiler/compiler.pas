...
{$endif Delphi}
  ...
  cobjects,files,globals,options,parser,symtable,link,import,export,tokens;
...
end.
{
  ...
  Revision 1.1.2.4  2000/11/19 00:18:06  pierre
   + IsLibrary boolean for IDE

  Revision 1.1.2.3  2000/10/06 23:51:58  pierre
   * avoid IDE crash after compilation failure

  Revision 1.1.2.2  2000/08/21 09:09:08  jonas
    - removed catch unit from uses clause for Linux (clashed with fpcatch
     from IDE and is already in pp.pas for command line compiler)
