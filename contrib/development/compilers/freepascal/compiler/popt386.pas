...
{
 $Log$
 Revision 1.1  2002/02/19 08:22:48  sasu
 Initial revision
 ...
 Revision 1.1.2.6  2000/11/14 09:52:05  jonas
   * added missing allocregbetween()

 Revision 1.1.2.5  2000/10/02 12:54:32  jonas
 ...
 Revision 1.1.2.4  2000/09/18 11:24:47  jonas
   * fixed web bug 1133

 Revision 1.1.2.3  2000/08/18 10:04:20  jonas
   * fix for web bug1099

 Revision 1.1.2.2  2000/07/31 08:33:22  jonas
   - removed imul support from -dfoldarithops since "imull [reg32],[mem32]"
     doesn't exist

 Revision 1.1.2.1  2000/07/28 13:54:19  jonas
   * fixed bug in shr/shl optimization when -Og is used
