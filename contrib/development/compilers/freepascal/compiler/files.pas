...
{
  $Log$
  Revision 1.1  2002/02/19 08:22:20  sasu
  Initial revision

  Revision 1.1.2.3  2000/09/26 08:48:09  pierre
   * close ppu files if recompiling

  Revision 1.1.2.2  2000/08/13 08:59:18  peter
    * fixed fileseek() typo
