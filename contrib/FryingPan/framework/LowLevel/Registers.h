...
// so far it is the only way I know...
   ...
   #define XGETA0(var) asm volatile("mov.l a0,%0\n\t" : "=omg"(var))
   #define XGETA1(var) asm volatile("mov.l a1,%0\n\t" : "=omg"(var))
   #define XGETA2(var) asm volatile("mov.l a2,%0\n\t" : "=omg"(var))
   #define XGETA3(var) asm volatile("mov.l a3,%0\n\t" : "=omg"(var))
   #define XGETA4(var) asm volatile("mov.l a4,%0\n\t" : "=omg"(var))
   #define XGETA5(var) asm volatile("mov.l a5,%0\n\t" : "=omg"(var))
   #define XGETA6(var) asm volatile("mov.l a6,%0\n\t" : "=omg"(var))
   #define XGETA7(var) asm volatile("mov.l a7,%0\n\t" : "=omg"(var))
   #define XGETD0(var) asm volatile("mov.l d0,%0\n\t" : "=omg"(var))
   #define XGETD1(var) asm volatile("mov.l d1,%0\n\t" : "=omg"(var))
   #define XGETD2(var) asm volatile("mov.l d2,%0\n\t" : "=omg"(var))
   #define XGETD3(var) asm volatile("mov.l d3,%0\n\t" : "=omg"(var))
   #define XGETD4(var) asm volatile("mov.l d4,%0\n\t" : "=omg"(var))
   #define XGETD5(var) asm volatile("mov.l d5,%0\n\t" : "=omg"(var))
   #define XGETD6(var) asm volatile("mov.l d6,%0\n\t" : "=omg"(var))
   #define XGETD7(var) asm volatile("mov.l d7,%0\n\t" : "=omg"(var))
