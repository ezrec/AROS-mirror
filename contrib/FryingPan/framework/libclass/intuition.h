...
//    PROC9(os4multiarg2, 78, struct Gadget *, gadget, d0, struct Window *, window, d1, struct Requester *, requester, d2, uint16, flags, d3, uint16, horizPot, d4, uint16, vertPot, d5, uint16, horizBody, d6, uint16, vertBody, d7, int16, numGad, a0);
      ...
      FUNC2(uint32, GetAttrsA, 0, void *, object, d0, const struct TagItem *, tagList, d1);
      PROC0(dummy16, 0);
      ...
      PROC0(dummy19, 0);
      FUNC3(uint32, IDoSuperMethodA, 0, Class *, cl, d0, Object *, object, d1, uint32*, msg, d2);
      PROC0(dummy20, 0);
      FUNC3(uint32, ISetSuperAttrsA, 0, Class *, cl, d0, Object *, object, d1, const struct TagItem *, taglist, d2);
      PROC0(dummy21, 0);
      FUNC3(uint32, ICoerceMethodA, 0, Class *, cl, d0, Object *, object, d1, uint32*, msg, d2);
      PROC0(dummy22, 0);
      FUNC2(uint32, IDoMethodA, 0, Object *, object, d0, uint32*, msg, d1);
      PROC0(dummy23, 0);
      ...
      PROC0(dummy26, 0);
      FUNC4(int32, GetWindowAttr, 0, struct Window *, win, d0, uint32, attr, d1, void *, data, d2, uint32, size, d3);
      FUNC4(int32, SetWindowAttr, 0, struct Window *, win, d0, uint32, attr, d1, void *, data, d2, uint32, size, d3);
