...
#include <utility/tagitem.h>
   ...
   BEGINDECL(Utility, "utility.library")
      ...
      FUNC3(uint32,                 CallHookPkt,           18, const struct Hook*,  hook,    a0,   void*,                  param1,  a2, void*,                 param2,  a1);
      PROC0(                        dummy1,                19);
      ...
      FUNC2(struct SkipNode*,       FindSkipNode,          34, const SkipList*,     list,    a0,   void*,                  key,     a1);
      ...
      FUNC3(struct SkipNode*,       InsertSkipNode,        37, struct SkipList*,    list,    a0,   void*,                  key,     a1, uint32,                dtsize,  d0);
      FUNC2(bool,                   RemoveSkipNode,        38, struct SkipList*,    list,    a0,   void*,                  key,     a1);
      FUNC1(struct SplayTree*,      CreateSplayTree,       39, const struct Hook*,  hook,    a0);
      PROC1(                        DeleteSplayTree,       40, struct SplayTree*,   tree,    a0);
      FUNC2(struct SplayNode*,      FindSplayNode,         41, const SplayTree*,    tree,    a0,   void*,                  key,     a1);
      FUNC3(struct SplayNode*,      InsertSplayNode,       42, struct SplayTree*,   tree,    a0,   void*,                  key,     a1, uint32,                dtsize,  d0);
      FUNC2(struct SplayNode*,      RemoveSplayNode,       43, struct SplayTree*,   tree,    a0,   void*,                  key,     a1);
      ...
      PROC3(                        Digest_SHA_Update,     48, struct MessageDigest_SHA*, sha, a0, void*,                  data,    a1, int32,                 len,     d0);
      ...
      FUNC3(void*,                  SetMem,                52, void*,               dest,    a0,   uint8,                  fillch,  d0, int32,                 len,     d1);
      ...
      FUNC2(const char*,            VASPrintf,             59, const char*,         fmt,     a0,   void*,                  args,    a1);
      PROC0(                        dummy3,                60);
      FUNC4(const char*,            VSSPrintf,             59, char*,               buffer,  a0,   int32,                  buflen,  d0, const char*,           fmt,     a1,   void*,               args,    a2);
      PROC0(                        dummy4,                60);
#else
      FUNC2(struct TagItem*,        FindTagItem,            5, Tag,                 value,   d0,   const struct TagItem*,  list,    a0);
      FUNC3(uint32,                 GetTagData,             6, Tag,                 value,   d0,   uint32,                 deflt,   d1, const struct TagItem*, list,    a0);
      ...
      FUNC3(uint32,                 CallHookPkt,           17, const struct Hook*,  hook,    a0,   void*,                  param1,  a2, void*,                 param2,  a1);
