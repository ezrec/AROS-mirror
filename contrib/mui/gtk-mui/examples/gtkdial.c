...
gtk_dial_class_init (GtkDialClass *class)
{
  ...
  object_class->destroy = gtk_dial_destroy; /* TODO */

  widget_class->realize = gtk_dial_realize;  
  widget_class->expose_event = gtk_dial_expose;
  widget_class->size_request = gtk_dial_size_request;
  widget_class->size_allocate = gtk_dial_size_allocate;
  widget_class->button_press_event = gtk_dial_button_press; /* TODO */
  widget_class->button_release_event = gtk_dial_button_release; /* TODO */
  widget_class->motion_notify_event = gtk_dial_motion_notify; /* TODO */
			  ...
			  GtkAdjustment *adjustment)
{
  ...
  DebOut("ok\n");
  DebOut("dial: %lx\n",dial);
  DebOut("dial->adjustment: %lx",dial->adjustment);
  if (dial->adjustment)
    {
			...
			GtkAllocation *allocation)
{
  ...
  DebOut("dial->radius=%d\n",dial->radius);
  DebOut("dial->pointer_width=%d\n",dial->pointer_width);
}

static void testme(GtkWidget      *widget) {
  gint w, h;
  ...
  gtk_paint_box (widget->style,widget->window,GTK_STATE_NORMAL,GTK_SHADOW_OUT,NULL,widget,NULL,0,0,w/4,h/4);


  gtk_paint_slider(widget->style,widget->window,GTK_STATE_NORMAL,GTK_SHADOW_OUT,NULL,widget,"hscale",w/3,0,w/4,h/4,GTK_ORIENTATION_HORIZONTAL);

  gtk_paint_flat_box(widget->style,widget->window,GTK_STATE_NORMAL,GTK_SHADOW_OUT,NULL,widget,"text",2*w/3,0,w/4,h/4);
  /* arrows */

  gtk_paint_arrow(widget->style,widget->window,GTK_STATE_SELECTED,GTK_SHADOW_OUT,NULL,widget,NULL,GTK_ARROW_DOWN,1,0,h/3,w/4,h/4);
  gtk_paint_arrow(widget->style,widget->window,GTK_STATE_NORMAL,GTK_SHADOW_OUT,NULL,widget,NULL,GTK_ARROW_UP,0,w/3,h/3,w/4,h/4);
  gtk_paint_arrow(widget->style,widget->window,GTK_STATE_NORMAL,GTK_SHADOW_OUT,NULL,widget,NULL,GTK_ARROW_LEFT,1,2*w/3,h/3,w/4,h/4);

  /* check */
  gtk_paint_check(widget->style,widget->window,GTK_STATE_NORMAL,GTK_SHADOW_OUT,NULL,widget,"cellcheck",0,2*h/3,w/4,h/4);
  gtk_paint_check(widget->style,widget->window,GTK_STATE_ACTIVE,GTK_SHADOW_OUT,NULL,widget,NULL,w/3,2*h/3,w/4,h/4);
  /* extension */
    gtk_paint_extension(widget->style,widget->window,GTK_STATE_ACTIVE,GTK_SHADOW_OUT,NULL,widget,NULL,2*w/3,2*h/3,w/4,h/4,GTK_POS_RIGHT);
