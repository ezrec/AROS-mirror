/**************************************************
 * taken and modified from the gtk+-2.6.9 sources,
 * there was no "original copyright header", so 
 * don't complain, that it is missing.
 *
 * o1i
 *
 * $Id: gdkcolor.h,v 1.4 2005/12/12 16:18:58 itix Exp $
 **************************************************/
