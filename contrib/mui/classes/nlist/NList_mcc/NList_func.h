...
#define STYLE_MASK      (0x0007)
#define STYLE_UNDERLINE (0x0001)
#define STYLE_BOLD      (0x0002)
#define STYLE_ITALIC    (0x0004)
#define SET_STYLE_NORMAL(s)    ((s) = (s) & ~STYLE_MASK)
#define SET_STYLE_UNDERLINE(s) ((s) = (s) | STYLE_UNDERLINE)
#define SET_STYLE_BOLD(s)      ((s) = (s) | STYLE_BOLD)
#define SET_STYLE_ITALIC(s)    ((s) = (s) | STYLE_ITALIC)
#define IS_STYLE_NORMAL(s)     (!((s) & STYLE_MASK))
#define IS_STYLE_UNDERLINE(s)  ((s) & STYLE_UNDERLINE)
#define IS_STYLE_BOLD(s)       ((s) & STYLE_BOLD)
#define IS_STYLE_ITALIC(s)     ((s) & STYLE_ITALIC)
