...
void _STARTCLOCK(unsigned long dclass, unsigned long dflags, const char *file, unsigned long line);
void _STOPCLOCK(unsigned long dclass, unsigned long dflags, const char *file, unsigned long line, const char *msg);
...
#define STARTCLOCK(f)          _STARTCLOCK(DBC_TIMEVAL, f, __FILE__, __LINE__)
#define STOPCLOCK(f, msg)      _STOPCLOCK(DBC_TIMEVAL, f, __FILE__, __LINE__, msg)
