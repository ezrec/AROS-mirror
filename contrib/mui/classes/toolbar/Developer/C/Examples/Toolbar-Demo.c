...
VOID TestFunc(REG(a0) struct Hook *hook, REG(a2) APTR unused, REG(a1) ULONG *prms)
{
...
#ifdef __AROS__
const struct Hook TestHook  = { { NULL,NULL }, HookEntry, (HOOKFUNC)TestFunc,NULL };
#else
					...
					WindowContents, HGroup,
						Child, VGroup,
							...
							Child, TX_About = NFloattextObject,
								...
								TextFrame,
								MUIA_NFloattext_Text,	"This is a simple demonstration of the features "
