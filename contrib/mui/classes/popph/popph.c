...
/*
** $Id: popph.c,v 1.8 2000/04/04 17:58:19 carlos Exp $
**
...
void __saveds __asm WindowFunc(register __a0 struct Hook *hook, register __a2 Object *popobject, register __a1 Object *window)
{
...
void * __saveds __asm ObjStrFunc( register __a0 struct Hook *hook,
...
//               set( xget( data->str, MUIA_Window ), MUIA_Window_ActiveObject, data->str );

//               DoMethod(_app(data->str), MUIM_Application_PushMethod,
//               _win(data->str), 3, MUIM_Set, MUIA_Window_ActiveObject, data->str);
...
//|
/// HOOK: DisplayHook
void * __saveds __asm DisplayFunc(register __a0 struct Hook *hook, register __a2 char **array, register __a1 char *node)
{
...
/// _OpenAsl
ULONG _OpenAsl(struct IClass *cl, Object *obj, struct opSet *msg)
{
...
ULONG  avoid;
        ...
        // shall it be popph/popasl combined object?
...
//       if( ! (asl_type = GetTagData( MUIA_Popasl_Type, ASL_FileRequest, ((struct opSet *)msg)->ops_AttrList )) )
...
/*
                   ...
                   {
                   set( popaslbutton, MUIA_CycleChain, TRUE );
//           set( popaslbutton, MUIA_ControlChar, ParseHotKey(key));
                   }
*/
...
//    DoMethod( data->popobj, MUIM_Popstring_Close, TRUE );

/*
        if( data->string )
           {
           MUI_DisposeObject( data->string );
...
/*
        D(bug(__NAME ": data->popaslbutton: %lx\n", data->popaslbutton ));
        if( data->popaslbutton )
           {
           MUI_DisposeObject( data->popaslbutton );
           data->popaslbutton = NULL;
           }
*/
