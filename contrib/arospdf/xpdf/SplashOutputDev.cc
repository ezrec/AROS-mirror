...
struct T3GlyphStack {
  ...
  T3GlyphStack *next;		// next xObject on stack
};
...
void SplashOutputDev::doUpdateFont(GfxState *state) {
  ...
  if ((fontFile = fontEngine->getFontFile(id))) {
	...
	goto err2;
      ...
      refObj.free();
      if (!strObj.isStream()) {
	error(-1, "Embedded font xObject is wrong type");
	strObj.free();
	fclose(tmpFile);
	goto err2;
      }
...
void SplashOutputDev::drawImageMask(GfxState *state, xObject *ref, Stream *str,
...
void SplashOutputDev::drawImage(GfxState *state, xObject *ref, Stream *str,
...
void SplashOutputDev::drawMaskedImage(GfxState *state, xObject *ref,
				      Stream *str, int width, int height,
				      GfxImageColorMap *colorMap,
				      Stream *maskStr, int maskWidth,
				      int maskHeight, GBool maskInvert) {
  GfxImageColorMap *maskColorMap;
  xObject maskDecode, decodeLow, decodeHigh;
  double *ctm;
  SplashCoord mat[6];
...
void SplashOutputDev::drawSoftMaskedImage(GfxState *state, xObject *ref,
					  Stream *str, int width, int height,
					  GfxImageColorMap *colorMap,
					  Stream *maskStr,
