...
void OutputDev::drawImageMask(GfxState *state, xObject *ref, Stream *str,
...
void OutputDev::drawImage(GfxState *state, xObject *ref, Stream *str,
...
void OutputDev::drawMaskedImage(GfxState *state, xObject *ref, Stream *str,
...
void OutputDev::drawSoftMaskedImage(GfxState *state, xObject *ref, Stream *str,
				    int width, int height,
				    GfxImageColorMap *colorMap,
				    Stream *maskStr,
				    int maskWidth, int maskHeight,
