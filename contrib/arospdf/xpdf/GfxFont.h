...
public:
  ...
  xObject *getCharProc(int code, xObject *proc);
...
private:
  ...
  xObject charProcs;		// Type 3 CharProcs dictionary
  xObject resources;		// Type 3 Resources dictionary
};
