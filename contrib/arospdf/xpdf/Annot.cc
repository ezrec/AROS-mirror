...
Annot::Annot(XRef *xrefA, Dict *acroForm, Dict *dict, Ref *refA) {
  xObject apObj, asObj, obj1, obj2, obj3;
...
void Annot::generateFieldAppearance(Dict *field, Dict *annot, Dict *acroForm) {
  xObject mkObj, ftObj, appearDict, drObj, obj1, obj2, obj3;
  Dict *mkDict;
...
xObject *Annot::fieldLookup(Dict *field, char *key, xObject *obj) {
  Dict *dict;
  xObject parent;
...
Annots::Annots(XRef *xref, Catalog *catalog, xObject *annotsObj) {
  Dict *acroForm;
  Annot *annot;
  xObject obj1;
  Ref ref;
