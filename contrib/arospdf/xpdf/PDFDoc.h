...
public:
  ...
  xObject *getStructTreeRoot() { return catalog->getStructTreeRoot(); }
  ...
  xObject *getDocInfo(xObject *obj) { return xref->getDocInfo(obj); }
  xObject *getDocInfoNF(xObject *obj) { return xref->getDocInfoNF(obj); }
  ...
  // Return a pointer to the GUI (XPDFCore or WinPDFCore xObject).
