...
void PreScanOutputDev::beginStringOp(GfxState *state) {
  ...
  if (simpleTTF) {
    //~ need to create a FoFiTrueType xObject, and check for a Unicode cmap
  }
...
void PreScanOutputDev::drawImageMask(GfxState *state, xObject *ref, Stream *str,
...
void PreScanOutputDev::drawImage(GfxState *state, xObject *ref, Stream *str,
...
void PreScanOutputDev::drawMaskedImage(GfxState *state, xObject *ref,
				       Stream *str,
				       int width, int height,
				       GfxImageColorMap *colorMap,
				       Stream *maskStr,
...
void PreScanOutputDev::drawSoftMaskedImage(GfxState *state, xObject *ref,
					   Stream *str,
					   int width, int height,
					   GfxImageColorMap *colorMap,
					   Stream *maskStr,
