...
public:
  ...
  static Function *parse(xObject *funcObj);
...
public:
  ...
  SampledFunction(xObject *funcObj, Dict *dict);
...
public:
  ...
  ExponentialFunction(xObject *funcObj, Dict *dict);
...
public:
  ...
  StitchingFunction(xObject *funcObj, Dict *dict);
...
public:
  ...
  PostScriptFunction(xObject *funcObj, Dict *dict);
