...
LinkAction *LinkAction::parseDest(xObject *obj) {
  LinkAction *action;
...
LinkAction *LinkAction::parseAction(xObject *obj, GString *baseURI) {
  LinkAction *action;
  xObject obj2, obj3, obj4;
...
GString *LinkAction::getFileSpecName(xObject *fileSpecObj) {
  GString *name;
  xObject obj1;
...
LinkGoTo::LinkGoTo(xObject *destObj) {
  dest = NULL;
  namedDest = NULL;
...
LinkGoToR::LinkGoToR(xObject *fileSpecObj, xObject *destObj) {
  dest = NULL;
  namedDest = NULL;
...
LinkLaunch::LinkLaunch(xObject *actionObj) {
  xObject obj1, obj2;
...
LinkURI::LinkURI(xObject *uriObj, GString *baseURI) {
  GString *uri2;
  int n;
  char c;
...
LinkNamed::LinkNamed(xObject *nameObj) {
  name = NULL;
  if (nameObj->isName()) {
...
LinkMovie::LinkMovie(xObject *annotObj, xObject *titleObj) {
  annotRef.num = -1;
  title = NULL;
  if (annotObj->isRef()) {
...
Links::Links(xObject *annots, GString *baseURI) {
  Link *link;
  xObject obj1, obj2;
  int size;
  int i;
