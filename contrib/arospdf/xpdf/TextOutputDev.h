...
public:
  ...
  // Get the TextFontInfo xObject associated with this word.
...
private:
  ...
  GList *fonts;			// all font info xObjects used on this
				//   page [TextFontInfo]
...
public:
  ...
  // Returns the TextPage xObject for the last rasterized page,
