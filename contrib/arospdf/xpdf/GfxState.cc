...
GfxColorSpace *GfxColorSpace::parse(xObject *csObj) {
  GfxColorSpace *cs;
  xObject obj1;
...
GfxPattern *GfxPattern::parse(xObject *obj) {
  GfxPattern *pattern;
  xObject obj1;
...
GfxTilingPattern *GfxTilingPattern::parse(xObject *patObj) {
...
GfxTilingPattern::GfxTilingPattern(int paintTypeA, int tilingTypeA,
				   ...
				   xObject *resDictA, double *matrixA,
				   xObject *contentStreamA):
  GfxPattern(1)
{
  int i;
...
GfxShadingPattern *GfxShadingPattern::parse(xObject *patObj) {
  Dict *dict;
  GfxShading *shadingA;
  double matrixA[6];
  xObject obj1, obj2;
...
GfxShading *GfxShading::parse(xObject *obj) {
  GfxShading *shading;
  Dict *dict;
  int typeA;
  xObject obj1;
  ...
  case 4:
    if (obj->isStream()) {
      ...
      error(-1, "Invalid Type 4 shading xObject");
      goto err1;
    }
    break;
  case 5:
    if (obj->isStream()) {
      ...
      error(-1, "Invalid Type 5 shading xObject");
      goto err1;
    }
    break;
  case 6:
    if (obj->isStream()) {
      ...
      error(-1, "Invalid Type 6 shading xObject");
      goto err1;
    }
    break;
  case 7:
    if (obj->isStream()) {
      ...
      error(-1, "Invalid Type 7 shading xObject");
      goto err1;
    }
    break;
  default:
...
GfxImageColorMap::GfxImageColorMap(int bitsA, xObject *decode,
...
GBool GfxState::parseBlendMode(xObject *obj, GfxBlendMode *mode) {
  xObject obj2;
  int i, j;
