  ...
  GfxFont(tagA, idA, nameA)
{
  ...
  // construct the char code -> Unicode mapping xObject
...
xObject *Gfx8BitFont::getCharProc(int code, xObject *proc) {
  ...
  GfxFont(tagA, idA, nameA)
{
  ...
  xObject desFontDictObj;
  xObject obj1, obj2, obj3, obj4, obj5, obj6;
