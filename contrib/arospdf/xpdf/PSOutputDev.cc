...
void PSOutputDev::setupResources(Dict *resDict) {
  xObject xObjDict, xObjRef, xObj, patDict, patRef, pat, resObj;
  Ref ref0, ref1;
  GBool skip;
  int i, j;
...
void PSOutputDev::setupEmbeddedType1Font(Ref *id, GString *psName) {
  ...
  refObj.free();
  if (!strObj.isStream()) {
    error(-1, "Embedded font file xObject is not a stream");
    goto err1;
  }
...
void PSOutputDev::setupImages(Dict *resDict) {
  xObject xObjDict, xObj, xObjRef, subtypeObj;
  int i;
...
void PSOutputDev::setupForm(Ref id, xObject *strObj) {
  Dict *dict, *resDict;
  xObject matrixObj, bboxObj, resObj, obj1;
  double m[6], bbox[4];
  PDFRectangle box;
  Gfx *gfx;
  int i;
...
void PSOutputDev::tilingPatternFill(GfxState *state, xObject *str,
...
void PSOutputDev::drawImageMask(GfxState *state, xObject *ref, Stream *str,
...
void PSOutputDev::drawImage(GfxState *state, xObject *ref, Stream *str,
...
void PSOutputDev::drawMaskedImage(GfxState *state, xObject *ref, Stream *str,
...
void PSOutputDev::doImageL1(xObject *ref, GfxImageColorMap *colorMap,
...
void PSOutputDev::doImageL2(xObject *ref, GfxImageColorMap *colorMap,
			    GBool invert, GBool inlineImg,
			    Stream *str, int width, int height, int len,
...
void PSOutputDev::doImageL3(xObject *ref, GfxImageColorMap *colorMap,
			    GBool invert, GBool inlineImg,
			    Stream *str, int width, int height, int len,
			    int *maskColors, Stream *maskStr,
			    int maskWidth, int maskHeight, GBool maskInvert) {
...
GBool PSOutputDev::getFileSpec(xObject *fileSpec, xObject *fileName) {
