...
public:
  ...
  // Get appearance xObject.
  xObject *getAppearance(xObject *obj) { return appearance.fetch(xref, obj); }
...
private:
  ...
  xObject *fieldLookup(Dict *field, char *key, xObject *obj);

  XRef *xref;			// the xref table for this PDF file
  Ref ref;			// xObject ref identifying this annotation
  GString *type;		// annotation type
  xObject appearance;		// a reference to the Form XObject stream
...
public:
  ...
  // Build a list of Annot xObjects.
  Annots(XRef *xref, Catalog *catalog, xObject *annotsObj);
