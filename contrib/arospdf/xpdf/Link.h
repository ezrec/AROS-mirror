...
public:
  ...
  static LinkAction *parseDest(xObject *obj);

  // Parse an action dictionary.
  static LinkAction *parseAction(xObject *obj, GString *baseURI = NULL);

  // Extract a file name from a file specification (string or
  // dictionary).
  static GString *getFileSpecName(xObject *fileSpecObj);
};
...
public:
  ...
  LinkGoToR(xObject *fileSpecObj, xObject *destObj);
...
public:
  ...
  LinkURI(xObject *uriObj, GString *baseURI);
...
public:
  ...
  LinkMovie(xObject *annotObj, xObject *titleObj);
...
public:
  ...
  Links(xObject *annots, GString *baseURI);
