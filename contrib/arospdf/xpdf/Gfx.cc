...
GBool GfxResources::lookupXObject(char *name, xObject *obj) {
  GfxResources *resPtr;
...
GBool GfxResources::lookupXObjectNF(char *name, xObject *obj) {
  GfxResources *resPtr;
...
void GfxResources::lookupColorSpace(char *name, xObject *obj) {
  GfxResources *resPtr;
...
GBool GfxResources::lookupGState(char *name, xObject *obj) {
  GfxResources *resPtr;
...
void Gfx::display(xObject *obj, GBool topLevel) {
  xObject obj2;
  int i;
...
void Gfx::go(GBool topLevel) {
  xObject obj;
  xObject args[maxArgs];
  int numArgs, i;
  int lastAbortCheck;

  // scan a sequence of xObjects
...
void Gfx::execOp(xObject *cmd, xObject args[], int numArgs) {
  Operator *op;
  char *name;
  xObject *argPtr;
  int i;
...
GBool Gfx::checkArg(xObject *arg, TchkType type) {
  switch (type) {
...
void Gfx::opSave(xObject args[], int numArgs) {
  saveState();
}

void Gfx::opRestore(xObject args[], int numArgs) {
  restoreState();
}

void Gfx::opConcat(xObject args[], int numArgs) {
...
void Gfx::opSetDash(xObject args[], int numArgs) {
  Array *a;
  int length;
  xObject obj;
  double *dash;
...
void Gfx::opSetFlat(xObject args[], int numArgs) {
  state->setFlatness((int)args[0].getNum());
  out->updateFlatness(state);
}

void Gfx::opSetLineJoin(xObject args[], int numArgs) {
  state->setLineJoin(args[0].getInt());
  out->updateLineJoin(state);
}

void Gfx::opSetLineCap(xObject args[], int numArgs) {
  state->setLineCap(args[0].getInt());
  out->updateLineCap(state);
}

void Gfx::opSetMiterLimit(xObject args[], int numArgs) {
  state->setMiterLimit(args[0].getNum());
  out->updateMiterLimit(state);
}

void Gfx::opSetLineWidth(xObject args[], int numArgs) {
  state->setLineWidth(args[0].getNum());
  out->updateLineWidth(state);
}

void Gfx::opSetExtGState(xObject args[], int numArgs) {
  xObject obj1, obj2, obj3, obj4, obj5;
  GfxBlendMode mode;
  GBool haveFillOP;
  Function *funcs[4];
...
void Gfx::doSoftMask(xObject *str, GBool alpha,
		     GfxColorSpace *blendingColorSpace,
...
void Gfx::opSetRenderingIntent(xObject args[], int numArgs) {
}
...
void Gfx::opSetFillGray(xObject args[], int numArgs) {
  GfxColor color;
...
void Gfx::opSetStrokeGray(xObject args[], int numArgs) {
  GfxColor color;
...
void Gfx::opSetFillCMYKColor(xObject args[], int numArgs) {
  GfxColor color;
  int i;
...
void Gfx::opSetStrokeCMYKColor(xObject args[], int numArgs) {
  GfxColor color;
  int i;
...
void Gfx::opSetFillRGBColor(xObject args[], int numArgs) {
  GfxColor color;
  int i;
...
void Gfx::opSetStrokeRGBColor(xObject args[], int numArgs) {
  GfxColor color;
  int i;
...
void Gfx::opSetFillColorSpace(xObject args[], int numArgs) {
  xObject obj;
...
void Gfx::opSetStrokeColorSpace(xObject args[], int numArgs) {
  xObject obj;
  GfxColorSpace *colorSpace;
  GfxColor color;
...
void Gfx::opSetFillColor(xObject args[], int numArgs) {
  GfxColor color;
  int i;
...
void Gfx::opSetStrokeColor(xObject args[], int numArgs) {
  GfxColor color;
  int i;
...
void Gfx::opSetFillColorN(xObject args[], int numArgs) {
  GfxColor color;
  GfxPattern *pattern;
  int i;
...
void Gfx::opSetStrokeColorN(xObject args[], int numArgs) {
  GfxColor color;
  GfxPattern *pattern;
  int i;
...
void Gfx::opMoveTo(xObject args[], int numArgs) {
  state->moveTo(args[0].getNum(), args[1].getNum());
}

void Gfx::opLineTo(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opCurveTo(xObject args[], int numArgs) {
...
void Gfx::opCurveTo1(xObject args[], int numArgs) {
  double x1, y1, x2, y2, x3, y3;
...
void Gfx::opCurveTo2(xObject args[], int numArgs) {
  double x1, y1, x2, y2, x3, y3;
...
void Gfx::opRectangle(xObject args[], int numArgs) {
  double x, y, w, h;
...
void Gfx::opClosePath(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opEndPath(xObject args[], int numArgs) {
  doEndPath();
}

void Gfx::opStroke(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opCloseStroke(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opFill(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opEOFill(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opFillStroke(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opCloseFillStroke(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opEOFillStroke(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opCloseEOFillStroke(xObject args[], int numArgs) {
  if (!state->isCurPt()) {
...
void Gfx::opShFill(xObject args[], int numArgs) {
  GfxShading *shading;
  GfxPath *savedPath;
  double xMin, yMin, xMax, yMax;
...
void Gfx::opClip(xObject args[], int numArgs) {
  clip = clipNormal;
}

void Gfx::opEOClip(xObject args[], int numArgs) {
  clip = clipEO;
}
...
void Gfx::opBeginText(xObject args[], int numArgs) {
...
void Gfx::opEndText(xObject args[], int numArgs) {
...
void Gfx::opSetCharSpacing(xObject args[], int numArgs) {
  state->setCharSpace(args[0].getNum());
  out->updateCharSpace(state);
}

void Gfx::opSetFont(xObject args[], int numArgs) {
  GfxFont *font;
...
void Gfx::opSetTextLeading(xObject args[], int numArgs) {
  state->setLeading(args[0].getNum());
}

void Gfx::opSetTextRender(xObject args[], int numArgs) {
  state->setRender(args[0].getInt());
  out->updateRender(state);
}

void Gfx::opSetTextRise(xObject args[], int numArgs) {
  state->setRise(args[0].getNum());
  out->updateRise(state);
}

void Gfx::opSetWordSpacing(xObject args[], int numArgs) {
  state->setWordSpace(args[0].getNum());
  out->updateWordSpace(state);
}

void Gfx::opSetHorizScaling(xObject args[], int numArgs) {
...
void Gfx::opTextMove(xObject args[], int numArgs) {
  double tx, ty;
...
void Gfx::opTextMoveSet(xObject args[], int numArgs) {
  double tx, ty;
...
void Gfx::opSetTextMatrix(xObject args[], int numArgs) {
...
void Gfx::opTextNextLine(xObject args[], int numArgs) {
  double tx, ty;
...
void Gfx::opShowText(xObject args[], int numArgs) {
  if (!state->getFont()) {
...
void Gfx::opMoveShowText(xObject args[], int numArgs) {
  double tx, ty;
...
void Gfx::opMoveSetShowText(xObject args[], int numArgs) {
  double tx, ty;
...
void Gfx::opShowSpaceText(xObject args[], int numArgs) {
  Array *a;
  xObject obj;
  int wMode;
  int i;
...
void Gfx::opXObject(xObject args[], int numArgs) {
  char *name;
  xObject obj1, obj2, obj3, refObj;
#if OPI_SUPPORT
  xObject opiDict;
#endif
...
void Gfx::doImage(xObject *ref, Stream *str, GBool inlineImg) {
  Dict *dict, *maskDict;
  int width, height;
  int bits, maskBits;
...
void Gfx::doForm(xObject *str) {
  Dict *dict;
  GBool transpGroup, isolated, knockout;
  GfxColorSpace *blendingColorSpace;
  xObject matrixObj, bboxObj;
  double m[6], bbox[4];
  xObject resObj;
  Dict *resDict;
...
void Gfx::doForm1(xObject *str, Dict *resDict, double *matrix, double *bbox,
...
void Gfx::opBeginImage(xObject args[], int numArgs) {
  Stream *str;
  int c1, c2;
...
Stream *Gfx::buildImageStream() {
  ...
  while (!obj.isCmd("ID") && !obj.isEOF()) {
    if (!obj.isName()) {
      error(getPos(), "Inline image dictionary key must be a name xObject");
      obj.free();
    } else {
...
void Gfx::opImageData(xObject args[], int numArgs) {
  error(getPos(), "Internal: got 'ID' operator");
}

void Gfx::opEndImage(xObject args[], int numArgs) {
...
void Gfx::opSetCharWidth(xObject args[], int numArgs) {
  out->type3D0(state, args[0].getNum(), args[1].getNum());
}

void Gfx::opSetCacheDevice(xObject args[], int numArgs) {
...
void Gfx::opBeginIgnoreUndef(xObject args[], int numArgs) {
  ++ignoreUndef;
}

void Gfx::opEndIgnoreUndef(xObject args[], int numArgs) {
  if (ignoreUndef > 0)
    --ignoreUndef;
}
...
void Gfx::opBeginMarkedContent(xObject args[], int numArgs) {
  if (printCommands) {
...
void Gfx::opEndMarkedContent(xObject args[], int numArgs) {
}

void Gfx::opMarkPoint(xObject args[], int numArgs) {
  if (printCommands) {
...
void Gfx::drawAnnot(xObject *str, AnnotBorderStyle *borderStyle,
		    double xMin, double yMin, double xMax, double yMax) {
  Dict *dict, *resDict;
  xObject matrixObj, bboxObj, resObj;
  xObject obj1;
