...
public:
  ...
  static GfxColorSpace *parse(xObject *csObj);
...
public:
  ...
  static GfxPattern *parse(xObject *obj);
...
public:
  ...
  static GfxTilingPattern *parse(xObject *patObj);
  ...
  xObject *getContentStream() { return &contentStream; }
...
public:
  ...
  static GfxShadingPattern *parse(xObject *patObj);
...
public:
  ...
  static GfxShading *parse(xObject *obj);
...
public:
  ...
  // Constructor.
  GfxImageColorMap(int bitsA, xObject *decode, GfxColorSpace *colorSpaceA);
...
public:
  ...
  // Misc
  GBool parseBlendMode(xObject *obj, GfxBlendMode *mode);
