...
public:
  ...
  static SecurityHandler *make(PDFDoc *docA, xObject *encryptDictA);
  ...
  // a password.  Returns an authorization data xObject, or NULL to
  // cancel.
...
public:
  ...
  StandardSecurityHandler(PDFDoc *docA, xObject *encryptDictA);
...
public:
  ...
  ExternalSecurityHandler(PDFDoc *docA, xObject *encryptDictA,
