...
SecurityHandler *SecurityHandler::make(PDFDoc *docA, xObject *encryptDictA) {
  xObject filterObj;
...
StandardSecurityHandler::StandardSecurityHandler(PDFDoc *docA,
						 xObject *encryptDictA):
  SecurityHandler(docA)
{
  xObject versionObj, revisionObj, lengthObj;
  xObject ownerKeyObj, userKeyObj, permObj, fileIDObj;
  xObject fileIDObj1;
  xObject cryptFiltersObj, streamFilterObj, stringFilterObj;
  xObject cryptFilterObj, cfmObj, cfLengthObj;
  xObject encryptMetadataObj;
