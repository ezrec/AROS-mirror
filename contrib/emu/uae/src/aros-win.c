...
int graphics_init(void)
{
    ...
    if (currprefs.color_mode > 2)
        fprintf(stderr, "Bad color mode selected %d. Using default.\n", currprefs.color_mode), currprefs.color_mode = 1;
    fprintf(stderr, "Color mode selected %d.\n", currprefs.color_mode);
...

	{
		...
		CybBitMap = AllocBitMap(currprefs.gfx_width, currprefs.gfx_height+1,
                                  bitdepth,
