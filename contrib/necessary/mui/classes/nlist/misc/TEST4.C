...
int main(int argc,char *argv[])
{
      ...
      WindowContents, VGroup,
        ...
        Child, LV_Text2 = NListviewObject,
          ...
          MUIA_NListview_NList, LI_Text2 = NDirlistObject,
            MUIA_NDirlist_Directory, "SYS:",
            MUIA_NList_TitleClick,1,
            MUIA_NList_DragColOnly, 0,
            MUIA_NList_Title,"Name",
  ...
  DoMethod(ST_string,MUIM_Notify, MUIA_String_Acknowledge, MUIV_EveryTime,
    LI_Text2, 3, MUIM_Set, MUIA_NDirlist_Directory, MUIV_TriggerValue);
