...
/****************************************************************************/
  ...
  static  void  Insert_Y_Turn( RAS_ARGS  Int  y )
  {
    PStorage  y_turns;
    Int       y2, n;
  ...
  void  Insert_Y_Turn( RAS_ARGS  Int  y );
...
/****************************************************************************/
  ...
  void  Push_Bezier( RAS_ARGS Long  x1, Long  y1,
                              Long  x2, Long  y2,
                              Long  x3, Long  y3 );
