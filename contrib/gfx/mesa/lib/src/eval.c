...
void gl_EvalCoord1f(GLcontext* ctx, GLfloat u)
{
  ...
  if (ctx->Eval.Map1Color4) {
     ...
     icolor[0] = (GLint) (fcolor[0] * 255.0F);
     icolor[1] = (GLint) (fcolor[1] * 255.0F);
     icolor[2] = (GLint) (fcolor[2] * 255.0F);
     icolor[3] = (GLint) (fcolor[3] * 255.0F);
     colorPtr = icolor;
  }
  else {
     colorPtr = ctx->Current.ByteColor;
  }
