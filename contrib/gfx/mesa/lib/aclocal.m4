...
running cat m4/assembler.m4 m4/dllext.m4 m4/extrapaths.m4 m4/libtool.m4 m4/md_flag.m4 ...
...
AC_DEFUN(MESA_SYS_AS_FEATURE, [
  AC_CACHE_CHECK(whether the assembler supports $1,
                 mesa_cv_sys_as_$1,
                 MESA_TRY_ASSEMBLE([#include "src/X86/assyntax.h"], $2,
...
#   MESA_SYS_AS_FEATURE(SomeFeat, somefeat, asm-code-using-somefeat)
