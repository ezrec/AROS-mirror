...
PROGS = bounce.exe;,gamma.exe;,gears.exe;,glxdemo.exe;,glxpixmap.exe;,isosurf.exe;,\
	offset.exe;,osdemo.exe;,spin.exe;,test0.exe;,texobj.exe;,\
	xdemo.exe;,reflect.exe;,winpos.exe;
