...
OBJS          = glut_8x13.obj glut_9x15.obj glut_bitmap.obj glut_bwidth.obj glut_cindex.obj \
                ...
                glut_fullscrn.obj glut_get.obj glut_hel10.obj glut_hel12.obj glut_hel18.obj \
                glut_init.obj glut_input.obj glut_mesa.obj glut_modifier.obj glut_mroman.obj \
		...
		glut_swap.obj glut_cmap.obj \
                win32_glx.obj win32_menu.obj win32_util.obj win32_x11.obj
...
$(PROGRAM):     $(OBJS) 
                $(link) $(dlllflags) /out:$(PROGRAM) \
                        /def:fxglut.def $(OBJS) $(guilibsdll) ..\lib\GLU32.lib ..\lib\OpenGL32.lib
