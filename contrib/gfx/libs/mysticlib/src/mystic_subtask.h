...
struct subtask
{
	...
	LONG (* function) (APTR, BYTE);				/* sub task function */
	...
	BOOL (* initfunction) (APTR);				/* init function */
...
APTR SubTask(LONG (* function)(struct subtask *, BYTE), APTR data, WORD prio, char* name, BOOL (* initfunction)(struct subtask *), BOOL autodestruct);
