...
{
  switch (k) {
    case TK_1: object=1; break;
    case TK_2: object=2; break;
    case TK_3: object=3; break;
    case TK_4: object=4; break;
    case TK_5: object=5; break;
    case TK_SPACE: mono^=1; break;
    case TK_RETURN: smooth^=1; break;
    case TK_ESCAPE:
      tkQuit();
  }
  pinit();
...
void INIT(void)
{
  ...
  if (tkInitWindow("Morph 3D - Shows morphing platonic polyhedra") == GL_FALSE) {
    tkQuit();
  }
