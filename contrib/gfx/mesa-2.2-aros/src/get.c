...
/*
 * $Log$
 * Revision 1.1  2003/08/09 00:23:20  chodorowski
 * Initial revision
 *
   ...
   switch (pname) {
      ...
      case GL_ALPHA_BIAS:
         *params = FLOAT_TO_BOOL(ctx->Pixel.AlphaBias);
         break;
      case GL_ALPHA_BITS:
         if (ctx->Visual->FrontAlphaEnabled || ctx->Visual->BackAlphaEnabled) {
            *params = GL_TRUE;
         }
         else {
            *params = GL_FALSE;
	 ...
	 break;
      case GL_BLUE_BIAS:
         *params = FLOAT_TO_BOOL(ctx->Pixel.BlueBias);
         break;
      case GL_BLUE_BITS:
         *params = INT_TO_BOOL( bits( ctx->Visual->BlueScale ) );
         break;
      case GL_BLUE_SCALE:
      ...
      case GL_CURRENT_COLOR:
         params[0] = INT_TO_BOOL(ctx->Current.IntColor[0]);
         params[1] = INT_TO_BOOL(ctx->Current.IntColor[1]);
         params[2] = INT_TO_BOOL(ctx->Current.IntColor[2]);
         params[3] = INT_TO_BOOL(ctx->Current.IntColor[3]);
         break;
	 ...
	 *params = ENUM_TO_BOOL(ctx->Polygon.FrontFace);
	 ...
	 break;
      case GL_GREEN_BITS:
         *params = INT_TO_BOOL( bits( ctx->Visual->GreenScale ) );
	 break;
      case GL_GREEN_SCALE:
	 ...
	 *params = ENUM_TO_BOOL(ctx->Pixel.ReadBuffer);
	 ...
	 break;
      case GL_RED_BITS:
         *params = INT_TO_BOOL( bits( ctx->Visual->RedScale ) );
	 break;
      case GL_RED_SCALE:
	 ...
	 break;
      case GL_BLUE_BIAS:
         *params = (GLdouble) ctx->Pixel.BlueBias;
         break;
      case GL_BLUE_BITS:
         *params = (GLdouble) bits( ctx->Visual->BlueScale );
         break;
      case GL_BLUE_SCALE:
      ...
      case GL_CULL_FACE_MODE:
         *params = (GLdouble) ctx->Polygon.CullFaceMode;
         break;
      case GL_CURRENT_COLOR:
         params[0] = ctx->Current.IntColor[0] * ctx->Visual->InvRedScale;
         params[1] = ctx->Current.IntColor[1] * ctx->Visual->InvGreenScale;
         params[2] = ctx->Current.IntColor[2] * ctx->Visual->InvBlueScale;
         params[3] = ctx->Current.IntColor[3] * ctx->Visual->InvAlphaScale;
         break;
      case GL_CURRENT_INDEX:
	 ...
	 break;
      case GL_GREEN_BIAS:
         *params = (GLdouble) ctx->Pixel.GreenBias;
         break;
      case GL_GREEN_BITS:
         *params = (GLdouble) bits( ctx->Visual->GreenScale );
         break;
      case GL_GREEN_SCALE:
	 ...
	 break;
      case GL_RED_BIAS:
         *params = (GLdouble) ctx->Pixel.RedBias;
         break;
      case GL_RED_BITS:
         *params = (GLdouble) bits( ctx->Visual->RedScale );
         break;
      case GL_RED_SCALE:
   ...
   switch (pname) {
      ...
      case GL_ALPHA_TEST:
         *params = (GLfloat) ctx->Color.AlphaEnabled;
         break;
      case GL_ALPHA_TEST_FUNC:
         *params = (GLfloat) ctx->Color.AlphaFunc;
         break;
      case GL_ALPHA_TEST_REF:
      ...
      case GL_BLEND:
         *params = (GLfloat) ctx->Color.BlendEnabled;
         break;
      case GL_BLEND_DST:
         *params = (GLfloat) ctx->Color.BlendDst;
         break;
      case GL_BLEND_SRC:
         *params = (GLfloat) ctx->Color.BlendSrc;
         break;
      case GL_BLEND_EQUATION_EXT:
	 *params = (GLfloat) ctx->Color.BlendEquation;
	 break;
      case GL_BLEND_COLOR_EXT:
	 ...
	 break;
      case GL_BLUE_BIAS:
         *params = ctx->Pixel.BlueBias;
         break;
      case GL_BLUE_BITS:
         *params = (GLfloat) bits( ctx->Visual->BlueScale );
         break;
      case GL_BLUE_SCALE:
      ...
      case GL_COLOR_MATERIAL:
         *params = (GLfloat) ctx->Light.ColorMaterialEnabled;
         break;
      case GL_COLOR_MATERIAL_FACE:
         *params = (GLfloat) ctx->Light.ColorMaterialFace;
         break;
      case GL_COLOR_MATERIAL_PARAMETER:
         *params = (GLfloat) ctx->Light.ColorMaterialMode;
         break;
      case GL_COLOR_WRITEMASK:
      ...
      case GL_CULL_FACE:
         *params = (GLfloat) ctx->Polygon.CullFlag;
         break;
      case GL_CULL_FACE_MODE:
         *params = (GLfloat) ctx->Polygon.CullFaceMode;
         break;
      case GL_CURRENT_COLOR:
         params[0] = ctx->Current.IntColor[0] * ctx->Visual->InvRedScale;
         params[1] = ctx->Current.IntColor[1] * ctx->Visual->InvGreenScale;
	 ...
	 *params = (GLfloat) ctx->Visual->DBflag;
	 break;
      case GL_DRAW_BUFFER:
	 *params = (GLfloat) ctx->Color.DrawBuffer;
	 break;
      case GL_EDGE_FLAG:
	 ...
	 break;
      case GL_FEEDBACK_BUFFER_SIZE:
         ...
         *params = (GLfloat) ctx->Feedback.BufferSize;
         break;
      case GL_FEEDBACK_BUFFER_TYPE:
         *params = (GLfloat) ctx->Feedback.Type;
         break;
      case GL_FOG:
	 ...
	 *params = ctx->Fog.End;
	 break;
      case GL_FOG_HINT:
	 *params = (GLfloat) ctx->Hint.Fog;
	 break;
      case GL_FOG_INDEX:
	 *params = ctx->Fog.Index;
	 break;
      case GL_FOG_MODE:
	 *params = (GLfloat) ctx->Fog.Mode;
	 break;
      case GL_FOG_START:
	 *params = ctx->Fog.Start;
	 break;
      case GL_FRONT_FACE:
	 *params = (GLfloat) ctx->Polygon.FrontFace;
	 break;
      case GL_GREEN_BIAS:
         *params = (GLfloat) ctx->Pixel.GreenBias;
         break;
      case GL_GREEN_BITS:
         *params = (GLfloat) bits( ctx->Visual->GreenScale );
         break;
      case GL_GREEN_SCALE:
	 ...
	 *params = (GLfloat) ctx->Line.SmoothFlag;
	 break;
      case GL_LINE_SMOOTH_HINT:
	 *params = (GLfloat) ctx->Hint.LineSmooth;
	 break;
      case GL_LINE_STIPPLE:
	 ...
	 *params = (GLfloat) gl_list_index();
	 break;
      case GL_LIST_MODE:
	 *params = ctx->ExecuteFlag ? (GLfloat) GL_COMPILE_AND_EXECUTE
	   			  : (GLfloat) GL_COMPILE;
	 break;
      case GL_INDEX_LOGIC_OP:
	 ...
	 *params = (GLfloat) ctx->Color.ColorLogicOpEnabled;
	 break;
      case GL_LOGIC_OP_MODE:
         *params = (GLfloat) ctx->Color.LogicOp;
	 break;
      case GL_MAP1_COLOR_4:
	 ...
	 break;
      ...
      case GL_PACK_IMAGE_HEIGHT_EXT:
         *params = (GLfloat) ctx->Pack.ImageHeight;
         break;
      case GL_PERSPECTIVE_CORRECTION_HINT:
	 *params = (GLfloat) ctx->Hint.PerspectiveCorrection;
	 break;
      case GL_PIXEL_MAP_A_TO_A_SIZE:
	 ...
	 *params = (GLfloat) ctx->Point.SmoothFlag;
	 break;
      case GL_POINT_SMOOTH_HINT:
	 *params = (GLfloat) ctx->Hint.PointSmooth;
	 break;
      case GL_POLYGON_MODE:
	 params[0] = (GLfloat) ctx->Polygon.FrontMode;
	 params[1] = (GLfloat) ctx->Polygon.BackMode;
	 break;
#ifdef GL_EXT_polygon_offset
      case GL_POLYGON_OFFSET_BIAS_EXT:
	 ...
	 *params = (GLfloat) ctx->Polygon.SmoothFlag;
	 break;
      case GL_POLYGON_SMOOTH_HINT:
	 *params = (GLfloat) ctx->Hint.PolygonSmooth;
	 break;
      case GL_POLYGON_STIPPLE:
	 for (i=0;i<32;i++) {		/* RIGHT? */
	 ...
	 *params = (GLfloat) ctx->ProjectionStackDepth;
	 break;
      case GL_READ_BUFFER:
	 *params = (GLfloat) ctx->Pixel.ReadBuffer;
	 break;
      case GL_RED_BIAS:
         *params = ctx->Pixel.RedBias;
         break;
      case GL_RED_BITS:
         *params = (GLfloat) bits( ctx->Visual->RedScale );
         break;
      case GL_RED_SCALE:
         *params = ctx->Pixel.RedScale;
         break;
      case GL_RENDER_MODE:
	 *params = (GLfloat) ctx->RenderMode;
	 break;
      case GL_RGBA_MODE:
	 ...
	 *params = (GLfloat) ctx->Scissor.Enabled;
	 break;
      case GL_SHADE_MODEL:
	 *params = (GLfloat) ctx->Light.ShadeModel;
	 break;
      case GL_STENCIL_BITS:
	 ...
	 *params = (GLfloat) ctx->Stencil.Clear;
	 break;
      case GL_STENCIL_FAIL:
	 *params = (GLfloat) ctx->Stencil.FailFunc;
	 break;
      case GL_STENCIL_FUNC:
	 *params = (GLfloat) ctx->Stencil.Function;
	 break;
      case GL_STENCIL_PASS_DEPTH_FAIL:
	 *params = (GLfloat) ctx->Stencil.ZFailFunc;
	 break;
      case GL_STENCIL_PASS_DEPTH_PASS:
	 *params = (GLfloat) ctx->Stencil.ZPassFunc;
	 break;
      case GL_STENCIL_REF:
	 ...
	 break;
      case GL_VERTEX_ARRAY_SIZE:
         *params = (GLfloat) ctx->Array.VertexSize;
         break;
      case GL_VERTEX_ARRAY_TYPE:
         *params = (GLfloat) ctx->Array.VertexType;
         break;
      case GL_VERTEX_ARRAY_STRIDE:
      ...
      case GL_VERTEX_ARRAY_COUNT_EXT:
         *params = 0.0;
         break;
      case GL_NORMAL_ARRAY_TYPE:
         *params = (GLfloat) ctx->Array.NormalType;
         break;
      case GL_NORMAL_ARRAY_STRIDE:
      ...
      case GL_COLOR_ARRAY_SIZE:
         *params = (GLfloat) ctx->Array.ColorSize;
         break;
      case GL_COLOR_ARRAY_TYPE:
         *params = (GLfloat) ctx->Array.ColorType;
         break;
      case GL_COLOR_ARRAY_STRIDE:
      ...
      case GL_COLOR_ARRAY_COUNT_EXT:
         *params = 0.0;
         break;
      case GL_INDEX_ARRAY_TYPE:
         *params = (GLfloat) ctx->Array.IndexType;
         break;
      case GL_INDEX_ARRAY_STRIDE:
      ...
      case GL_TEXTURE_COORD_ARRAY_SIZE:
         *params = (GLfloat) ctx->Array.TexCoordSize;
         break;
      case GL_TEXTURE_COORD_ARRAY_TYPE:
         *params = (GLfloat) ctx->Array.TexCoordType;
         break;
      case GL_TEXTURE_COORD_ARRAY_STRIDE:
	 ...
	 break;
      case GL_BLUE_BIAS:
         *params = (GLint) ctx->Pixel.BlueBias;
         break;
      case GL_BLUE_BITS:
         *params = (GLint) bits( ctx->Visual->BlueScale );
         break;
      case GL_BLUE_SCALE:
      ...
      case GL_CULL_FACE_MODE:
         *params = (GLint) ctx->Polygon.CullFaceMode;
         break;
      case GL_CURRENT_COLOR:
         params[0] = FLOAT_TO_INT( (ctx->Current.IntColor[0]/ctx->Visual->RedScale) );
         params[1] = FLOAT_TO_INT( (ctx->Current.IntColor[1]/ctx->Visual->GreenScale) );
         params[2] = FLOAT_TO_INT( (ctx->Current.IntColor[2]/ctx->Visual->BlueScale) );
         params[3] = FLOAT_TO_INT( (ctx->Current.IntColor[3]/ctx->Visual->AlphaScale) );
         break;
      case GL_CURRENT_INDEX:
	 ...
	 break;
      case GL_GREEN_BIAS:
         *params = (GLint) ctx->Pixel.GreenBias;
         break;
      case GL_GREEN_BITS:
         *params = (GLint) bits( ctx->Visual->GreenScale );
         break;
      case GL_GREEN_SCALE:
	 ...
	 break;
      case GL_RED_BIAS:
         *params = (GLint) ctx->Pixel.RedBias;
         break;
      case GL_RED_BITS:
         *params = (GLint) bits( ctx->Visual->RedScale );
         break;
      case GL_RED_SCALE:
