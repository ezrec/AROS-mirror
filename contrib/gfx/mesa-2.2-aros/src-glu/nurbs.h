...
/*
 * $Log$
 * Revision 1.1  2003/08/09 00:23:32  chodorowski
 * Initial revision
 *
...
GLenum glu_do_sampling_3D(GLUnurbsObj *nobj, new_ctrl_type *new_ctrl,
...
GLenum patch_trimming(GLUnurbsObj *nobj,new_ctrl_type *new_ctrl,
	GLint *sfactors, GLint *tfactors);

void collect_unified_knot(knot_str_type *dest, knot_str_type *src,
	GLfloat maximal_min_knot, GLfloat minimal_max_knot);

GLenum select_knot_working_range(GLUnurbsObj *nobj,knot_str_type *geom_knot,
	knot_str_type *color_knot, knot_str_type *normal_knot,
	knot_str_type *texture_knot);

void free_unified_knots(knot_str_type *geom_knot, knot_str_type *color_knot,
