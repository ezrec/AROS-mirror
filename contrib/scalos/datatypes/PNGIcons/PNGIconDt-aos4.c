...
static const struct TagItem inittab[] =
	{
	{CLT_DataSize, (ULONG)sizeof(struct PngIconObjectDtLibBase)},
...
static struct Library * Initlib(struct Library *libbase, BPTR seglist, struct ExecIFace *pIExec)
{
	struct PngIconObjectDtLibBase *IconObjLibBase = (struct PngIconObjectDtLibBase *) libbase;
...
static BPTR Expungelib(struct LibraryManagerInterface *Self)
{
	struct PngIconObjectDtLibBase *IconObjLibBase = (struct PngIconObjectDtLibBase *) Self->Data.LibBase;
