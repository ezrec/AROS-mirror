...
static const struct TagItem inittab[] =
	{
	{CLT_DataSize, (ULONG)sizeof(struct AmigaIconObjectDtLibBase)},
...
static struct Library * Initlib(struct Library *libbase, BPTR seglist, struct ExecIFace *pIExec)
{
	struct AmigaIconObjectDtLibBase *IconObjLibBase = (struct AmigaIconObjectDtLibBase *) libbase;
...
static BPTR Expungelib(struct LibraryManagerInterface *Self)
{
	struct AmigaIconObjectDtLibBase *IconObjLibBase = (struct AmigaIconObjectDtLibBase *) Self->Data.LibBase;
