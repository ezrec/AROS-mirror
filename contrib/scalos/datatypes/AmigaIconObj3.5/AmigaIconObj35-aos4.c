...
static const struct TagItem inittab[] =
	{
	{CLT_DataSize, (ULONG)sizeof(struct AmigaIconObj35DtLibBase)},
...
static struct Library * Initlib(struct Library *libbase, BPTR seglist, struct ExecIFace *pIExec)
{
	struct AmigaIconObj35DtLibBase *IconObjLibBase = (struct AmigaIconObj35DtLibBase *) libbase;
...
static BPTR Expungelib(struct LibraryManagerInterface *Self)
{
	struct AmigaIconObj35DtLibBase *IconObjLibBase = (struct AmigaIconObj35DtLibBase *) Self->Data.LibBase;
