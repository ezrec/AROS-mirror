...
static const struct TagItem inittab[] =
	{
	{CLT_DataSize, (ULONG)sizeof(struct GlowIconObjectDtLibBase)},
...
static struct Library * Initlib(struct Library *libbase, BPTR seglist, struct ExecIFace *pIExec)
{
	struct GlowIconObjectDtLibBase *IconObjLibBase = (struct GlowIconObjectDtLibBase *) libbase;
	...
	IconObjLibBase->nib_ClassLibrary.cl_Lib.lib_Node.ln_Pri = 10;
...
static BPTR Expungelib(struct LibraryManagerInterface *Self)
{
	struct GlowIconObjectDtLibBase *IconObjLibBase = (struct GlowIconObjectDtLibBase *) Self->Data.LibBase;
