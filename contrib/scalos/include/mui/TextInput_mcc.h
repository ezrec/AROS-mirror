...
struct MUIP_Textinput_ExternalEdit { STACKED ULONG MethodID; };
struct MUIP_Textinputscroll_Inform { STACKED ULONG MethodID; STACKED ULONG xo; STACKED ULONG yo; STACKED ULONG xs; STACKED ULONG ys; STACKED ULONG xv; STACKED ULONG yv; STACKED ULONG noedit; };
struct MUIP_Textinputmcp_GrabCols  { STACKED ULONG MethodID; STACKED ULONG notall; };
struct MUIP_Textinput_Blink { STACKED ULONG MethodID; };
struct MUIP_Textinput_SaveToFile { STACKED ULONG MethodID; STACKED STRPTR filename; };
struct MUIP_Textinput_LoadFromFile { STACKED ULONG MethodID; STACKED STRPTR filename; };
struct MUIP_Textinput_ExternalEditDone { STACKED ULONG MethodID; STACKED ULONG changed; };
struct MUIP_Textinput_DoRevert { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoDelLine { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoCutLine { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoMarkStart { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoMarkAll { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoCut { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoCopyCut { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoCopy { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoPaste { STACKED ULONG MethodID; };
struct MUIP_Textinput_AppendText { STACKED ULONG MethodID; STACKED STRPTR text; STACKED LONG len; };
struct MUIP_Textinputmcp_LAct { STACKED ULONG MethodID; STACKED ULONG which; };
struct MUIP_Textinputmcp_LCopy { STACKED ULONG MethodID; };
struct MUIP_Textinputmcp_LAdd { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoToggleWordwrap { STACKED ULONG MethodID; };
struct MUIP_Textinput_Acknowledge { STACKED ULONG MethodID; STACKED STRPTR contents; };
struct MUIP_Textinput_TranslateEvent { STACKED ULONG MethodID; STACKED struct InputEvent *ie; STACKED STRPTR mappedstring; STACKED ULONG *mappedlen; };
struct MUIP_Textinput_InsertText { STACKED ULONG MethodID; STACKED STRPTR text;STACKED  LONG len; };
struct MUIP_Textinput_DoLeft { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoRight { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoUp { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoDown { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoLineStart { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoLineEnd { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoTop { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoBottom { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoPageUp { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoPageDown { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoPopup { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoPrevWord { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoNextWord { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoDel { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoDelEOL { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoBS { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoBSSOL { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoubleClick { STACKED ULONG MethodID; STACKED ULONG xp; STACKED ULONG yp; STACKED ULONG cnt; };
struct MUIP_Textinput_DoDelWord { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoBSWord { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoInsertFile { STACKED ULONG MethodID; };
struct MUIP_Textinput_InsertFromFile { STACKED ULONG MethodID; STACKED STRPTR filename; };
struct MUIP_Textinput_HandleChar { STACKED ULONG MethodID; STACKED ULONG ch; STACKED ULONG quiet; };
struct MUIP_Textinput_HandleURL { STACKED ULONG MethodID; STACKED STRPTR url; };
struct MUIP_Textinput_HandleRexxSignal {STACKED  ULONG MethodID; };
struct MUIP_Textinput_HandleMisspell { STACKED ULONG MethodID; STACKED STRPTR word; STACKED STRPTR pos; STACKED STRPTR correction; };
struct MUIP_Textinput_DoToggleCase { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoToggleCaseEOW { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoIncrementDec { STACKED ULONG MethodID; };
...
struct MUIP_Textinput_DoSetBookmark2 { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoSetBookmark3 { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoGotoBookmark1 { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoGotoBookmark2 { STACKED ULONG MethodID; };
struct MUIP_Textinput_DoGotoBookmark3 { STACKED ULONG MethodID; };
