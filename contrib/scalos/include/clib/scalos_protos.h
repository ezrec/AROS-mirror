...
BOOL SCA_WBStartTags(APTR argArray, ULONG numArgs, Tag firstTag, ...);
VOID SCA_SortNodes(struct ScalosNodeList * nodelist, struct Hook * sortHook,
	ULONG sortType);
struct AppObject * SCA_NewAddAppIcon(ULONG iD, IPTR userData, Object * iconObj,
	struct MsgPort * msgPort, CONST struct TagItem * tagList);
struct AppObject * SCA_NewAddAppIconTags(ULONG iD, IPTR userData, Object * iconObj,
	struct MsgPort * msgPort, Tag tagList, ...);
BOOL SCA_RemoveAppObject(struct AppObject * appObj);
struct AppObject * SCA_NewAddAppWindow(ULONG iD, IPTR userData, struct Window * win,
	struct MsgPort * msgPort, CONST struct TagItem * tagList);
struct AppObject * SCA_NewAddAppWindowTags(ULONG iD, IPTR userData, struct Window * win,
	struct MsgPort * msgPort, Tag tagList, ...);
struct AppObject * SCA_NewAddAppMenuItem(ULONG iD, IPTR userData, CONST_STRPTR text,
	struct MsgPort * msgPort, CONST struct TagItem * tagList);
struct AppObject * SCA_NewAddAppMenuItemTags(ULONG iD, IPTR userData, CONST_STRPTR text,
	struct MsgPort * msgPort, Tag tagList, ...);
...
BOOL SCA_OpenIconWindowTags(Tag tagList, ...);
...
VOID SCA_ScreenTitleMsgArgs(CONST_STRPTR format, IPTR args, ...);
...
Object * SCA_NewScalosObjectTags(CONST_STRPTR className, Tag tagList, ...);
VOID SCA_DisposeScalosObject(Object * obj);
ULONG SCA_ScalosControlA(CONST_STRPTR name, CONST struct TagItem * tagList);
ULONG SCA_ScalosControl(CONST_STRPTR name, Tag tagList, ...);
ULONG SCA_ScalosControlTags(CONST_STRPTR name, Tag tagList, ...);
...
struct ScaWindowStruct * SCA_OpenDrawerByNameTags(CONST_STRPTR path, Tag tagList, ...);
...
Object * SCA_GetDefIconObjectTags(BPTR dirLock, CONST_STRPTR name, Tag tagList, ...);
