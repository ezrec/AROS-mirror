...
#define WaitSelect(nfds, read_fds, write_fds, except_fds, _timeout, signals) ({ \
  ...
  struct timeval * _WaitSelect__timeout = (_timeout); \
  ...
  register struct timeval * __WaitSelect__timeout __asm("a3") = (_WaitSelect__timeout); \
...
#define GetDefaultDomainName(buffer, buffer_size) ({ \
  ...
  ({ \
  register struct Library * const __GetDefaultDomainName__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
...
#define SetDefaultDomainName(buffer) ({ \
  ...
  { \
  register struct Library * const __SetDefaultDomainName__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
...
#define ObtainRoadshowData(access) ({ \
  ...
  ({ \
  register struct Library * const __ObtainRoadshowData__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
...
#define ReleaseRoadshowData(list) ({ \
  ...
  { \
  register struct Library * const __ReleaseRoadshowData__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
...
#define ChangeRoadshowData(list, name, length, data) ({ \
  ...
  ({ \
  register struct Library * const __ChangeRoadshowData__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
