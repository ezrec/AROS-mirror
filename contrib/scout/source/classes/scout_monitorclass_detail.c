	...
	MUIA_Window_ID, MakeID('M','C','L','D'),
        WindowContents, VGroup,
            ...
            Child, (IPTR)(group = (Object *)ScrollgroupObject,
                ...
                MUIA_Scrollgroup_Contents, VGroupV,
                    ...
                    Child, VGroup,
                        GroupFrame,
                        Child, ColGroup(2),
			    Child, MyLabel2(txtMonitorClassMonitorName),
                            Child, (IPTR)(texts[ 0] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassManufacturer),
                            Child, (IPTR)(texts[ 1] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassManufacturerID),
			    Child, (IPTR)(texts[ 2] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassProductID),
                            Child, (IPTR)(texts[ 3] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassMemorySize),
			    Child, (IPTR)(texts[ 4] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassTopLeft),
			    Child, (IPTR)(texts[ 5] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassTopMiddle),
			    Child, (IPTR)(texts[ 6] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassTopRight),
			    Child, (IPTR)(texts[ 7] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassMiddleLeft),
			    Child, (IPTR)(texts[ 8] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassMiddleRight),
			    Child, (IPTR)(texts[ 9] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassBottomLeft),
			    Child, (IPTR)(texts[10] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassBottomMiddle),
			    Child, (IPTR)(texts[11] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassBottomRight),
			    Child, (IPTR)(texts[12] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassGammaControl),
			    Child, (IPTR)(texts[13] = MyTextObject6()),
			    Child, MyLabel2(txtMonitorClassPointerType),
			...
			End,
			    ...
			    Child, ColGroup(2),
				Child, MyLabel2(txtScreenModeDepth),
				Child, MyLabel2(txtPixelFormat),
				Child, MyLabel2("8"),
			...
			End,
			    ...
			    Child, ColGroup(2),
				Child, MyLabel2(txtPointerType),
				Child, MyLabel2(txtPointerSize),
				Child, MyLabel2("PointerType_3Plus1"),
				Child, (IPTR)(texts[21] = MyTextObject6()),
				Child, MyLabel2("PointerType_2Plus1"),
				Child, (IPTR)(texts[22] = MyTextObject6()),
				Child, MyLabel2("PointerType_ARGB"),
