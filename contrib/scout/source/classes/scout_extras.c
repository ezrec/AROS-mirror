...
APTR GetApplication( void )
{
    ...
    menustrip = MenustripObject,
        MUIA_Family_Child, MenuObject,
            ...
            MUIA_Family_Child, MakeMenuitem(txtMenuAbout,             MENU_ABOUT),
            MUIA_Family_Child, MakeMenuitem(txtMenuAboutMUI,          MENU_ABOUT_MUI),
            MUIA_Family_Child, MakeMenuitem(txtMenuQuit,              MENU_QUIT),
        End,
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, txtMenuList,
            MUIA_Family_Child, MakeMenuitem(txtMenuAllocations,       MENU_ALLOCATIONS),
            MUIA_Family_Child, MakeMenuitem(txtMenuAssigns,           MENU_ASSIGNS),
            MUIA_Family_Child, MakeMenuitem(txtMenuClasses,           MENU_CLASSES),
            MUIA_Family_Child, MakeMenuitem(txtMenuCommodities,       MENU_COMMODITIES),
            MUIA_Family_Child, MakeMenuitem(txtMenuDevices,           MENU_DEVICES),
            MUIA_Family_Child, MakeMenuitem(txtMenuExpansions,        MENU_EXPANSIONS),
            MUIA_Family_Child, MakeMenuitem(txtMenuFonts,             MENU_FONTS),
            MUIA_Family_Child, MakeMenuitem(txtMenuInputHandlers,     MENU_INPUTHANDLERS),
            MUIA_Family_Child, MakeMenuitem(txtMenuInterrupts,        MENU_INTERRUPTS),
            MUIA_Family_Child, MakeMenuitem(txtMenuLibraries,         MENU_LIBRARIES),
            MUIA_Family_Child, MakeMenuitem(txtMenuLocks,             MENU_LOCKS),
            MUIA_Family_Child, MakeMenuitem(txtMenuLowMemory,         MENU_LOWMEMORY),
            MUIA_Family_Child, MakeMenuitem(txtMenuMemory,            MENU_MEMORY),
            MUIA_Family_Child, MakeMenuitem(txtMenuMount,             MENU_MOUNTS),
            MUIA_Family_Child, MakeMenuitem(txtMenuPorts,             MENU_PORTS),
            MUIA_Family_Child, MakeMenuitem(txtMenuResidents,         MENU_RESIDENTS),
            MUIA_Family_Child, MakeMenuitem(txtMenuResCmds,           MENU_COMMANDS),
            MUIA_Family_Child, MakeMenuitem(txtMenuResources,         MENU_RESOURCES),
            MUIA_Family_Child, MakeMenuitem(txtMenuScreenModes,       MENU_SCREENMODES),
            MUIA_Family_Child, MakeMenuitem(txtMenuSemaphores,        MENU_SEMAPHORES),
            MUIA_Family_Child, MakeMenuitem(txtMenuSystem,            MENU_SYSTEM),
            MUIA_Family_Child, MakeMenuitem(txtMenuTasks,             MENU_TASKS),
            MUIA_Family_Child, MakeMenuitem(txtMenuTimer,             MENU_TIMERS),
            MUIA_Family_Child, MakeMenuitem(txtMenuVectors,           MENU_VECTORS),
            MUIA_Family_Child, MakeMenuitem(txtMenuWindows,           MENU_WINDOWS),
            MUIA_Family_Child, MakeMenuitem(NULL,                     0),
            MUIA_Family_Child, MakeMenuitem(txtMenuInstalledPatches,  MENU_PATCHES),
            MUIA_Family_Child, MakeMenuitem(txtMenuLocaleCatalogs,    MENU_CATALOGS),
            MUIA_Family_Child, MakeMenuitem(txtMenuAHIAudioModes,     MENU_AUDIOMODES),
            MUIA_Family_Child, MakeMenuitem(txtMenuResetHandlers,     MENU_RESETHANDLERS),
        End,
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, txtMenuOther,
            MUIA_Family_Child, MakeMenuitem(txtMenuFlushDevices,      MENU_FLUSHDEVS),
            MUIA_Family_Child, MakeMenuitem(txtMenuFlushFonts,        MENU_FLUSHFONTS),
            MUIA_Family_Child, MakeMenuitem(txtMenuFlushLibraries,    MENU_FLUSHLIBS),
            MUIA_Family_Child, MakeMenuitem(txtMenuFlushAll,          MENU_FLUSHALL),
            MUIA_Family_Child, MakeMenuitem(NULL,                     0),
            MUIA_Family_Child, MakeMenuitem(txtMenuClearResetVectors, MENU_CLEARVECTORS),
        End,
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, txtMenuOptions,
            MUIA_Family_Child, MakeMenuitem(txtMenuSingleWindows,     MENU_SINGLE_WINDOWS),
        End,
    End;
