                   ...
                   struct opSet *msg )
{
    ...
    if ((obj = (Object *)DoSuperNew(cl, obj,
        ...
        WindowContents, VGroup,
            ...
            Child, pages = RegisterGroup(allocationPages),
                ...
                Child, ScrollgroupObject,
                    ...
                    MUIA_Scrollgroup_Contents, VGroupV,
                        Child, ColGroup(2),
                            Child, Label1(txtAllocationTimerA),
                            Child, ciaaText[0] = MyTextObject(),
                            Child, Label1(txtAllocationTimerB),
                            Child, ciaaText[1] = MyTextObject(),
                            Child, Label1(txtAllocationAlarm),
                            Child, ciaaText[2] = MyTextObject(),
                            Child, Label1(txtAllocationSerial),
                            Child, ciaaText[3] = MyTextObject(),
                            Child, Label1(txtAllocationFlag),
                            Child, ciaaText[4] = MyTextObject(),
                        End,
                    End,
                End,
                ...
                Child, ScrollgroupObject,
                    ...
                    MUIA_Scrollgroup_Contents, VGroupV,
                        Child, ColGroup(2),
                            Child, Label1(txtAllocationTimerA),
                            Child, ciabText[0] = MyTextObject(),
                            Child, Label1(txtAllocationTimerB),
                            Child, ciabText[1] = MyTextObject(),
                            Child, Label1(txtAllocationAlarm),
                            Child, ciabText[2] = MyTextObject(),
                            Child, Label1(txtAllocationSerial),
                            Child, ciabText[3] = MyTextObject(),
                            Child, Label1(txtAllocationFlag),
                            Child, ciabText[4] = MyTextObject(),
                        End,
                    End,
                End,
                ...
                Child, ScrollgroupObject,
                    ...
                    MUIA_Scrollgroup_Contents, VGroupV,
                        Child, ColGroup(2),
                            Child, Label1(txtAllocationSerialPort),
                            Child, portsText[0] = MyTextObject(),
                            Child, Label1(txtAllocationSerialControl),
                            Child, portsText[1] = MyTextObject(),
                            Child, Label1(txtAllocationParallelPort),
                            Child, portsText[2] = MyTextObject(),
                            Child, Label1(txtAllocationParallelControl),
                            Child, portsText[3] = MyTextObject(),
                        End,
                    End,
                End,
            End,
