                        ...
                        Object *obj )
{
    ...
    if (IsFileSystem(me->me_Name) && me->me_ValidFSSM) {
        ...
        subgroup = VGroup,
            ...
            Child, ColGroup(2),
                Child, MyLabel2(txtFSSMDevice),
                Child, texts[ 0] = MyTextObject6(),
                Child, MyLabel2(txtFSSMDiskState),
                Child, texts[ 1] = MyTextObject6(),
                Child, MyLabel2(txtFSSMDiskType),
                Child, texts[ 2] = MyTextObject6(),
                Child, MyLabel2(txtFSSMFlags),
                Child, texts[ 3] = MyTextObject6(),
                Child, MyLabel2(txtFSSMCapacity),
                Child, texts[ 4] = MyTextObject6(),
                Child, MyLabel2(txtFSSMEnviron2),
                Child, texts[ 5] = MyTextObject6(),
            End,
            Child, VGroup,
                GroupFrameT(txtFSSMEnviron),
                Child, ColGroup(2),
                    Child, MyLabel2(txtEnvecTableSize),
                    Child, texts[ 6] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecSizeBlock),
                    Child, texts[ 7] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecSecOrg),
                    Child, texts[ 8] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecSurfaces),
                    Child, texts[ 9] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecSectorPerBlock),
                    Child, texts[10] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecBlocksPerTrack),
                    Child, texts[11] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecReserved),
                    Child, texts[12] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecPreAlloc),
                    Child, texts[13] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecInterleave),
                    Child, texts[14] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecLowCyl),
                    Child, texts[15] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecHighCyl),
                    Child, texts[16] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecNumBuffers),
                    Child, texts[17] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecBufMemType2),
                    Child, texts[18] = FlagsButtonObject,
                        MUIA_FlagsButton_Type, MUIV_FlagsButton_Type_Long,
                        MUIA_FlagsButton_Title, txtEnvecBufMemType,
                        MUIA_FlagsButton_BitArray, memFlags,
                        MUIA_FlagsButton_WindowTitle, txtMemoryFlagsTitle,
                    End,
                    Child, MyLabel2(txtEnvecMaxTransfer),
                    Child, texts[19] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecMask),
                    Child, texts[20] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecBootPri),
                    Child, texts[21] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecDosType),
                    Child, texts[22] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecBaud),
                    Child, texts[23] = MyTextObject6(),
                    Child, MyLabel2(txtEnvecControl),
                    Child, texts[24] = DisassemblerButtonObject,
                        MUIA_DisassemblerButton_ForceHexDump, TRUE,
                    End,
                    Child, MyLabel2(txtEnvecBootBlocks),
                ...
                MUIA_Scrollgroup_Contents, VGroupV,
                    ...
                    Child, maingroup = VGroup,
                        ...
                        Child, ColGroup(2),
                            ...
                            Child, texts[ 1] = MyTextObject6(),
                            Child, MyLabel2(txtMountNext),
                            Child, texts[ 2] = MyTextObject6(),
                            Child, MyLabel2(txtMountType),
                            Child, texts[ 3] = MyTextObject6(),
                            Child, MyLabel2(txtMountTask),
                            Child, texts[ 4] = TaskButtonObject,
                                MUIA_TaskButton_IsProcessPointer, TRUE,
                            End,
                            Child, MyLabel2(txtMountLock),
                            Child, texts[ 5] = MyTextObject6(),
                            Child, MyLabel2(txtMountHandler2),
                            Child, texts[ 6] = MyTextObject6(),
                            Child, MyLabel2(txtMountStackSize),
                            Child, texts[ 7] = MyTextObject6(),
                            Child, MyLabel2(txtMountPriority),
                            Child, texts[ 8] = MyTextObject6(),
                            Child, MyLabel2(txtMountStartup),
                            Child, texts[ 9] = DisassemblerButtonObject,
                                MUIA_DisassemblerButton_ForceHexDump, TRUE,
                            End,
                            Child, MyLabel2(txtMountSegList),
                            Child, texts[10] = MyTextObject6(),
                            Child, MyLabel2(txtMountGlobVec),
                            Child, texts[11] = MyTextObject6(),
                      End,
                    End,
                End,
