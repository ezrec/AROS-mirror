...
#if STD_RUSSIAN
#define MES_SIGNON      "Интерпретатор Bywater BASIC, версия"
#define MES_COPYRIGHT   "Copyright (c) 1992, Ted A. Campbell"
#define MES_LANGUAGE    ""
#define PROMPT          "Готово"
#define ERROR_HEADER    "ОШИБКА в строке"
#define MATHERR_HEADER  "ОШИБКА"
#define MES_BREAK       "Программа прервана в строке"
#define ERR_OPENFILE    "Не могу открыть файл %s"
#define ERR_GETMEM      "Мало памяти"
#define ERR_LINENO      "Неверный номер строки"
#define ERR_LNNOTFOUND  "Строка %d не найдена"
#define ERR_LOADNOFN    "LOAD: не задано имя файла"
#define ERR_NOLN        "Отсутствует номер строки"
#define ERR_NOFN        "Отсутствует имя файла"
#define ERR_RETNOGOSUB  "RETURN без GOSUB"
#define ERR_INCOMPLETE  "Невершенный оператор"
#define ERR_ONNOGOTO    "ON без GOTO или GOSUB"
#define ERR_VALOORANGE  "Значение вне диапазона"
#define ERR_SYNTAX      "Синтаксическая ошибка"
#define ERR_DEVNUM      "Неверный номер устройства"
#define ERR_DEV         "Ошибка устройства"
#define ERR_OPSYS       "Ошибка в команде операционной системы"
#define ERR_ARGSTR      "Аргумент должен быть строкой"
#define ERR_DEFCHAR     "Неверный аргумент в определении переменной"
#define ERR_MISMATCH    "Несоответствие типов"
#define ERR_DIMNOTARRAY "Аргумент не имя массива"
#define ERR_OD          "Нет данных"
#define ERR_OVERFLOW    "Переполнение"
#define ERR_NF          "NEXT без FOR"
#define ERR_UF          "Неопределенная функция"
#define ERR_DBZ         "Деление на ноль"
#define ERR_REDIM       "Нельзя менять размерность переменной"
#define ERR_OBDIM       "OPTION BASE должна быть вызвана до DIM"
#define ERR_UC          "Неверная команда"
#endif
