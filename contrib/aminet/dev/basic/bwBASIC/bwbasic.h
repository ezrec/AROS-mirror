...
#define VERSION         "1.11"          /* Current version number */

/* Definitions controlling program features */

#define UNIX_CMDS	FALSE 		/* implement CHDIR, MKDIR, and RMDIR */
					/* and other BASIC commands and functions */
					/* requiring Unix-type commands such as */
					/* chdir() mkdir() rmdir() */
...
#endif					/* 493 dec = 755 octal */
#endif

/* define number of commands */

#define CMDS_BASE       53              /* number of base commands defined */
#if UNIX_CMDS
#define CMDS_DIR	5
#else
#define CMDS_DIR	0
...
#define FUNCS_BASE      42              /* number of basic functions */
#if UNIX_CMDS
#define FUNCS_DIR	1
#else
#define	FUNCS_DIR	0
...
#endif
#define FUNCTIONS	(FUNCS_BASE+FUNCS_DEBUG+FUNCS_DIR)	/* total number of functions implemented */
