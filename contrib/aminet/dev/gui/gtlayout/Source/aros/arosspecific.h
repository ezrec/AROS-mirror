...
#endif
 struct LayoutHandle *LT_CreateHandleTags( struct Screen *screen, Tag tag1, ... );
#if 0
...
#endif
 LONG LT_GetAttributes( struct LayoutHandle *handle, LONG id, Tag tag1, ... );
#if 0
 VOID GTLayout_LT_SetAttributesA( struct LayoutHandle *handle, LONG id, struct TagItem *tagList );
#endif
 VOID LT_SetAttributes( struct LayoutHandle *handle, LONG id, Tag tag1, ... );
#if 0
 VOID GTLayout_LT_AddA( struct LayoutHandle *handle, LONG type, STRPTR label, LONG id, struct TagItem *tagList );
#endif
 VOID GTLayout_LT_Add( struct LayoutHandle *handle, LONG type, STRPTR label, LONG id, Tag tag1, ... );
#if 0
 VOID GTLayout_LT_NewA( struct LayoutHandle *handle, struct TagItem *tagList );
#endif
 VOID LT_New( struct LayoutHandle *handle, Tag tag1,... );
#if 0
...
#endif
 struct Window *LT_Layout( struct LayoutHandle *handle, STRPTR title, struct IBox *bounds, LONG extraWidth, LONG extraHeight, ULONG idcmp, LONG align, Tag tag1,... );
#if 0
...
#endif
 struct Window *LT_Build( struct LayoutHandle *handle, Tag tag1, ... );
#if 0
 BOOL GTLayout_LT_RebuildTagList( struct LayoutHandle *handle, LONG clear, struct TagItem *tags );
#endif
 BOOL LT_RebuildTags( struct LayoutHandle *handle, BOOL clear, Tag tag1,... );
#if 0
/*--- Added in v9.0 ---------------------------------------------------*/
...
#endif
 VOID LT_MenuControlTags( struct Window *window, struct Menu *intuitionMenu, Tag tag1,... );
#if 0
