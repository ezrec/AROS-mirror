...
#pragma usrcall(LTP_BackfillRoutine(A0,A2,A1))
#pragma usrcall(LTP_DefaultEditRoutine(A0,A2,A1))
#pragma usrcall(LTP_DefaultHistoryHook(A0,A2,A1))
#pragma usrcall(LTP_HexEditRoutine(A0,A2,A1))
#pragma usrcall(LTP_ImageDispatcher(A0,A2,A1))
#pragma usrcall(LTP_PopupClassDispatcher(A0,A2,A1))
