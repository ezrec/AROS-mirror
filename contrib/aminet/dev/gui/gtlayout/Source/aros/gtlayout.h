...
/*****************************************************************************/
 ...
 LayoutHandle * LT_CreateHandleTags(struct Screen *Screen, unsigned long tag1,...);
 LONG LT_GetAttributes(LayoutHandle *Handle, LONG ID, unsigned long tag1, ... );
 VOID LT_SetAttributes(LayoutHandle *handle, LONG id, unsigned long tag1, ... );
 VOID GTLayout_LT_Add(LayoutHandle *handle, LONG type, STRPTR label, LONG id, unsigned long tag1, ... );
 VOID LT_New(LayoutHandle *handle, unsigned long tag1,... );
 struct Window *LT_Layout(LayoutHandle *handle, STRPTR title, struct IBox *bounds, LONG extraWidth, LONG extraHeight, ULONG idcmp, LONG align, unsigned long tag1,... );
 struct Window *LT_Build(LayoutHandle *handle, unsigned long tag1, ... );
