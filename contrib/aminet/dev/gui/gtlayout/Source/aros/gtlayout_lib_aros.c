...
/*****************************************************************************/
AROS_UFH3(STATIC struct Library * LIBENT, LibInit,
    AROS_UFHA(REG(d0) struct GTLayoutBase *, GTLayoutBase, D0),
    AROS_UFHA(REG(a0) BPTR, Segment, A0),
    AROS_UFHA(REG(a6) struct ExecBase *, ExecBase, A6))
{
...
/*****************************************************************************/
AROS_LH0(STATIC struct Library * LIBENT, LibOpen,
    struct GTLayoutBase *, GTLayoutBase, 1, GTLayout)
{
...
/*****************************************************************************/
AROS_LH0(STATIC BPTR LIBENT, LibExpunge,
    struct GTLayoutBase *, GTLayoutBase, 3, GTLayout)
{
	BPTR result;
...
/*****************************************************************************/
AROS_LH0(STATIC BPTR LIBENT, LibClose,
    struct GTLayoutBase *, GTLayoutBase, 2, GTLayout)
{
	BPTR result;
...
/*****************************************************************************/
AROS_LH0(STATIC LONG, LibNull,
    struct GTLayoutBase *, GTLayoutBase, 4, GTLayout)
{
	return(NULL);
}
