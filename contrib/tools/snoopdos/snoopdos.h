...
#define PAT_COMPLEX_NOT_EXCLUDE "~((Workbench|Shell Process|Background CLI)|%s)"
...
#define LAST_DOS_GADGET         GID_SYSTEMTAGLIST
...
#ifdef __amigaos4__
GLOBAL struct Library *IntuitionBase;             /* Intuition library base       */
#else
