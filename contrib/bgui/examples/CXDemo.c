	...
	if ( CM_Broker )
	{
		...
		**/
		WN_Window = WindowObject,
			...
			WINDOW_MasterGroup,
				VGroupObject, HOffset(6), VOffset(6), Spacing(6), GROUP_BackFill, FILL_RASTER,
					StartMember,
					...
					StartMember,
						HGroupObject,
							StartMember, GA_Hide = FuzzButton( "_Hide", ID_HIDE ), EndMember,
							VarSpace(DEFAULT_WEIGHT),
							StartMember, GA_Quit = FuzzButton( "_Quit", ID_QUIT ), EndMember,
