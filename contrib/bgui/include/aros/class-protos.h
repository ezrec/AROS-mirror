...
extern ASM REGFUNC2(ULONG, CompStrlenF, REGPARAM(A0, UBYTE *,), REGPARAM(A1, ULONG *,));

//extern ASM VOID DoSPrintF(REG(a0) UBYTE *, REG(a1) UBYTE *, REG(a2) ULONG *);
extern ASM REGFUNC3(VOID, DoSPrintF, REGPARAM(A0, UBYTE *,), REGPARAM(A1, UBYTE *,), REGPARAM(A2, ULONG *,));
#ifdef _AROS
#else
...
extern ASM REGFUNC2(LONG, max, REGPARAM(D0, LONG,), REGPARAM(D1, LONG,));

//extern ASM LONG min(REG(d0) LONG, REG(d1) LONG);
extern ASM REGFUNC2(LONG, min, REGPARAM(D0, LONG,), REGPARAM(D1, LONG,));

//extern ASM LONG abs(REG(d0) LONG);

//extern ASM LONG range(REG(d0) LONG, REG(d1) LONG, REG(d2) LONG);
extern ASM REGFUNC3(LONG, range, REGPARAM(D0, LONG,), REGPARAM(D1, LONG,), REGPARAM(D2, LONG,));

//extern ASM ULONG CountLabels(REG(a0) UBYTE **);
extern ASM REGFUNC1(ULONG, CountLabels, REGPARAM(A0, UBYTE **,));

//extern ASM BOOL PointInBox(REG(a0) struct IBox *, REG(d0) WORD, REG(d1) WORD);
extern ASM REGFUNC3(BOOL, PointInBox, REGPARAM(A0, struct IBox *,), REGPARAM(D0, WORD,), REGPARAM(D1, WORD,));
...
extern ASM REGFUNC2(VOID, ShowHelpReq, REGPARAM(A0, struct Window *,), REGPARAM(A1, UBYTE *,));

//extern ASM UBYTE *DoBuffer(REG(a0) UBYTE *, REG(a1) UBYTE **, REG(a2) ULONG *, REG(a3) ULONG *);
extern ASM REGFUNC4(UBYTE *, DoBuffer, REGPARAM(A0, UBYTE *,), REGPARAM(A1, UBYTE **,), REGPARAM(A2, ULONG *,), REGPARAM(A3, ULONG *,));

extern VOID DoMultiSet(Tag, ULONG, ULONG, Object *, ...);

//extern ASM VOID SetGadgetBounds(REG(a0) Object *, REG(a1) struct IBox *);
extern ASM REGFUNC2(VOID, SetGadgetBounds, REGPARAM(A0, Object *,), REGPARAM(A1, struct IBox *,));

//extern ASM VOID SetImageBounds(REG(a0) Object *, REG(a1) struct IBox *);
extern ASM REGFUNC2(VOID, SetImageBounds, REGPARAM(A0, Object *,), REGPARAM(A1, struct IBox *,));

//extern ASM VOID UnmapTags(REG(a0) struct TagItem *, REG(a1) struct TagItem *);
extern ASM REGFUNC2(VOID, UnmapTags, REGPARAM(A0, struct TagItem *,), REGPARAM(A1, struct TagItem *,));

//extern ASM Object *CreateVector(REG(a0) struct TagItem *);
extern ASM REGFUNC1(Object *, CreateVector, REGPARAM(A0, struct TagItem *,));

//extern ASM struct TagItem *BGUI_NextTagItem(REG(a0) struct TagItem **);
extern ASM REGFUNC1(struct TagItem *, BGUI_NextTagItem, REGPARAM(A0, struct TagItem **,));
...
extern ASM REGFUNC1(ULONG, GetIDReport, REGPARAM(A0, struct Window *,));

extern struct Window *GetFirstIDReportWindow(void);

//extern ASM VOID RemoveIDReport(REG(a0) struct Window *);
extern ASM REGFUNC1(VOID, RemoveIDReport, REGPARAM(A0, struct Window *,));

//extern ASM VOID AddWindow(REG(a0) Object *, REG(a1) struct Window *);
extern ASM REGFUNC2(VOID, AddWindow, REGPARAM(A0, Object *,), REGPARAM(A1, struct Window *,));

//extern ASM VOID RemWindow(REG(a0) Object *);
extern ASM REGFUNC1(VOID, RemWindow, REGPARAM(A0, Object *,));

//extern ASM Object *WhichWindow(REG(a0) struct Screen *);
extern ASM REGFUNC1(Object *, WhichWindow, REGPARAM(A0, struct Screen *,));

extern struct TagItem *DefTagList(ULONG, struct TagItem *);

//extern SAVEDS ASM ULONG BGUI_CountTagItems(REG(a0) struct TagItem *);
extern SAVEDS ASM REGFUNC1(ULONG, BGUI_CountTagItems, REGPARAM(A0, struct TagItem *,));

//extern SAVEDS ASM struct TagItem *BGUI_MergeTagItems(REG(a0) struct TagItem *, REG(a1) struct TagItem *);
extern SAVEDS ASM REGFUNC2(struct TagItem *, BGUI_MergeTagItems, REGPARAM(A0, struct TagItem *,), REGPARAM(A1, struct TagItem *,));

//extern SAVEDS ASM struct TagItem *BGUI_CleanTagItems(REG(a0) struct TagItem *, REG(d0) LONG);
extern SAVEDS ASM REGFUNC2(struct TagItem *, BGUI_CleanTagItems, REGPARAM(A0, struct TagItem *,), REGPARAM(D0, LONG,));
...
extern SAVEDS ASM REGFUNC3(ULONG, __GCD, REGPARAM(A0, Class *,), REGPARAM(A2, Object *,), REGPARAM(A1, Msg,));
...
extern ASM REGFUNC3(ULONG, BGUI_GetAttrChart, REGPARAM(A0, Class *,), REGPARAM(A2, Object *,), REGPARAM(A1, struct rmAttr *,));

//extern ULONG ASM BGUI_SetAttrChart(REG(a0) Class *, REG(a2) Object *, REG(a1) struct rmAttr *);
extern ASM REGFUNC3(ULONG, BGUI_SetAttrChart, REGPARAM(A0, Class *,), REGPARAM(A2, Object *,), REGPARAM(A1, struct rmAttr *,));
...
extern ASM REGFUNC3(ULONG, Get_Attr, REGPARAM(A0, Object *,), REGPARAM(D0, ULONG,), REGPARAM(A1, void *,));

//extern ASM ULONG Get_SuperAttr(REG(a2) Class *, REG(a0) Object *, REG(d0) ULONG, REG(a1) void *);
extern ASM REGFUNC4(ULONG, Get_SuperAttr, REGPARAM(A2, Class *,), REGPARAM(A0, Object *,), REGPARAM(D0, ULONG,), REGPARAM(A1, void *,));
...
extern ASM REGFUNC3(ULONG, DoRenderMethod, REGPARAM(A0, Object *,), REGPARAM(A1, struct GadgetInfo *,), REGPARAM(D0, ULONG,));

//extern ASM ULONG ForwardMsg(REG(a0) Object *, REG(a1) Object *, REG(a2) Msg);
extern ASM REGFUNC3(ULONG, ForwardMsg, REGPARAM(A0, Object *,), REGPARAM(A1, Object *,), REGPARAM(A2, Msg,));
...
extern SAVEDS ASM REGFUNC3(struct BaseInfo *, BGUI_AllocBaseInfoDebugA, REGPARAM(A0, struct TagItem *,), REGPARAM(A1, STRPTR,), REGPARAM(D0, ULONG,));

//extern SAVEDS ASM struct BaseInfo *BGUI_AllocBaseInfoA(REG(a0) struct TagItem *);
extern SAVEDS ASM REGFUNC1(struct BaseInfo *, BGUI_AllocBaseInfoA, REGPARAM(A0, struct TagItem *,));
...
extern ASM REGFUNC1(ULONG, RelayoutGroup, REGPARAM(A0, Object *,));
...
extern SAVEDS ASM REGFUNC3(ULONG, BGUI_CallHookPkt, REGPARAM(A0, struct Hook *,), REGPARAM(A2, APTR,), REGPARAM(A1, APTR,));
...
extern ASM REGFUNC2(UWORD, TotalHeight, REGPARAM(A0, struct RastPort *,), REGPARAM(A1, UBYTE *,));

//extern UWORD ASM TotalWidth(REG(a0) struct RastPort *, REG(a1) UBYTE *);
extern ASM REGFUNC2(UWORD, TotalWidth, REGPARAM(A0, struct RastPort *,), REGPARAM(A1, UBYTE *,));
...
extern ASM REGFUNC2(ULONG, TextWidth, REGPARAM(A1, struct RastPort *,), REGPARAM(A0, UBYTE *,));

//extern ASM ULONG TextWidthNum(REG(a1) struct RastPort *, REG(a0) UBYTE *, REG(d0) ULONG);
extern ASM REGFUNC3(ULONG, TextWidthNum, REGPARAM(A1, struct RastPort *,), REGPARAM(A0, UBYTE *,), REGPARAM(D0, ULONG,));

//extern ASM VOID BDisableBox(REG(a0) struct BaseInfo *, REG(a1) struct IBox *);
extern ASM REGFUNC2(VOID, BDisableBox, REGPARAM(A0, struct BaseInfo *,), REGPARAM(A1, struct IBox *,));
...
extern ASM REGFUNC2(VOID, SetDashedLine, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, UWORD,));
...
extern ASM REGFUNC7(VOID, SRectFillDebug, REGPARAM(A0, struct RastPort *,), REGPARAM(D0, LONG,), REGPARAM(D1, LONG,), REGPARAM(D2, LONG,), REGPARAM(D3, LONG,), REGPARAM(A1, STRPTR,), REGPARAM(D4, ULONG, ));
extern ASM REGFUNC5(VOID, SRectFill, REGPARAM(A0, struct RastPort *, ), REGPARAM(D0, LONG,), REGPARAM(D1, LONG,), REGPARAM(D2, LONG,), REGPARAM(D3, LONG,));
...
extern ASM REGFUNC7(VOID, BRectFillDebug, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, LONG,), REGPARAM(D1, LONG,), REGPARAM(D2, LONG,), REGPARAM(D3, LONG,), REGPARAM(A1, STRPTR,), REGPARAM(D4, ULONG,));

//extern ASM VOID BRectFillA(REG(a0) struct BaseInfo *, REG(a1) struct Rectangle *);
extern ASM REGFUNC2(VOID, BRectFillA, REGPARAM(a0,struct BaseInfo *,), REGPARAM(a1, struct Rectangle *,));
extern ASM REGFUNC5(VOID, BRectFill, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, LONG,), REGPARAM(D1, LONG,), REGPARAM(D2, LONG,), REGPARAM(D3, LONG,));

//extern ASM VOID BBoxFill(REG(a0) struct BaseInfo *, REG(d0) LONG, REG(d1) LONG, REG(d2) LONG, REG(d3) LONG);
extern ASM REGFUNC5(VOID, BBoxFill, REGPARAM(A0, struct BaseInfo *,), REGPARAM(d0,LONG,), REGPARAM(d1,LONG,), REGPARAM(d2,LONG,), REGPARAM(d3,LONG,));

//extern ASM VOID BBoxFillA(REG(a0) struct BaseInfo *, REG(a1) struct IBox *);
extern ASM REGFUNC2(VOID, BBoxFillA, REGPARAM(a0, struct BaseInfo *,), REGPARAM(a1,struct IBox *,));

//extern ASM VOID RenderBackFill(REG(a0) struct RastPort *, REG(a1) struct IBox *, REG(a2) UWORD *, REG(d0) ULONG);
extern ASM REGFUNC4(VOID, RenderBackFill, REGPARAM(A0, struct RastPort *,), REGPARAM(A1, struct IBox *,), REGPARAM(A2, UWORD *,), REGPARAM(D0, ULONG,));
...
extern ASM REGFUNC6(VOID, RenderBackFillRasterDebug, REGPARAM(A0, struct RastPort *,), REGPARAM(A1, struct IBox *,), REGPARAM(D0, UWORD,), REGPARAM(D1, UWORD,), REGPARAM(A2, STRPTR,), REGPARAM(D2, ULONG,));
extern ASM REGFUNC4(VOID, RenderBackFillRaster, REGPARAM(A0, struct RastPort *,), REGPARAM(A1, struct IBox *,), REGPARAM(D0, UWORD,), REGPARAM(D1, UWORD,));
        
//extern ASM VOID DottedBox(REG(a0) struct BaseInfo *, REG(a1) struct IBox *);
extern ASM REGFUNC2(VOID, DottedBox, REGPARAM(A0, struct BaseInfo *,), REGPARAM(A1, struct IBox *,));

//extern ASM ULONG GadgetState(REG(a0) struct BaseInfo *, REG(a1) Object *, REG(d0) BOOL);
extern ASM REGFUNC3(ULONG, GadgetState, REGPARAM(A0, struct BaseInfo *,), REGPARAM(A1, Object *,), REGPARAM(D0, BOOL,));
...
extern ASM REGFUNC4(VOID, HLine, REGPARAM(A1, struct RastPort *,), REGPARAM(D0, UWORD,), REGPARAM(D1, UWORD,), REGPARAM(D2, UWORD,));

//extern VOID ASM VLine(REG(a1) struct RastPort *, REG(d0) UWORD, REG(d1) UWORD, REG(d2) UWORD);
extern ASM REGFUNC4(VOID, VLine, REGPARAM(A1, struct RastPort *,), REGPARAM(D0, UWORD,), REGPARAM(D1, UWORD,), REGPARAM(D2, UWORD,));

//extern ASM ULONG FGetAPen(REG(a1) struct RastPort *);
extern ASM REGFUNC1(ULONG, FGetAPen, REGPARAM(A1, struct RastPort *,));

//extern ASM ULONG FGetBPen(REG(a1) struct RastPort *);
extern ASM REGFUNC1(ULONG, FGetBPen, REGPARAM(A1, struct RastPort *,));
        
//extern ASM ULONG FGetDrMd(REG(a1) struct RastPort *);
extern ASM REGFUNC1(ULONG, FGetDrMd, REGPARAM(A1, struct RastPort *,));

//extern ASM ULONG FGetDepth(REG(a1) struct RastPort *);
extern ASM REGFUNC1(ULONG, FGetDepth, REGPARAM(A1, struct RastPort *,));

//extern ASM VOID FSetAPen(REG(a1) struct RastPort *, REG(d0) ULONG);
extern ASM REGFUNC2(VOID, FSetAPen, REGPARAM(A1, struct RastPort *, ), REGPARAM(D0, ULONG,));

//extern ASM VOID FSetBPen(REG(a1) struct RastPort *, REG(d0) ULONG);
extern ASM REGFUNC2(VOID, FSetBPen, REGPARAM(A1, struct RastPort *,), REGPARAM(D0, ULONG,));

//extern ASM VOID FSetDrMd(REG(a1) struct RastPort *, REG(d0) ULONG);
extern ASM REGFUNC2(VOID, FSetDrMd, REGPARAM(A1, struct RastPort *,), REGPARAM(D0, ULONG,));

//extern ASM VOID FSetABPenDrMd(REG(a1) struct RastPort *, REG(d0) ULONG, REG(d1) ULONG, REG(d2) ULONG);
extern ASM REGFUNC4(VOID, FSetABPenDrMd, REGPARAM(A1, struct RastPort *,), REGPARAM(D0, ULONG,), REGPARAM(D1, ULONG,), REGPARAM(D2, ULONG,));

//extern ASM VOID FSetFont(REG(a1) struct RastPort *, REG(a0) struct TextFont *);
extern ASM REGFUNC2(VOID, FSetFont, REGPARAM(A1, struct RastPort *,), REGPARAM(A0, struct TextFont *,));

//extern ASM VOID FSetFontStyle(REG(a1) struct RastPort *, REG(d0) ULONG);
extern ASM REGFUNC2(VOID, FSetFontStyle, REGPARAM(A1, struct RastPort *,), REGPARAM(D0, ULONG, ));

//extern ASM VOID FClearAfPt(REG(a1) struct RastPort *);
extern ASM REGFUNC1(VOID, FClearAfPt, REGPARAM(A1, struct RastPort *,));

//extern ASM VOID BSetDPenA(REG(a0) struct BaseInfo *, REG(d0) LONG);
extern ASM REGFUNC2(VOID, BSetDPenA, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, LONG,));

//extern ASM VOID BSetPenA(REG(a0) struct BaseInfo *, REG(d0) ULONG);
extern ASM REGFUNC2(VOID, BSetPenA, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, ULONG,));

//extern ASM VOID BSetDPenB(REG(a0) struct BaseInfo *, REG(d0) LONG);
extern ASM REGFUNC2(VOID, BSetDPenB, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, LONG,));

//extern ASM VOID BSetPenB(REG(a0) struct BaseInfo *, REG(d0) ULONG);
extern ASM REGFUNC2(VOID, BSetPenB, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, ULONG,));

//extern ASM VOID BSetDrMd(REG(a0) struct BaseInfo *, REG(d0) ULONG);
extern ASM REGFUNC2(VOID, BSetDrMd, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, ULONG,));

//extern ASM VOID BSetFont(REG(a0) struct BaseInfo *, REG(a1) struct TextFont *);
extern ASM REGFUNC2(VOID, BSetFont, REGPARAM(A0, struct BaseInfo *,), REGPARAM(A1, struct TextFont *,));

//extern ASM VOID BSetFontStyle(REG(a0) struct BaseInfo *, REG(d0) ULONG);
extern ASM REGFUNC2(VOID, BSetFontStyle, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, ULONG,));

//extern ASM VOID BSetAfPt(REG(a0) struct BaseInfo *, REG(a1) UWORD *, REG(d0) ULONG);
extern ASM REGFUNC3(VOID, BSetAfPt, REGPARAM(A0, struct BaseInfo *,), REGPARAM(A1, UWORD *,), REGPARAM(D0, ULONG,));

//extern ASM VOID BClearAfPt(REG(a0) struct BaseInfo *);
extern ASM REGFUNC1(VOID, BClearAfPt, REGPARAM(A0, struct BaseInfo *,));

//extern ASM VOID BSetDrPt(REG(a0) struct BaseInfo *, REG(d0) ULONG);
extern ASM REGFUNC2(VOID, BSetDrPt, REGPARAM(A0, struct BaseInfo *,), REGPARAM(D0, ULONG,));

//extern ASM VOID BDrawImageState(REG(a0) struct BaseInfo *, REG(a1) Object *, REG(d0) ULONG, REG(d1) ULONG, REG(d2) ULONG);
extern ASM REGFUNC5(VOID, BDrawImageState, REGPARAM(A0, struct BaseInfo *,), REGPARAM(A1, Object *,), REGPARAM(D0, ULONG,), REGPARAM(D1, ULONG,), REGPARAM(D2, ULONG,));
...
extern ASM REGFUNC1(VOID, EraseBMO, REGPARAM(A0, BMO *,));

//extern VOID ASM LayerBMO(REG(a0) BMO *);
extern ASM REGFUNC1(VOID, LayerBMO, REGPARAM(A0, BMO *,));

//extern VOID ASM DrawBMO(REG(a0) BMO *);
extern ASM REGFUNC1(VOID, DrawBMO, REGPARAM(A0, BMO *,));

//extern ASM BMO *CreateBMO(REG(a0) Object *, REG(a1) struct GadgetInfo *);
extern ASM REGFUNC2(BMO *, CreateBMO, REGPARAM(A0, Object *,), REGPARAM(A1, struct GadgetInfo *,));

//extern ASM VOID DeleteBMO(REG(a0) BMO *);
extern ASM REGFUNC1(VOID, DeleteBMO, REGPARAM(A0, BMO *,));

//extern ASM VOID MoveBMO(REG(a0) BMO *, REG(d0) WORD, REG(d1) WORD);
extern ASM REGFUNC3(VOID, MoveBMO, REGPARAM(A0, BMO *,), REGPARAM(D0, WORD,), REGPARAM(d1, WORD,));
...
extern ASM REGFUNC3(ULONG, ScaleWeight, REGPARAM(D2, ULONG,), REGPARAM(D3, ULONG,), REGPARAM(D4, ULONG,));

//extern /*__stdargs*/ ASM ULONG StrLenfA(REG(a0) UBYTE *, REG(a1) ULONG *);
extern ASM REGFUNC2(ULONG, StrLenfA, REGPARAM(A0, UBYTE *,), REGPARAM(A1, ULONG *,));
...
extern ASM REGFUNC2(ULONG, AsmDoMethodA, REGPARAM(A2, Object *,), REGPARAM(A1, Msg,));

//extern ASM ULONG AsmDoSuperMethodA( REG(a0) Class *, REG(a2) Object *, REG(a1) Msg );
extern ASM REGFUNC3(ULONG, AsmDoSuperMethodA, REGPARAM(A0, Class *,), REGPARAM(A2, Object *,), REGPARAM(A1, Msg,));

//extern ASM ULONG AsmCoerceMethodA( REG(a0) Class *, REG(a2) Object *, REG(a1) Msg );
extern ASM REGFUNC3(ULONG, AsmCoerceMethodA, REGPARAM(A0, Class *,), REGPARAM(A2, Object *,), REGPARAM(A1, Msg,));
...
extern ASM REGFUNC1(VOID, RevertStack, REGPARAM(A0, APTR,));
