...
// int LMatchPattern(char *,char *);
// int LMatchPatternI(char *,char *);
...
// void AssignGadget(struct ConfigStuff *,int,int,char *,char *);
// void AssignMenu(struct ConfigStuff *,int,char *,char *);
// void FreeConfig(struct ConfigStuff *);
// int CheckConfig(struct ConfigStuff *);
// int FindSystemFile(char *,char *,int,int);
// int ReadStringFile(struct StringData *,char *);
// void FreeStringFile(struct StringData *);
