...
USHORT scrdata_norm_width;                /* Normal width of the display */
USHORT scrdata_norm_height;               /* Normal height of the display */
USHORT scrdata_scr_height;                /* Main screen/window height */

USHORT scrdata_dispwin_lines;             /* Number of lines in each window */
USHORT scrdata_dispwin_width[2];          /* Displayed width in each window */
USHORT scrdata_dispwin_height;            /* Height of directory windows */
USHORT scrdata_dispwin_nchars[2];         /* Width of each window in characters */
USHORT scrdata_dispwin_ypos;              /* Y-Position of directory windows */
USHORT scrdata_dispwin_left[2];           /* Left edge of directory windows */
USHORT scrdata_dispwin_xpos[2];           /* Left edge of text in windows */
USHORT scrdata_dispwin_center;            /* Center of the two windows */

USHORT scrdata_dirwin_xpos[2];            /* Rendered X-Position of each window */
USHORT scrdata_dirwin_ypos[2];            /* Rendered Y-Position of each window */
USHORT scrdata_dirwin_width[2];           /* Rendered width of each window */
USHORT scrdata_dirwin_height;             /* Rendered height of directory windows */
USHORT scrdata_dirwin_bottom;             /* Rendered bottom of each window */
USHORT scrdata_dirwin_center;             /* Rendered center of the two windows */

USHORT scrdata_drive_width;               /* Width of the drive gadgets */
USHORT scrdata_gadget_offset;             /* X-Offset of entire gadget display */
USHORT scrdata_gadget_xpos;               /* X-Position of the custom gadgets */
USHORT scrdata_gadget_ypos;               /* Y-Position of the custom gadgets */
USHORT scrdata_gadget_width;              /* Width of the custom gadgets */
USHORT scrdata_gadget_height;             /* Height of the custom gadgets */

USHORT scrdata_clock_width;               /* Width of the clock bar */
USHORT scrdata_clock_height;              /* Height of the clock bar */
USHORT scrdata_clock_xpos;                /* x-pos of the clock bar */
USHORT scrdata_clock_ypos;                /* y-pos of the clock bar */
USHORT scrdata_status_xpos;               /* X-Position of the status bar */
USHORT scrdata_status_ypos;               /* Y-Position of the status bar */
USHORT scrdata_status_width;              /* Width of the status bar */
USHORT scrdata_status_height;             /* Height of the status bar */
USHORT scrdata_diskname_width[2];         /* Width of each diskname display */
USHORT scrdata_diskname_height;           /* Height of the diskname displays */
USHORT scrdata_diskname_ypos;             /* Y-Position of the diskname displays */
USHORT scrdata_diskname_xpos[2];          /* X-Position of each diskname display */
USHORT scrdata_prop_height;               /* Height of the vertical sliders */
USHORT scrdata_string_height;             /* Height of the path string gadgets */
USHORT scrdata_closegad_width;            /* Width of the screen close gadget */

USHORT scrdata_font_xsize;                /* X-Size of the dir window font */
...
USHORT scrdata_xoffset;                   /* General x-offset */
USHORT scrdata_yoffset;                   /* General y-offset */
USHORT scrdata_width;                     /* Display width */
USHORT scrdata_height;                    /* Display height */
	...
	*drive_gadgets,                         /* Drive gadgets */
	...
	path_strgadget[2]={                     /* Path field gadgets */
		{&path_strgadget[1],2,0,0,0,
			...
			GTYP_STRGADGET,NULL,NULL,NULL,NULL,
	...
	vert_propgad[2]={                       /* Vertical slider gadgets */
		{&vert_propgad[1],0,0,8,0,
			...
			GTYP_PROPGADGET,(APTR)&vert_propimage[0],NULL,NULL,NULL,
			(APTR)&vert_propinfo[0],SCRGAD_LEFTPROP,NULL},
		{NULL,0,0,8,0,
			GFLG_GADGHNONE,
			GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
			GTYP_PROPGADGET,(APTR)&vert_propimage[1],NULL,NULL,NULL,
	...
	horiz_propgad[2]={                      /* Horizontal slider gadgets */
		{&horiz_propgad[1],0,0,0,5,
			GFLG_GADGHNONE,
			GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
			GTYP_PROPGADGET,(APTR)&horiz_propimage[0],NULL,NULL,NULL,
			(APTR)&horiz_propinfo[0],SCRGAD_LEFTHPROP,NULL},
		{NULL,0,0,0,5,
			GFLG_GADGHNONE,
			GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
			GTYP_PROPGADGET,(APTR)&horiz_propimage[1],NULL,NULL,NULL,
	...
	drive_propgad={                         /* Drive banks slider gadget */
		...
		GFLG_GADGHNONE,
		GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
		GTYP_PROPGADGET,(APTR)&drive_propimage,NULL,NULL,NULL,
	...
	gadget_propgad={                        /* Gadget banks slider gadget */
		...
		GFLG_GADGHNONE,
		GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
		GTYP_PROPGADGET,(APTR)&gadget_propimage,NULL,NULL,NULL,
	...
	screen_gadgets[24]={                    /* General screen gadgets */
		{&screen_gadgets[1],0,0,2,0,
			GFLG_GADGHCOMP,
			GACT_RELVERIFY,
			GTYP_BOOLGADGET,NULL,NULL,NULL,NULL,
	...
	size_gadgets[]={
		...
		GFLG_GADGHNONE,
		GACT_IMMEDIATE|GACT_RELVERIFY,
		GTYP_SIZING,NULL,NULL,NULL,NULL,
		NULL,65000,NULL},
		{NULL,0,0,0,0,
		GFLG_GADGHNONE,
		GACT_IMMEDIATE|GACT_RELVERIFY,
