    ...
    *drive_gadgets,                         /* Drive gadgets */
    ...
    path_strgadget[2]={                     /* Path field gadgets */
        {&path_strgadget[1],2,0,0,0,
            ...
            GTYP_STRGADGET,NULL,NULL,NULL,0L,
    ...
    vert_propgad[2]={                       /* Vertical slider gadgets */
        {&vert_propgad[1],0,0,8,0,
            ...
            GTYP_PROPGADGET,(APTR)&vert_propimage[0],NULL,NULL,0L,
            (APTR)&vert_propinfo[0],SCRGAD_LEFTPROP,NULL},
        {NULL,0,0,8,0,
            GFLG_GADGHNONE,
            GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
            GTYP_PROPGADGET,(APTR)&vert_propimage[1],NULL,NULL,0L,
    ...
    horiz_propgad[2]={                      /* Horizontal slider gadgets */
        {&horiz_propgad[1],0,0,0,5,
            GFLG_GADGHNONE,
            GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
            GTYP_PROPGADGET,(APTR)&horiz_propimage[0],NULL,NULL,0L,
            (APTR)&horiz_propinfo[0],SCRGAD_LEFTHPROP,NULL},
        {NULL,0,0,0,5,
            GFLG_GADGHNONE,
            GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
            GTYP_PROPGADGET,(APTR)&horiz_propimage[1],NULL,NULL,0L,
    ...
    drive_propgad={                         /* Drive banks slider gadget */
        ...
        GFLG_GADGHNONE,
        GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
        GTYP_PROPGADGET,(APTR)&drive_propimage,NULL,NULL,0L,
    ...
    gadget_propgad={                        /* Gadget banks slider gadget */
        ...
        GFLG_GADGHNONE,
        GACT_IMMEDIATE|GACT_RELVERIFY|GACT_FOLLOWMOUSE,
        GTYP_PROPGADGET,(APTR)&gadget_propimage,NULL,NULL,0L,
    ...
    screen_gadgets[24]={                    /* General screen gadgets */
        {&screen_gadgets[1],0,0,2,0,
            GFLG_GADGHCOMP,
            GACT_RELVERIFY,
            GTYP_BOOLGADGET,NULL,NULL,NULL,0L,
