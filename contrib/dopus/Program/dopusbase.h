...
// AddGadgets(struct Window *,struct Gadget *,char **,int,int,int,int);
// AddListView(struct DOpusListView *,int);
// Assign(char *,char *);
// Atoh(char *,int);
// char *BaseName(char *);
// void BtoCStr(BSTR,char *,int);
// CheckExist(char *,int *);
// CheckHexGad(struct Gadget *,struct Window *,int,int);
// CheckNumGad(struct Gadget *,struct Window *,int,int);
// int CompareDate(struct DateStamp *,struct DateStamp *);
// CompareLock(BPTR,BPTR);
...
// DoRMBGadget(struct RMBGadget *,struct Window *);
...
// struct IORequest *LCreateExtIO(struct MsgPort *,int);
// struct MsgPort *LCreatePort(char *,int);
// void LDeleteExtIO(struct IORequest *);
// void LDeletePort(struct MsgPort *);
...
// LMatchPattern(char *,char *);
// LMatchPatternI(char *,char *);
// void LParsePattern(char *,char *);
// void LParsePatternI(char *,char *);
...
// LStrnCmp(char *,char *,int);
// LStrnCmpI(char *,char *,int);
...
// struct Image *GetCheckImage(int,int,int,struct DOpusRemember **);
...
// void ObjectText(struct RequesterBase *,short,short,short,short,char *,short);
...
// ReadConfig(char *,struct ConfigStuff *);
// SaveConfig(char *,struct ConfigStuff *);
// DefaultConfig(struct ConfigStuff *);
// GetDevices(struct ConfigStuff *);
// AssignGadget(struct ConfigStuff *,int,int,char *,char *);
// AssignMenu(struct ConfigStuff *,int,char *,char *);
// FreeConfig(struct ConfigStuff *);
// CheckConfig(struct ConfigStuff *);
// FindSystemFile(char *,char *,int,int);
// ReadStringFile(struct StringData *,char *);
// FreeStringFile(struct StringData *);
