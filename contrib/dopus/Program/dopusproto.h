...
int dochecktype(struct dopusfiletype *,const char *,BPTR,struct FileInfoBlock *);
int checktypechars(BPTR,unsigned char *,int);
int typesearch(BPTR,char *,int,char *,int);
