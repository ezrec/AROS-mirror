...
int x,y;
{
	...
	list->boxhi=screen_pens[(int)config->gadgettopcol].pen;
	list->boxlo=screen_pens[(int)config->gadgetbotcol].pen;
...
int x,y,fg,num;
{
	...
	Do3DBox(r,x,y,84,22,screen_pens[(int)config->gadgettopcol].pen,screen_pens[(int)config->gadgetbotcol].pen);
...
int x,y,w,h;
{
	...
	Do3DBox(rp,x,y,w,h,screen_pens[(int)config->gadgetbotcol].pen,screen_pens[(int)config->gadgettopcol].pen);
...
int fp,bp,type,x,y;
{
	...
	if (type==CFG_GADGET || type==CFG_DRIVE)
		Do3DBox(r,x+10,y+12,124,8,screen_pens[(int)config->gadgettopcol].pen,screen_pens[(int)config->gadgetbotcol].pen);
...
int x,y,fp,bp;
{
	...
	Do3DBox(r,x+94,y-10,144,32,screen_pens[(int)config->gadgetbotcol].pen,screen_pens[(int)config->gadgettopcol].pen);
}
