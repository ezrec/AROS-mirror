...
FAR int			viewangletox[FINEANGLES/2];
...
FAR lighttable_t*	zlight[LIGHTLEVELS][MAXLIGHTZ];
...
//    pspritescale2 = FRACUNIT*viewheight/200;
    ...
    for (i=0 ; i<viewwidth ; i++)
    {
	cosadj = iabs(finecosine[xtoviewangle[i]>>ANGLETOFINESHIFT]);
