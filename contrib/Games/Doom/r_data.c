...
{
    char*		flatpresent = NULL;
    char*		texturepresent = NULL;
    ...
    // Precache flats.
    if ((flatpresent = malloc(numflats)) == NULL)
      I_Error ("malloc(%d) failed", numflats);
    ...
    // Precache textures.
    if ((texturepresent = malloc(numtextures)) == NULL)
      I_Error ("malloc(%d) failed", numtextures);
    ...
    // Precache sprites.
    if ((spritepresent = malloc(numsprites)) == NULL)
      I_Error ("malloc(%d) failed", numsprites);
