...
#include "header.h"
void redraw_position();
void draw_hex(int row, int column, int fill, int type);
void draw_pos(int column, int fill, int type);
 ...
 */
void place_piece(piece,tpiece,upos)
 ...
 * grid down.
 */
void shift_redraw_grid(start_row,grid)
int start_row;
position_t grid[MAXROW][MAXCOLUMN];
{
    int row, column;
 ...
 * grid down.
 */
void shift_offset_redraw_grid(start_row,grid)
int start_row;
position_t grid[MAXROW][MAXCOLUMN];
{
    int row, column;
 ...
 * 6 - Quit
 */
int update(choice,grid,npiece,piece,score,rows)
int choice;
position_t grid[MAXROW][MAXCOLUMN];
 ...
 */
int update_drop(grid,npiece,piece,score,rows)
position_t grid[MAXROW][MAXCOLUMN];
piece_t *npiece,*piece;
int *score, *rows;
{
 ...
 */
void new_game(grid,npiece,piece,score,rows)
position_t grid[MAXROW][MAXCOLUMN];
piece_t *npiece,*piece;
int *score, *rows;
{
 ...
 * is placed.
 */
int is_high_score(name,userid,score,rows,high_scores)
 ...
 */
void do_choice(choice,grid,npiece,piece,score,rows,game_over,game_view,high_scores)
char *choice;
position_t grid[MAXROW][MAXCOLUMN];
piece_t *npiece,*piece;
 ...
 */
void redraw_game(grid,npiece,piece,score,rows,game_view,high_scores)
position_t grid[MAXROW][MAXCOLUMN];
piece_t *npiece,*piece;
