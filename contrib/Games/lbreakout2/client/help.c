...
void draw_hints_screen()
{
	...
	draw_hint( hint_x, hint_y + hint_h * 8, " d    Disintegrate single bricks." );
	draw_hint( hint_x, hint_y + hint_h * 9, " w    Warp to next level. (after enough bricks where cleared)" );
	draw_hint( hint_x, hint_y + hint_h * 10, " TAB  Take a screenshot." );
	draw_hint( hint_x, hint_y + hint_h * 11, " ESC  Quit game." );
