...
/*
 * Uncomment exactly one of the following, as needed.  Some systems already
 * predefine one of these and will complain if you define it also.
 */

#define AMIGA 1                      /* AmigaDOS, Lattice            */
/*#define ST520*/                       /* ST520, TOS                   */
/*#define MWC86*/
/*#define V7*/                          /* V7 UN*X or Coherent          */
/*#define VMS*/                         /* VAX/VMS                      */
/*#define CPM*/                         /* CP/M-86                      */
