...
AROS Research Operating System - легковесная, эффективная и гибкая 
операционная система для персонального ("десктопного") применения, 
позволяющая выжать максимум способностей из вашего компьютера. 
Это независимый, переносимый и свобоный проект, стремящийся к достижению 
максимальной совместимости с AmigaOS 3.1 на уровне API (подоно Wine, но не UAE)
, при этом превосходя её во многих областях. Исходный код доступен по открытой 
