...
.. raw:: html
   ...
   Nightly builds worden automatisch elke avond aangemaakt, direct met de laatste bron code. Als u gewoon de AROS Live CD wil proberen, download dan de  "boot ISO" voor uw platform (i386 of PPC).<br><br>
   ...
   <a href=http://www.aros-exec.org>AROS-EXEC</a> is de primaire AROS community site. Ontvang hulp, leer wat er speelt in de community, en post uw gedachten over AROS.<br><br>
   ...
   Openstaande Bounties:<br><img style="width: 177px; height: 2px;" alt="spacer" src="/images/sidespacer.png"><br>
   <a href=http://www.teamaros.org>Team AROS</a> is een ondersteunende groep voor AROS, die probeert een drijvende motor te zijn voor het project, primair door het ophalen van geld via donaties voor gefocuste ontwikkeling.
   ...
   Aangewezen Bounties:<br><img style="width: 177px; height: 2px;" alt="spacer" src="/images/sidespacer.png"><br>
   ...
   Syndicatie Feeds:<br><img style="width: 177px; height: 2px;" alt="spacer" src="/images/sidespacer.png"><br>
   ...
   Laatste ARCHIVE insturingen:<br><img style="width: 238px; height: 2px;" alt="spacer" src="/images/sidespacer.png"><br>
   <a href=http://archives.aros-exec.org>The AROS Archive</a> bevat de nieuwste systeem content ingestuurd door onze community en is de primaire locatie voor gebruikers applicaties, thema's, graphics en aanvullende documentatie.<br><br>
