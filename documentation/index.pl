...
.. Include:: documentation/developers/contribute-abstract.pl

`Wiêcej... <documentation/developers/contribute>`__
...
.. raw:: html
   ...
   Nocne buildy budowane s± automatycznie ka¿nej nocy z najnowszych ¼róde³. Aby wypróbowaæ Live CD AROSa, ¶ci±gnij "boot ISO" dla twojej platformy.<br><br>
   ...
   <a href=http://archives.aros-exec.org>Archiwa AROSa </a> zawieraj± najnowsze aplikacje, grafiki i dodatkow± dokumentacjê przygotowan± przez spo³eczno¶æ AROS.<br><br>
