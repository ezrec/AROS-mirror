...
и, если и не готова  к версии 1.0, то, во всяком случае, теперь стала намного
...
последние события вокруг Amiga Inc позволили предполагать, что для AROS самое 
время немного поменять название.
...
Благодаря Nic Andrews, Wanderer теперь имеет выбора показа иконок с иконками
либо всех файлов. Также добавлена возможность растянуть изображения для обоев 
рабочего стола и навигация с клавиатуры.

Robert Norris добавил поддержку записи реализации файловой системы FAT на AROS.
...
Paul J. Beel опубликовал множество интересных интервью и статей о AROS и
