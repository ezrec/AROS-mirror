...
κατεβάσετε την bit native έκδοση του AROS από την ιστοσελίδα μας. 
Αυτή η νέα έκδοση είναι προφανώς πιο προχωρημένη από τη συνήθη,
και έχει περιορισμένη προστασία μνήμης και φόρτωση modules εκκίνησης. 
...
και Workstation (v5 ή 6). Αυτή η διανομή είναι ακόμα μακριά
...
VmwAROS είναι οι καθημερινοί χρήστες και προγραμματιστές και όποιοσδήποτε
