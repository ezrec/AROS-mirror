...
Прежде всего, пожалуйста `свяжитесь с нами <http://aros.sourceforge.net/contact.php#mailing-lists>`__, 
...
новый язык рекомендуется отписаться в почтовую рассылку для разработчиков, 
чтобы проконсультироваться. Также прочтите `страницу о документировании <documenting>`__ 
