...
Переводить так же просто, как это подразумевается. Всё, что вам нужно
...
вещах вы можете найти на странице `Работа с Subversion SVN <svn>`__. Для собственно
перевода ОС и сайта у вас совершенно нет нужды в использовании самой AROS, вполне 
подойдут Linux, Windows или Mac OS X.
