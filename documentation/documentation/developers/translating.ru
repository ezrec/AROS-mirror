...
Если вы близко не знакомы с SVN, прочтите что написано на странице `Работа с
Subversion (SVN)`_. Кратко: в отношении работы с файлами SVN подобна FTP. Однако
, вместо того, чтобы перемещать файлы по одиночке, как делает FTP, вы храните у
себя на жестком диске полную (и синхронизированную) копию исходников.
