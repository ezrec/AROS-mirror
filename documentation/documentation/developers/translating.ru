...
Если вы близко не знакомы с SVN, прочтите страницу `Работа с Subversion (SVN)`_.
...
неформатированными текстовыми файлами (не HTML). Красивый внешний вид сайта AROS
вместе с системой меню добавляется в ходе отдельного процесса на сервере, при
преобразовании этих текстовых файлов в сайт целком на HTML. Подробнее об этом
рассказано дальше.

Перед началом работы крайне рекомендуется подождать пока установится соединение
с SVN сервером. В дальнейшем это облегчит отправку и изменение переведенных вами 
файлов. Тем не менее есть проблема, заключающаяся в том, что получение доступа к
SVN-серверу может занять длительное время, иногда даже несколько недель после
вашего первоначального обращения. Это может стать испытанием терпения, а значит,
вам следует быть действительно полными энтузиазма... к счастью для вас, вы
...
checkout'е. Возможен сценарий, когда вы переводите файды из архивов и посылаете
...
в вашем языке используются более 'экзотические' символы (например, вликий и
могучий русский или греческий), то вам требуются другие настройки для текстового
редактора. В особенности при переводе сайта на новый язык рекомендуется
отписаться в почтовую рассылку для разработчиков, чтобы проконсультироваться.
Также прочтите `страницу о документировании`_ для дополнительной информации.
