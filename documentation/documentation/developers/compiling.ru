...
:Статус:    Завершено.
:Описание: Этот документ описывает процесс компилирования AROS. Разработка AROS 
...
Вы можете скачать исходный код AROS или со страницы `Загрузка`__ или используя 
