...
Такой makefile можно использовать, если система сборки запутана и вы хотите её
...
(Ошибка: Не возвращено выражения из функции с непустым возвращаемым значением)
