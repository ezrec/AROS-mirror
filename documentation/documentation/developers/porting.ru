...
Error: No return statement in function returning non-void (Ошибка: Не возвращено значения из функции с непустым возвращаемым значением)
  Функция, которая должна возвращать значение, *не возвращает* его.

Error: Control reaches end of non-void function (Ошибка: Проверка достишла конца функции с непустым возвращаемым значением)
