...
/* $Id: usb_core.h 25505 2007-03-21 10:04:43Z schulz $ */
...
typedef struct {
    ...
    uint16_t		wIndex;
    uint16_t		wLength;
} __attribute__((packed)) USBDevice_Request;
...
#define UD_IS_USB2(d) (AROS_LE2WORD((d)->bcdUSB) >= UD_USB_2_0)
...
#define UHD_NOT_REMOV(desc, i) \
    ...
    /* deprecated */ uint8_t		PortPowerCtrlMask[1];
