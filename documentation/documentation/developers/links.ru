...
+ `Write your own operating system`__
  ...
  но также содержит несколько полезных деталей о файловых систем, сетевом
  взаимодействии, форматах исполняемых файлов и других вещах.
...
+ `Object Oriented Programming For All (OOP4A)`__
  ...
  Ещё один, независящий от языка, объектно-ориентированный фреймворк для AmigaOS.
