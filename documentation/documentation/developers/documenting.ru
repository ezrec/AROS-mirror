...
+ директорию 'documentation', содержащая документацию для разработчиков и
  пользователей
...
+ директорию 'introduction' с введением в проект, содержащимся в соответствующем
  пункте меню
+ директорию 'misc' с некоторыми вспомогательными фалами.
...
локальные директории HTML и WWW. Следите за сообщениями об ошибках и исправляйте 
их. Проверьте результат через браузер. Обычно изменения добавляются на 
http://www.aros.org спустя несколько часов после фиксирования.
