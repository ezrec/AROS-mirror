...
`Více zde... <documentation/developers/contribute>`__
...
.. raw:: html
   ...
   Noèní sestavení jsou automaticky vytváøena ka¾dou noc pøímo z posledních zdrojových kódù. Pokud si chce¹ AROS live CD jen vyzkou¹et, stáhni si jeho bootovatelný obraz "boot ISO" pro svou platformu (i386 nebo PPC).<br><br>
   ...
   Assigned (pøiøazené) Bounties:<br><img style="width: 177px; height: 2px;" alt="spacer" src="/images/sidespacer.png"><br>
