...
`Ètìte více... <introduction/index>`__
...
.. Include:: documentation/developers/contribute-abstract.cs

`Ètìte více... <documentation/developers/contribute>`__
...
.. raw:: html
   ...
   Noèní sestavení jsou dìlány automaticky ka¾dou noc pøímo z nejnovìj¹ích zdrojových kódù. Pokud byste chtìli vyzkou¹et AROS live CD, vyberte si archiv "boot ISO" podle va¹í platformy (i386 nebo PPC).<br><br>
   ...
   <a href=http://www.aros-exec.org>AROS-EXEC</a> jsou hlavní komunitní stránky. Oèekávejte zde pomoc, zjistìte, co se dìje v komunitì a posílejte své my¹lenky o AROS.<br><br>
   ...
   Veøejné odmìny (Open Bounties):<br><img style="width: 177px; height: 2px;" alt="spacer" src="images/sidespacer.png"><br>
   <a href=http://www.teamaros.org>Team AROS</a> je seskupení obyèejných lidí podporujích AROS, sna¾ící se pùsobit jako katalyzátor pro AROS, zejména získáváním penìz skrz dary na soustøedìný vývoj. 
   ...
   Pøiøazené odmìny:<br><img style="width: 177px; height: 2px;" alt="spacer" src="images/sidespacer.png"><br>
   ...
   Publikaèní kanály:<br><img style="width: 177px; height: 2px;" alt="spacer" src="images/sidespacer.png"><br>
   ...
   Poslední pøíspìvky v ARCHIVE:<br><img style="width: 238px; height: 2px;" alt="spacer" src="images/sidespacer.png"><br>
   <a href=http://archives.aros-exec.org>Archivy AROS</a> obsahují nejnovìj¹í systémový obsah dodaný na¹í komunitou a jsou primárním místem pro u¾ivatelské aplikace, témata, grafiku, a dal¹í dokumentace.<br><br>
