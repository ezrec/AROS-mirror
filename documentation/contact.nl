...
+ `AROS Aankondigingen`__
  ...
  Dit is een 'kleine' lijst voor nieuws en belangrijke aankondigingen,
  wat typisch kopie‘n bevat van de berichten in de nieuws afdeling op de
...
+ `AROS Ontwikkelaars`__
  ...
  'nightly build/nacht compilatie' gepost. Het is ontwikkelaars **zeer**
  aan te raden om te abonneren op deze lijst, omdat het anders vrij
  moeilijk wordt om alle deelnemers op de hoogte van de nieuwste
  ...
  .. Opmerking:: Inschrijvingen voor deze lijst worden niet automatisch
                 afgehandeld - elke aanvraag moet namenlijk goedgekeurd worden door de
                 administrateur van de lijst. Het kan dus zijn dat er enige vertraging
                 zit tussen de aanvraag en het tijdstip waarop u lid wordt.
...
+ `AROS Bugs`__
  ...
  worden. Het is *aangeraden* voor ontwikkelaars om zich op de lijst te
  abonneren, zodat we oog houden op gemelde 'bugs'. Het verkeer op deze
  lijst is vrij laag. 
...
+ `AROS Website`__
  ...
  Het bouw script van de website stuurt mail naar deze lijst. Degenen
...
AROS-Exec__ is het offici‘le community portaal voor AROS. Hier kunt u
...
FreeNode__ netwerk. Verbind a.u.b. met `irc.freenode.net`__, wat u zal
...
zeldzame momenten kan het hoofdkanaal erg druk zijn. In dat geval wordt
de ontwikkel-gerelateerde discussie verplaatst naar het `#aros.dev`__
kanaal. 
