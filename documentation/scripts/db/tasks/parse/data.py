...
abbreviations = {
    ...
    'mathieeedoubbas' : 'MathIEEEDoubleBase.library',
    'mathieeedoubtrans' : 'MathIEEEDoubleTrans.library',
    'mathieeesingbas' : 'MathIEEESingleBase.library',
    'mathieeesingtrans' : 'MathIEEESingleTrans.library',
    'mathtrans' : 'MathTrans.library',
    'misc' : 'Misc.resource',
    'multiview' : 'MultiView',
