...
static int __init_stdio(struct StdCIOIntBase *StdCIOBase)
{
    ...
    StdCIOBase->intstdin.flags = __STDCIO_STDIO_READ | __STDCIO_STDIO_DONTCLOSE | __STDCIO_STDIO_DONTFREE;
    ...
    StdCIOBase->intstdout.flags = __STDCIO_STDIO_WRITE | __STDCIO_STDIO_DONTCLOSE | __STDCIO_STDIO_DONTFREE;
    D(bug("[__init_stdio]: intstdout.fh=0x%x\n", StdCIOBase->intstdout.fh));
    StdCIOBase->StdCIOBase._stdout = &StdCIOBase->intstdout;

    StdCIOBase->intstdin.fh = me->pr_CES ? me->pr_CES : me->pr_COS;
    StdCIOBase->intstdin.flags = __STDCIO_STDIO_WRITE | __STDCIO_STDIO_DONTCLOSE | __STDCIO_STDIO_DONTFREE;
