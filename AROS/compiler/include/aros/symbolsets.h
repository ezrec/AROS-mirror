 ...
 * 
 * const IPTR __GM_##bname##_offset = offsetof(struct MyBase, my_bname);
...
extern const IPTR const __GM_##bname##_offset;                 \
extern const LONG const __aros_libreq_##bname __attribute__((weak)); \
                                                               \
...
{                                                              \
     name, &__aros_libreq_##bname, &__GM_##bname##_offset      \
};                                                             \
