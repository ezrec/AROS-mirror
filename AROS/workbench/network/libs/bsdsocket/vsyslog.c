...
/*  FUNCTION
        ...
        application, if the name is known by bsdsocket.library.
    ...
    NOTES
        ...
        In contrast to the previous releases of AROSTCP, the 
        args pointer is expected to be a va_list, not a ULONG *
        array. This is to improve portability with existing
        POSIX code.
    ...
    EXAMPLE
        ...
        following call to syslog:
            ...
            syslog(LOG_INFO,  "Connection from host %s", CallingHostName);
