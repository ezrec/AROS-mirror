...
IPTR panelToolBar__PrefsSetup(Class *CLASS, Object *self, struct opSet *message)
{
    ...
    panelToolBarFSNotifyList = (struct List *)GetTagData(MUIA_Wanderer_FileSysNotifyList, (IPTR) NULL, message->ops_AttrList);
...
IPTR panelToolBar__Cleanup(Class *CLASS, Object *self, Msg message)
{
    SETUP_ICONWINDOW_INST_DATA;
