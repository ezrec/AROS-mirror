...
const UBYTE     wand_namestr[] = "Wanderer";

const UBYTE     wand_copyprocnamestr[] = "Wanderer FileCopy Operation";
        ...
        struct NewMenu nm[] = {
            {NM_TITLE,          _(MSG_MEN_WANDERER) },
                ...
                {NM_ITEM,       _(MSG_MEN_SORTIC) },
                    ...
                    {NM_SUB,    _(MSG_MEN_BYTYPE),      NULL                    , CHECKIT                               , ~((1 << 6)|(1 << 1)|(1 << 8)|(1 << 9)|(1 << 10)), (APTR) MEN_WINDOW_SORT_TYPE },
                    {NM_SUB,    NM_BARLABEL },
            ...
            {NM_TITLE,          _(MSG_MEN_ICON),        NULL                    , 0 },
                ...
                {NM_ITEM,       _(MSG_UNSNAPSHOT),      "U"                     , NM_ITEMDISABLED                       , 0, (APTR) MEN_ICON_UNSNAPSHOT },
                {NM_ITEM,       _(MSG_LEAVE_OUT),       "L"                     , NM_ITEMDISABLED                       , 0, (APTR) MEN_ICON_LEAVEOUT },
                {NM_ITEM,       _(MSG_PUT_AWAY),        "P"                     , NM_ITEMDISABLED                       , 0, (APTR) MEN_ICON_PUTAWAY },
                {NM_ITEM,       NM_BARLABEL },
