...
AROS_SOFTINTH1(PCN32_RX_Int, struct PCN32Unit *,  unit)
{
    AROS_INTFUNC_INIT
 ...
 */
/* ABI_V0 compatibility */
AROS_SOFTINTH1(PCN32_TX_Int, struct PCN32Unit *,  unit)
{
    AROS_INTFUNC_INIT
 ...
 */
/* ABI_V0 compatibility */
AROS_SOFTINTH1(PCN32_TX_End_Int, struct PCN32Unit *,  unit)
{
    AROS_INTFUNC_INIT
 ...
 */
static AROS_INTH1(PCN32_TimeoutHandler,struct PCN32Unit *, dev)
{
    AROS_INTFUNC_INIT
 ...
 */
static AROS_INTH1(PCN32_IntHandler, struct PCN32Unit *, dev)
{
    AROS_INTFUNC_INIT
        ...
        if (unit->pcnu_BaseMem)
        {
            ...
            if (unit->pcnu_fe_priv)
            {
...

                {
                    ...
                    unit->pcnu_irqhandler.is_Node.ln_Type = NT_INTERRUPT;
                    unit->pcnu_irqhandler.is_Node.ln_Pri = 100;
                    unit->pcnu_irqhandler.is_Node.ln_Name = LIBBASE->pcnb_Device.dd_Library.lib_Node.ln_Name;
                    unit->pcnu_irqhandler.is_Code = (VOID_FUNC)PCN32_IntHandler;
                    unit->pcnu_irqhandler.is_Data = unit;

                    unit->pcnu_touthandler.is_Node.ln_Type = NT_INTERRUPT;
                    unit->pcnu_touthandler.is_Node.ln_Pri = 100;
                    unit->pcnu_touthandler.is_Node.ln_Name = LIBBASE->pcnb_Device.dd_Library.lib_Node.ln_Name;
                    unit->pcnu_touthandler.is_Code = (VOID_FUNC)PCN32_TimeoutHandler;
                    unit->pcnu_touthandler.is_Data = unit;

                    unit->pcnu_rx_int.is_Node.ln_Type = NT_INTERRUPT;
                    unit->pcnu_rx_int.is_Node.ln_Name = unit->pcnu_name;
                    unit->pcnu_rx_int.is_Code = (VOID_FUNC)PCN32_RX_Int;
                    unit->pcnu_rx_int.is_Data = unit;

                    unit->pcnu_tx_int.is_Node.ln_Type = NT_INTERRUPT;
