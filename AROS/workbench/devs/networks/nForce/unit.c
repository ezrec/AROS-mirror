...
static AROS_SOFTINTH1(RX_Int, struct NFUnit *,  unit)
{
    AROS_INTFUNC_INIT
 ...
 */
/* ABI_V0 compatibility */
static AROS_SOFTINTH1(TX_Int, struct NFUnit *,  unit)
{
    AROS_INTFUNC_INIT
 ...
 */
/* ABI_V0 compatibility */
static AROS_SOFTINTH1(TX_End_Int, struct NFUnit *,  unit)
{
    AROS_INTFUNC_INIT
    ...
    pci_push(base);
    AROS_INTC1(dev->nu_irqhandler.is_Code, dev->nu_irqhandler.is_Data);
    Enable();
 ...
 */
static AROS_INTH1(NF_TimeoutHandler, struct NFUnit *, dev)
{
    AROS_INTFUNC_INIT
 ...
 */
static AROS_INTH1(NF_IntHandler, struct NFUnit *, dev)
{
    AROS_INTFUNC_INIT
        ...
        if (unit->nu_BaseMem)
        {
            ...
            if (unit->nu_fe_priv)
            {
...

                {
                    ...
                    unit->nu_irqhandler.is_Node.ln_Type = NT_INTERRUPT;
                    unit->nu_irqhandler.is_Node.ln_Pri = 100;
                    unit->nu_irqhandler.is_Node.ln_Name = LIBBASE->nf_Device.dd_Library.lib_Node.ln_Name;
                    unit->nu_irqhandler.is_Code = (VOID_FUNC)NF_IntHandler;
                    unit->nu_irqhandler.is_Data = unit;

                    unit->nu_touthandler.is_Node.ln_Type = NT_INTERRUPT;
                    unit->nu_touthandler.is_Node.ln_Pri = 100;
                    unit->nu_touthandler.is_Node.ln_Name = LIBBASE->nf_Device.dd_Library.lib_Node.ln_Name;
                    unit->nu_touthandler.is_Code = (VOID_FUNC)NF_TimeoutHandler;
                    unit->nu_touthandler.is_Data = unit;

                    unit->rx_int.is_Node.ln_Name = unit->name;
                    unit->rx_int.is_Code = (VOID_FUNC)RX_Int;
                    unit->rx_int.is_Data = unit;

                    unit->tx_int.is_Node.ln_Name = unit->name;
                    unit->tx_int.is_Code = (VOID_FUNC)TX_Int;
                    unit->tx_int.is_Data = unit;

                    unit->tx_end_int.is_Node.ln_Name = unit->name;
                    unit->tx_end_int.is_Code = (VOID_FUNC)TX_End_Int;
