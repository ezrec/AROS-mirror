...
{
    STACKED ULONG MethodID;
    STACKED Object *family;
};

struct MUIP_Family_GetChild
{
    STACKED ULONG MethodID;
    STACKED LONG nr;
    STACKED Object *ref;
...
#define MUIA_Family_Child \
    (MUIB_MUI | 0x0042c696)    /* MUI: V8  i.. Object *          */
#define MUIA_Family_List \
    (MUIB_MUI | 0x00424b9e)    /* MUI: V8  ..g struct MinList *  */
#define MUIA_Family_ChildCount \
    (MUIB_MUI | 0x0042b25a)    /* MUI: V20 ..g LONG              */
...
{
    STACKED ULONG MethodID;
    STACKED Object *refwindow;
};

struct MUIP_Application_AddInputHandler
{
    STACKED ULONG MethodID;
    STACKED struct MUI_InputHandlerNode *ihnode;
};

struct MUIP_Application_CheckRefresh
{
    STACKED ULONG MethodID;
};

struct MUIP_Application_GetMenuCheck
{
    STACKED ULONG MethodID;
    STACKED ULONG MenuID;
};

struct MUIP_Application_GetMenuState
{
    STACKED ULONG MethodID;
    STACKED ULONG MenuID;
};
...
{
    STACKED ULONG MethodID;
    STACKED ULONG *signal;
};

struct MUIP_Application_InputBuffered
{
    STACKED ULONG MethodID;
};
...
struct MUIP_Application_ReturnID
{
    STACKED ULONG MethodID;
    STACKED ULONG retid;
};
...
struct MUIP_Application_SetConfigItem
{
    STACKED ULONG MethodID;
    STACKED ULONG item;
    STACKED APTR data;
...
struct MUIP_Application_SetMenuCheck
{
    STACKED ULONG MethodID;
    STACKED ULONG MenuID;
    STACKED LONG stat;
...
struct MUIP_Application_SetMenuState
{
    STACKED ULONG MethodID;
    STACKED ULONG MenuID;
    STACKED LONG stat;
...
struct MUIP_Application_ShowHelp
{
    STACKED ULONG MethodID;
...
struct MUIP_Application_SetConfigdata
{
    STACKED ULONG MethodID;
    STACKED APTR configdata;
};
...
+*/
#define MUIA_Application_Version_Number \
    (MUIB_Application | 0x00000001)

/*+
    [I-G] CONST_STRPTR
    Date information on the standard international YYYY-MM-DD format. 
+*/
#define MUIA_Application_Version_Date \
    (MUIB_Application | 0x00000002)

/*+
    [I-G] CONST_STRPTR
    Arbitrary extra version information. Example: "nightly build".
+*/
#define MUIA_Application_Version_Extra \
    (MUIB_Application | 0x00000003)
...
/**************************************************************************
 Special Values MUIM_Application_ReturnID. Usually program should leave
...
#define MUIM_Window_ActionIconify \
    (MUIB_MUI | 0x00422cc0)       /* MUI: V18 undoc */
#define MUIM_Window_AddEventHandler \
    (MUIB_MUI | 0x004203b7)       /* MUI: V16 */
#define MUIM_Window_Cleanup \
    (MUIB_MUI | 0x0042ab26) /* MUI: V18 undoc */  /* For custom classes only */
#define MUIM_Window_RemEventHandler \
    (MUIB_MUI | 0x0042679e)       /* MUI: V16 */
#define MUIM_Window_ScreenToBack \
    (MUIB_MUI | 0x0042913d)       /* MUI: V4  */
#define MUIM_Window_ScreenToFront \
    (MUIB_MUI | 0x004227a4)       /* MUI: V4  */
#define MUIM_Window_Setup \
    (MUIB_MUI | 0x0042c34c) /* MUI: V18 undoc */  /* For custom Classes only */
#define MUIM_Window_Snapshot \
    (MUIB_MUI | 0x0042945e)       /* MUI: V11 */
#define MUIM_Window_ToBack \
    (MUIB_MUI | 0x0042152e)       /* MUI: V4  */
#define MUIM_Window_ToFront \
    (MUIB_MUI | 0x0042554f)       /* MUI: V4  */

struct MUIP_Window_ActionIconify
{
    STACKED ULONG MethodID;
};

struct MUIP_Window_AddEventHandler
{
    STACKED ULONG MethodID;
    STACKED struct MUI_EventHandlerNode *ehnode;
};

struct MUIP_Window_Cleanup
{
    STACKED ULONG MethodID;
};

struct MUIP_Window_RemEventHandler
{
    STACKED ULONG MethodID;
    STACKED struct MUI_EventHandlerNode *ehnode;
};

struct MUIP_Window_ScreenToBack
{
    STACKED ULONG MethodID;
};

struct MUIP_Window_ScreenToFront
{
    STACKED ULONG MethodID;
};
...
struct MUIP_Window_ToBack
{
    STACKED ULONG MethodID;
};

struct MUIP_Window_ToFront
{
    STACKED ULONG MethodID;
};
...
{
    STACKED ULONG MethodID;
    STACKED struct MUI_EventHandlerNode *ccnode;
};

struct MUIP_Window_AllocGadgetID
{
    STACKED ULONG MethodID;
};                              /* Custom Class - returns the Gadget ID */
...
{
    STACKED ULONG MethodID;
    STACKED LONG gadgetid;
};                              /* Custom Class */

struct MUIP_Window_RecalcDisplay
{
    STACKED ULONG MethodID;
    STACKED Object *originator;
};

struct MUIP_Window_RemControlCharHandler
{
    STACKED ULONG MethodID;
    STACKED struct MUI_EventHandlerNode *ccnode;
};

struct MUIP_Window_UpdateMenu
{
    STACKED ULONG MethodID;
};
...
/*** Attributes *************************************************************/
#define MUIA_Window_Activate \
    (MUIB_MUI | 0x00428d2f)       /* MUI: V4  isg BOOL                */
#define MUIA_Window_ActiveObject \
    (MUIB_MUI | 0x00427925)       /* MUI: V4  .sg Object *            */
#define MUIA_Window_AltHeight \
    (MUIB_MUI | 0x0042cce3)       /* MUI: V4  i.g LONG                */
#define MUIA_Window_AltLeftEdge \
    (MUIB_MUI | 0x00422d65)       /* MUI: V4  i.g LONG                */
#define MUIA_Window_AltTopEdge \
    (MUIB_MUI | 0x0042e99b)       /* MUI: V4  i.g LONG                */
#define MUIA_Window_AltWidth \
    (MUIB_MUI | 0x004260f4)       /* MUI: V4  i.g LONG                */
#define MUIA_Window_AppWindow \
    (MUIB_MUI | 0x004280cf)       /* MUI: V5  i.. BOOL                */
#define MUIA_Window_Backdrop \
    (MUIB_MUI | 0x0042c0bb)       /* MUI: V4  i.. BOOL                */
#define MUIA_Window_Borderless \
    (MUIB_MUI | 0x00429b79)       /* MUI: V4  i.. BOOL                */
#define MUIA_Window_CloseGadget \
    (MUIB_MUI | 0x0042a110)       /* MUI: V4  i.. BOOL                */
#define MUIA_Window_CloseRequest \
    (MUIB_MUI | 0x0042e86e)       /* MUI: V4  ..g BOOL                */
#define MUIA_Window_DefaultObject \
    (MUIB_MUI | 0x004294d7)       /* MUI: V4  isg Object *            */
#define MUIA_Window_DepthGadget \
    (MUIB_MUI | 0x00421923)       /* MUI: V4  i.. BOOL                */
#define MUIA_Window_DisableKeys \
    (MUIB_MUI | 0x00424c36) /* MUI: V15 isg ULONG */        /* undoc */
#define MUIA_Window_DragBar \
    (MUIB_MUI | 0x0042045d)       /* MUI: V4  i.. BOOL                */
#define MUIA_Window_FancyDrawing \
    (MUIB_MUI | 0x0042bd0e)       /* MUI: V8  isg BOOL                */
#define MUIA_Window_Height \
    (MUIB_MUI | 0x00425846)       /* MUI: V4  i.g LONG                */
#define MUIA_Window_ID \
    (MUIB_MUI | 0x004201bd)       /* MUI: V4  isg ULONG               */
#define MUIA_Window_InputEvent \
    (MUIB_MUI | 0x004247d8)       /* MUI: V4  ..g struct InputEvent * */
#define MUIA_Window_IsSubWindow \
    (MUIB_MUI | 0x0042b5aa)       /* MUI: V4  isg BOOL                */
#define MUIA_Window_LeftEdge \
    (MUIB_MUI | 0x00426c65)       /* MUI: V4  i.g LONG                */
#define MUIA_Window_MenuAction \
    (MUIB_MUI | 0x00427521)       /* MUI: V8  isg ULONG               */
#define MUIA_Window_Menustrip \
    (MUIB_MUI | 0x0042855e)       /* MUI: V8  i.g Object *            */
#define MUIA_Window_MouseObject \
    (MUIB_MUI | 0x0042bf9b)       /* MUI: V10 ..g Object *            */
#define MUIA_Window_NeedsMouseObject \
    (MUIB_MUI | 0x0042372a)       /* MUI: V10 i.. BOOL                */
#define MUIA_Window_NoMenus \
    (MUIB_MUI | 0x00429df5)       /* MUI: V4  is. BOOL                */
#define MUIA_Window_Open \
    (MUIB_MUI | 0x00428aa0)       /* MUI: V4  .sg BOOL                */
#define MUIA_Window_PublicScreen \
    (MUIB_MUI | 0x004278e4)       /* MUI: V6  isg STRPTR              */
#define MUIA_Window_RefWindow \
    (MUIB_MUI | 0x004201f4)       /* MUI: V4  is. Object *            */
#define MUIA_Window_RootObject \
    (MUIB_MUI | 0x0042cba5)       /* MUI: V4  isg Object *            */
#define MUIA_Window_Screen \
    (MUIB_MUI | 0x0042df4f)       /* MUI: V4  isg struct Screen *     */
#define MUIA_Window_ScreenTitle \
    (MUIB_MUI | 0x004234b0)       /* MUI: V5  isg STRPTR              */
#define MUIA_Window_SizeGadget \
    (MUIB_MUI | 0x0042e33d)       /* MUI: V4  i.. BOOL                */
#define MUIA_Window_SizeRight \
    (MUIB_MUI | 0x00424780)       /* MUI: V4  i.. BOOL                */
#define MUIA_Window_Sleep \
    (MUIB_MUI | 0x0042e7db)       /* MUI: V4  .sg BOOL                */
#define MUIA_Window_Title \
    (MUIB_MUI | 0x0042ad3d)       /* MUI: V4  isg STRPTR              */
#define MUIA_Window_TopEdge \
    (MUIB_MUI | 0x00427c66)       /* MUI: V4  i.g LONG                */
#define MUIA_Window_UseBottomBorderScroller \
    (MUIB_MUI | 0x00424e79)       /* MUI: V13 isg BOOL                */
#define MUIA_Window_UseLeftBorderScroller \
    (MUIB_MUI | 0x0042433e)       /* MUI: V13 isg BOOL                */
#define MUIA_Window_UseRightBorderScroller \
    (MUIB_MUI | 0x0042c05e)       /* MUI: V13 isg BOOL                */
#define MUIA_Window_Width \
    (MUIB_MUI | 0x0042dcae)       /* MUI: V4  i.g LONG                */
#define MUIA_Window_Window \
    (MUIB_MUI | 0x00426a42)       /* MUI: V4  ..g struct Window *     */

#define MUIA_Window_EraseArea \
    (MUIB_Window | 0x00000000)  /* Zune only i.. BOOL (default: TRUE) */
#define MUIA_Window_ZoomGadget \
...
{
    STACKED ULONG MethodID;
    STACKED LONG scalemin;
    STACKED LONG scalemax;
    STACKED LONG scale;
};

struct MUIP_Numeric_SetDefault
{
    STACKED ULONG MethodID;
};
...
/*** Attributes *************************************************************/
#define MUIA_Numeric_CheckAllSizes \
    (MUIB_MUI | 0x00421594)        /* MUI: V11 isg BOOL   */
#define MUIA_Numeric_Default \
    (MUIB_MUI | 0x004263e8)        /* MUI: V11 isg LONG   */
#define MUIA_Numeric_Format \
    (MUIB_MUI | 0x004263e9)        /* MUI: V11 isg STRPTR */
#define MUIA_Numeric_Max \
    (MUIB_MUI | 0x0042d78a)        /* MUI: V11 isg LONG   */
#define MUIA_Numeric_Min \
    (MUIB_MUI | 0x0042e404)        /* MUI: V11 isg LONG   */
#define MUIA_Numeric_Reverse \
    (MUIB_MUI | 0x0042f2a0)        /* MUI: V11 isg BOOL   */
#define MUIA_Numeric_RevLeftRight \
    (MUIB_MUI | 0x004294a7)        /* MUI: V11 isg BOOL   */
#define MUIA_Numeric_RevUpDown \
    (MUIB_MUI | 0x004252dd)        /* MUI: V11 isg BOOL   */
#define MUIA_Numeric_Value \
    (MUIB_MUI | 0x0042ae3a)        /* MUI: V11 isg LONG   */

#define MUIM_Numeric_ValueToScaleExt MUIB_Numeric /* ZUNE only */
...
/*** Attributes *************************************************************/
#define MUIA_String_Accept \
    (MUIB_MUI | 0x0042e3e1)      /* V4  isg STRPTR        */
#define MUIA_String_Acknowledge \
    (MUIB_MUI | 0x0042026c)      /* V4  ..g STRPTR        */
#define MUIA_String_AdvanceOnCR \
    (MUIB_MUI | 0x004226de)      /* V11 isg BOOL          */
#define MUIA_String_AttachedList \
    (MUIB_MUI | 0x00420fd2)      /* V4  isg Object *      */
#define MUIA_String_BufferPos \
    (MUIB_MUI | 0x00428b6c)      /* V4  .sg LONG          */
#define MUIA_String_Contents \
    (MUIB_MUI | 0x00428ffd)      /* V4  isg STRPTR        */
#define MUIA_String_DisplayPos \
    (MUIB_MUI | 0x0042ccbf)      /* V4  .sg LONG          */
#define MUIA_String_EditHook \
    (MUIB_MUI | 0x00424c33)      /* V7  isg struct Hook * */
#define MUIA_String_Format \
    (MUIB_MUI | 0x00427484)      /* V4  i.g LONG          */
#define MUIA_String_Integer \
    (MUIB_MUI | 0x00426e8a)      /* V4  isg ULONG         */
#define MUIA_String_LonelyEditHook \
    (MUIB_MUI | 0x00421569)      /* V11 isg BOOL          */
#define MUIA_String_MaxLen \
    (MUIB_MUI | 0x00424984)      /* V4  i.g LONG          */
#define MUIA_String_Reject \
    (MUIB_MUI | 0x0042179c)      /* V4  isg STRPTR        */
#define MUIA_String_Secret \
    (MUIB_MUI | 0x00428769)      /* V4  i.g BOOL          */
...
/*** Attributes *************************************************************/
#define MUIA_Menuitem_Checked \
    (MUIB_MUI | 0x0042562a)       /* MUI: V8  isg BOOL              */
#define MUIA_Menuitem_Checkit \
    (MUIB_MUI | 0x00425ace)       /* MUI: V8  isg BOOL              */
#define MUIA_Menuitem_CommandString \
    (MUIB_MUI | 0x0042b9cc)       /* MUI: V16 isg BOOL              */
#define MUIA_Menuitem_Enabled \
    (MUIB_MUI | 0x0042ae0f)       /* MUI: V8  isg BOOL              */
#define MUIA_Menuitem_Exclude \
    (MUIB_MUI | 0x00420bc6)       /* MUI: V8  isg LONG              */
#define MUIA_Menuitem_Shortcut \
    (MUIB_MUI | 0x00422030)       /* MUI: V8  isg STRPTR            */
#define MUIA_Menuitem_Title \
    (MUIB_MUI | 0x004218be)       /* MUI: V8  isg STRPTR            */
#define MUIA_Menuitem_Toggle \
    (MUIB_MUI | 0x00424d5c)       /* MUI: V8  isg BOOL              */
#define MUIA_Menuitem_Trigger \
    (MUIB_MUI | 0x00426f32)       /* MUI: V8  ..g struct MenuItem * */

#define MUIA_Menuitem_NewMenu \
    (MUIB_Menuitem | 0x00000000)  /* Zune: V1 ..g struct NewMenu *  */
...
{
    STACKED ULONG MethodID;
    STACKED struct IFFHandle *handle;
};
...
#define MUIA_Listview_ClickColumn \
    (MUIB_MUI | 0x0042d1b3)      /* V7  ..g LONG    */
#define MUIA_Listview_DefClickColumn \
    (MUIB_MUI | 0x0042b296)      /* V7  isg LONG    */
#define MUIA_Listview_DoubleClick \
    (MUIB_MUI | 0x00424635)      /* V4  i.g BOOL    */
#define MUIA_Listview_DragType \
    (MUIB_MUI | 0x00425cd3)      /* V11 isg LONG    */
#define MUIA_Listview_Input \
    (MUIB_MUI | 0x0042682d)      /* V4  i.. BOOL    */
#define MUIA_Listview_List \
    (MUIB_MUI | 0x0042bcce)      /* V4  i.g Object  */
#define MUIA_Listview_MultiSelect \
    (MUIB_MUI | 0x00427e08)      /* V7  i.. LONG    */
#define MUIA_Listview_ScrollerPos \
    (MUIB_MUI | 0x0042b1b4)      /* V10 i.. BOOL    */
#define MUIA_Listview_SelectChange \
    (MUIB_MUI | 0x0042178f)      /* V4  ..g BOOL    */
...
struct MUIP_Popstring_Open
{
    STACKED ULONG MethodID;
};

/*** Attributes *************************************************************/
#define MUIA_Popstring_Button \
    (MUIB_MUI | 0x0042d0b9)  /* MUI: V7  i.g Object *      */
#define MUIA_Popstring_CloseHook \
    (MUIB_MUI | 0x004256bf)  /* MUI: V7  isg struct Hook * */
#define MUIA_Popstring_OpenHook \
    (MUIB_MUI | 0x00429d00)  /* MUI: V7  isg struct Hook * */
#define MUIA_Popstring_String \
    (MUIB_MUI | 0x004239ea)  /* MUI: V7  i.g Object *      */
#define MUIA_Popstring_Toggle \
    (MUIB_MUI | 0x00422b7a)  /* MUI: V7  isg BOOL          */
...
#define MUIA_Popobject_Follow \
    (MUIB_MUI | 0x00424cb5)       /* MUI: V7  isg BOOL          */
#define MUIA_Popobject_Light \
    (MUIB_MUI | 0x0042a5a3)       /* MUI: V7  isg BOOL          */
#define MUIA_Popobject_Object \
    (MUIB_MUI | 0x004293e3)       /* MUI: V7  i.g Object *      */
#define MUIA_Popobject_ObjStrHook \
    (MUIB_MUI | 0x0042db44)       /* MUI: V7  isg struct Hook * */
#define MUIA_Popobject_StrObjHook \
    (MUIB_MUI | 0x0042fbe1)       /* MUI: V7  isg struct Hook * */
#define MUIA_Popobject_Volatile \
    (MUIB_MUI | 0x004252ec)       /* MUI: V7  isg BOOL          */
#define MUIA_Popobject_WindowHook \
    (MUIB_MUI | 0x0042f194)       /* MUI: V9  isg struct Hook * */
...
/*** Attributes *************************************************************/
#define MUIA_Gauge_Current \
    (MUIB_MUI | 0x0042f0dd)       /* MUI: V4  isg LONG    */
#define MUIA_Gauge_Divide \
    (MUIB_MUI | 0x0042d8df)       /* MUI: V4  isg LONG    */
#define MUIA_Gauge_Horiz \
    (MUIB_MUI | 0x004232dd)       /* MUI: V4  i.. BOOL    */
#define MUIA_Gauge_InfoText \
    (MUIB_MUI | 0x0042bf15)       /* MUI: V7  isg STRPTR  */
#define MUIA_Gauge_Max \
    (MUIB_MUI | 0x0042bcdb)       /* MUI: V4  isg LONG    */

#define MUIA_Gauge_DupInfoText \
    (MUIB_Gauge | 0x00000000)     /* ZUNE: V1  i.. BOOL - defaults to FALSE */
...
#define MUIA_Image_FontMatch \
    (MUIB_MUI | 0x0042815d)       /* MUI: V4  i.. BOOL                */
#define MUIA_Image_FontMatchHeight \
    (MUIB_MUI | 0x00429f26)       /* MUI: V4  i.. BOOL                */
#define MUIA_Image_FontMatchWidth \
    (MUIB_MUI | 0x004239bf)       /* MUI: V4  i.. BOOL                */
#define MUIA_Image_FreeHoriz \
    (MUIB_MUI | 0x0042da84)       /* MUI: V4  i.. BOOL                */
#define MUIA_Image_FreeVert \
    (MUIB_MUI | 0x0042ea28)       /* MUI: V4  i.. BOOL                */
#define MUIA_Image_OldImage \
...
#define MUIA_Imagedisplay_FreeVert \
    (MUIB_Imagedisplay | 0x00000001)   /* Zune 20030323 i.. BOOL [TRUE] */
...
#define MUIM_Settingsgroup_ConfigToGadgets \
    (MUIB_MUI | 0x00427043)        /* MUI: V11 */
#define MUIM_Settingsgroup_GadgetsToConfig \
    (MUIB_MUI | 0x00425242)        /* MUI: V11 */

struct MUIP_Settingsgroup_ConfigToGadgets
{
    STACKED ULONG MethodID;
    STACKED Object *configdata;
};
...
/*** Attributes *************************************************************/
#define MUIA_Balance_Quiet \
    (MUIB_Balance | 0x00000000) /* (zune) V20 i   LONG */
...
/*** Attributes *************************************************************/
#define MUIA_Pendisplay_Pen \
    (MUIB_MUI | 0x0042a748)        /* MUI: V13  ..g Object *       */
#define MUIA_Pendisplay_Reference \
    (MUIB_MUI | 0x0042dc24)        /* MUI: V13  isg Object *       */
#define MUIA_Pendisplay_RGBcolor \
    (MUIB_MUI | 0x0042a1a9)        /* MUI: V11  isg struct MUI_RGBcolor * */
#define MUIA_Pendisplay_Spec \
    (MUIB_MUI | 0x0042a204)        /* MUI: V11  isg struct MUI_PenSpec  * */
...
/*** Attributes *************************************************************/
#define MUIA_Coloradjust_Red \
    (MUIB_MUI | 0x00420eaa)   /* isg ULONG   */
#define MUIA_Coloradjust_Green \
    (MUIB_MUI | 0x004285ab)   /* isg ULONG   */
#define MUIA_Coloradjust_Blue \
    (MUIB_MUI | 0x0042b8a3)   /* isg ULONG   */
#define MUIA_Coloradjust_RGB \
    (MUIB_MUI | 0x0042f899)   /* isg ULONG * */
#define MUIA_Coloradjust_ModeID \
    (MUIB_MUI | 0x0042ec59)   /* isg ULONG   */
...
/*** Attributes *************************************************************/
#define MUIA_Dirlist_AcceptPattern \
    (MUIB_MUI | 0x0042760a)       /* MUI: V4  is. STRPTR        */
#define MUIA_Dirlist_Directory \
    (MUIB_MUI | 0x0042ea41)       /* MUI: V4  isg STRPTR        */
#define MUIA_Dirlist_DrawersOnly \
    (MUIB_MUI | 0x0042b379)       /* MUI: V4  is. BOOL          */
#define MUIA_Dirlist_FilesOnly \
    (MUIB_MUI | 0x0042896a)       /* MUI: V4  is. BOOL          */
#define MUIA_Dirlist_FilterDrawers \
    (MUIB_MUI | 0x00424ad2)       /* MUI: V4  is. BOOL          */
#define MUIA_Dirlist_FilterHook \
    (MUIB_MUI | 0x0042ae19)       /* MUI: V4  is. struct Hook * */
#define MUIA_Dirlist_MultiSelDirs \
    (MUIB_MUI | 0x00428653)       /* MUI: V6  is. BOOL          */
#define MUIA_Dirlist_NumBytes \
    (MUIB_MUI | 0x00429e26)       /* MUI: V4  ..g LONG          */
#define MUIA_Dirlist_NumDrawers \
    (MUIB_MUI | 0x00429cb8)       /* MUI: V4  ..g LONG          */
#define MUIA_Dirlist_NumFiles \
    (MUIB_MUI | 0x0042a6f0)       /* MUI: V4  ..g LONG          */
#define MUIA_Dirlist_Path \
    (MUIB_MUI | 0x00426176)       /* MUI: V4  ..g STRPTR        */
#define MUIA_Dirlist_RejectIcons \
    (MUIB_MUI | 0x00424808)       /* MUI: V4  is. BOOL          */
#define MUIA_Dirlist_RejectPattern \
    (MUIB_MUI | 0x004259c7)       /* MUI: V4  is. STRPTR        */
#define MUIA_Dirlist_SortDirs \
    (MUIB_MUI | 0x0042bbb9)       /* MUI: V4  is. LONG          */
#define MUIA_Dirlist_SortHighLow \
    (MUIB_MUI | 0x00421896)       /* MUI: V4  is. BOOL          */
#define MUIA_Dirlist_SortType \
    (MUIB_MUI | 0x004228bc)       /* MUI: V4  is. LONG          */
#define MUIA_Dirlist_Status \
    (MUIB_MUI | 0x004240de)       /* MUI: V4  ..g LONG          */
...
#define MUIA_Palette_Entries \
    0x8042a3d8  /* V6  i.g struct MUI_Palette_Entry * */
#define MUIA_Palette_Groupable \
    0x80423e67  /* V6  isg BOOL              */
#define MUIA_Palette_Names \
    0x8042c3a2  /* V6  isg char **           */
...
{
    STACKED ULONG MethodID;
    STACKED LONG maxdelay;
};

struct MUIP_Process_Launch
{
    STACKED ULONG MethodID;
};
...
/*** Attributes *************************************************************/
#define MUIA_Process_AutoLaunch \
    (MUIB_MUI | 0x00428855)   /* V20 i.. ULONG             */
#define MUIA_Process_Name \
    (MUIB_MUI | 0x0042732b)   /* V20 i.. ULONG             */
#define MUIA_Process_Priority \
    (MUIB_MUI | 0x00422a54)   /* V20 i.. ULONG             */
#define MUIA_Process_SourceClass \
    (MUIB_MUI | 0x0042cf8b)   /* V20 i.. ULONG             */
#define MUIA_Process_SourceObject \
    (MUIB_MUI | 0x004212a2)   /* V20 i.. ULONG             */
#define MUIA_Process_StackSize \
    (MUIB_MUI | 0x004230d0)   /* V20 i.. ULONG             */
#define MUIA_Process_Task \
    (MUIB_MUI | 0x0042b123)   /* V20 ..g ULONG             */
...
struct MUIP_Pixmap_DrawSection
{
    STACKED ULONG MethodID;
    STACKED LONG sx;
    STACKED LONG sy;
    STACKED LONG sw;
    STACKED LONG sh;
    STACKED struct MUI_RenderInfo *mri;
    STACKED LONG dx;
    STACKED LONG dy;
};                              /* private */

/*** Attributes *************************************************************/
#define MUIA_Pixmap_Alpha \
    (MUIB_MUI | 0x00421fef)   /* V20 isg ULONG             */
#define MUIA_Pixmap_CLUT \
    (MUIB_MUI | 0x0042042a)   /* V20 isg ULONG *           */
#define MUIA_Pixmap_CompressedSize \
    (MUIB_MUI | 0x0042e7e4)   /* V20 isg ULONG             */
#define MUIA_Pixmap_Compression \
    (MUIB_MUI | 0x0042ce74)   /* V20 isg ULONG             */
#define MUIA_Pixmap_Data \
    (MUIB_MUI | 0x00429ea0)   /* V20 isg APTR              */
#define MUIA_Pixmap_Format \
    (MUIB_MUI | 0x0042ab14)   /* V20 isg ULONG             */
#define MUIA_Pixmap_Height \
    (MUIB_MUI | 0x004288be)   /* V20 isg LONG              */
#define MUIA_Pixmap_UncompressedData \
    (MUIB_MUI | 0x0042b085)   /* V20 ..g APTR              */
