/*
    ...
    Desc: Get a pointer to a method and pointer to class for an object
    Lang: english
*/
...
#include <proto/oop.h>
    ...
    AROS_LH3(OOP_MethodFunc, OOP_GetMethodExt,
...
*****************************************************************************/
{
    ...
    *classPtr = ifm->mClass;
    ...
    /* Paranoia */
    D(if (NULL == ifm->MethodFunc) bug("!!! OOP/GetMethodExt(): IFMethod instance had no methodfunc. This should NEVER happen !!!\n");)
