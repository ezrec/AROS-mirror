...
AROS_UFH0(void, pPoPoGUITask)
{
    ...
    po->po_AppObj = ApplicationObject,
        ...
        MUIA_Application_Description, "Opens annoying windows",
        MUIA_Application_Base       , "POPO",
        MUIA_Application_HelpFile   , "HELP:Poseidon.guide",
        MUIA_Application_Menustrip  , MenustripObject,
            Child, MenuObjectT("Project"),
                Child, po->po_AboutMI = MenuitemObject,
                ...
                Child, MenuitemObject,
                    ...
                    End,
                Child, po->po_CloseMI = MenuitemObject,
                    MUIA_Menuitem_Title, "Close",
                    MUIA_Menuitem_Shortcut, "Q",
                    End,
                End,
            Child, MenuObjectT("Settings"),
                Child, po->po_TridentMI = MenuitemObject,
                    MUIA_Menuitem_Title, "Open Trident",
                    MUIA_Menuitem_Shortcut, "O",
                    End,
                Child, MenuitemObject,
                    MUIA_Menuitem_Title, NM_BARLABEL,
                    End,
                Child, po->po_MUIPrefsMI = MenuitemObject,
        ...
        SubWindow, po->po_WindowObj = WindowObject,
            MUIA_Window_ID   , MAKE_ID('P','O','P','O'),
            MUIA_Window_Title, "Poseidon Popups",
            MUIA_HelpNode, "main",

            WindowContents, VGroup,
                Child, po->po_PoPoObj = NewObject(po->po_PoPoClass->mcc_Class, 0, MUIA_ShowMe, FALSE, TAG_END),
                Child, po->po_GroupObj = VGroup,
                    Child, HGroup,
                        Child, HSpace(0),
                    ...
                    End,
                Child, HGroup,
                    Child, po->po_StickyObj = ImageObject, ImageButtonFrame,
                    ...
                    Child, HGroup,
                        ...
                        Child, po->po_SaveObj = TextObject, ButtonFrame,
                            MUIA_Disabled, (ps->ps_SavedConfigHash == ps->ps_ConfigHash),
                            MUIA_Background, MUII_ButtonBack,
                            MUIA_CycleChain, 1,
                            MUIA_InputMode, MUIV_InputMode_RelVerify,
                            MUIA_Text_Contents, "\33c Save Prefs ",
                            End,
                        Child, po->po_CloseObj = TextObject, ButtonFrame,
                            MUIA_Background, MUII_ButtonBack,
                            MUIA_CycleChain, 1,
                            MUIA_InputMode, MUIV_InputMode_RelVerify,
...
struct PsdPoPoGadgets * pAllocPoPoGadgets(LIBBASETYPEPTR ps, STRPTR body, STRPTR *gad)
{
    ...
    if((pog = (struct PsdPoPoGadgets *) psdAllocVec(sizeof(struct PsdPoPoGadgets))))
    {
        pog->pog_GroupObj =
            VGroup,
                Child, pog->pog_BodyObj = TextObject,
                ...
                Child, hgrp = HGroup,
                    MUIA_Group_SameWidth, TRUE,
                    Child, pog->pog_GadgetObj[0] = TextObject, ButtonFrame,
                        MUIA_Background, MUII_ButtonBack,
                        MUIA_CycleChain, 1,
                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                        MUIA_Text_PreParse, "\33c",
                        MUIA_Text_Contents, gad[0] ? gad[0] : (STRPTR) "",
                        MUIA_ShowMe, gad[0],
                        End,
                    Child, pog->pog_GadgetObj[1] = TextObject, ButtonFrame,
                        MUIA_Background, MUII_ButtonBack,
                        MUIA_CycleChain, 1,
                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                        MUIA_Text_PreParse, "\33c",
                        MUIA_Text_Contents, gad[1] ? gad[1] : (STRPTR) "",
                        MUIA_ShowMe, gad[1],
                        End,
                    Child, pog->pog_GadgetObj[2] = TextObject, ButtonFrame,
                        MUIA_Background, MUII_ButtonBack,
                        MUIA_CycleChain, 1,
                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                        MUIA_Text_PreParse, "\33c",
                        MUIA_Text_Contents, gad[2] ? gad[2] : (STRPTR) "",
                        MUIA_ShowMe, gad[2],
                        End,
                    Child, pog->pog_GadgetObj[3] = TextObject, ButtonFrame,
                        MUIA_Background, MUII_ButtonBack,
                        MUIA_CycleChain, 1,
                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                        MUIA_Text_PreParse, "\33c",
                        MUIA_Text_Contents, gad[3] ? gad[3] : (STRPTR) "",
                        MUIA_ShowMe, gad[3],
                        End,
                    End,
                //Child, VSpace(0),
