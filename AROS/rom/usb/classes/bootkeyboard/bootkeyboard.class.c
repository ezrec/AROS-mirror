...
AROS_UFH0(void, nGUITask)
{
    ...
    nh->nh_App = ApplicationObject,
        ...
        MUIA_Application_Description, "Settings for the bootkeyboard.class",
        MUIA_Application_Base       , "BOOTKEYBOARD",
        ...
        SubWindow, nh->nh_MainWindow = WindowObject,
            ...
            WindowContents, VGroup,
                Child, ColGroup(2), GroupFrameT("Global Settings"),
                    ...
                    Child, HGroup,
                        Child, nh->nh_RHEnableObj = ImageObject, ImageButtonFrame,
                    ...
                    Child, nh->nh_ResetDelayObj = SliderObject, SliderFrame,
                        MUIA_CycleChain, 1,
                        MUIA_Numeric_Min, 0,
                        MUIA_Numeric_Max, 60,
                        ...
                        End,
                    Child, Label((IPTR) "Amiga CapsLock behaviour:"),
                    Child, HGroup,
                        Child, nh->nh_CapsLockObj = ImageObject, ImageButtonFrame,
                            MUIA_Background, MUII_ButtonBack,
                            MUIA_CycleChain, 1,
                            MUIA_InputMode, MUIV_InputMode_Toggle,
                            MUIA_Image_Spec, MUII_CheckMark,
                        ...
                        Child, HSpace(0),
                        End,
                    Child, Label((IPTR) "Use standard ISA mapping:"),
                    Child, HGroup,
                        Child, nh->nh_ISAMapObj = ImageObject, ImageButtonFrame,
                            MUIA_Background, MUII_ButtonBack,
                            MUIA_CycleChain, 1,
                            MUIA_InputMode, MUIV_InputMode_Toggle,
                            MUIA_Image_Spec, MUII_CheckMark,
                        ...
                        Child, HSpace(0),
                        End,
                    Child, Label((IPTR) "Disable extra key emulation:"),
                    Child, HGroup,
                        Child, nh->nh_ExtraEmulObj = ImageObject, ImageButtonFrame,
                            MUIA_Background, MUII_ButtonBack,
                            MUIA_CycleChain, 1,
                            MUIA_InputMode, MUIV_InputMode_Toggle,
                            MUIA_Image_Spec, MUII_CheckMark,
