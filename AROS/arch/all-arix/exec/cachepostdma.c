...
******************************************************************************/
{
    ...
    /*
     * We're ready with DMA transactions. Unlock the memory so that kernel may
     * swap it out or do anything else with it
     */
    PD(SysBase).SysIFace->munlock(address, *length);
